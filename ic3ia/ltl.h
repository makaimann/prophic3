...
public:
  ...
  void encode(const TermMap &statevars, msat_term ltl, TransitionSystem &out);
...
private:
  ...
  void make_single_justice(TermMap &sv, TermList &justice, msat_term &init,
                           msat_term &trans);
  msat_term get_constraints(const TermMap &statevars, msat_term neg_f,
                            TermList &justice);
