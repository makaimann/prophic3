...
(define-fun .def_14 () Int (! D :next |.x.2|))
(define-fun .def_37 () Int (! E_0 :next |.xpv.1|))
(define-fun .def_35 () Bool (= .def_10 0))
(define-fun .def_34 () Bool (= .def_12 7))
(define-fun .def_36 () Bool (! (and .def_34 .def_35) :init true))
(define-fun .def_29 () Bool (<= .def_10 .def_14))
(define-fun .def_25 () Int (* (- 1) F))
