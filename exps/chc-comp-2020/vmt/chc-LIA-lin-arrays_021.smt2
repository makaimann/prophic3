...
(declare-fun H_0 () Int)
(declare-fun F_7 () Int)
(define-fun .def_8 () Int (! D_7 :next |.y.29|))
(define-fun .def_10 () Int (! .y.18 :next |.y.30|))
(define-fun .def_12 () Int (! .y.19 :next |.y.31|))
(define-fun .def_14 () (Array Int Int) (! E_7 :next |.y.32|))
(define-fun .def_16 () Int (! H_7 :next |.y.33|))
(define-fun .def_18 () (Array Int Int) (! I_7 :next |.y.34|))
(define-fun .def_20 () Int (! G_7 :next |.y.35|))
(define-fun .def_22 () Int (! A_8 :next |.y.36|))
...
(define-fun .def_44 () Int (! J_7 :next |.xtv.1|))
(define-fun .def_66 () Int (! H_0 :next |.xtv.2|))
(define-fun .def_67 () Int (! F_7 :next |.xtv.3|))
...
(define-fun .def_272 () Int (select .def_14 .def_67))
(define-fun .def_271 () Int (select .def_18 .def_44))
(define-fun .def_273 () Bool (= .def_271 .def_272))
(define-fun .def_295 () Bool (not .def_273))
(define-fun .def_261 () Bool (<= .def_8 0))
(define-fun .def_101 () Bool (<= .def_67 0))
(define-fun .def_102 () Bool (not .def_101))
(define-fun .def_268 () Bool (or .def_102 .def_261))
(define-fun .def_265 () Bool (<= .def_22 .def_20))
(define-fun .def_266 () Bool (not .def_265))
(define-fun .def_262 () Bool (not .def_261))
(define-fun .def_93 () Int (* (- 1) .def_67))
(define-fun .def_174 () Int (+ .def_20 .def_93))
(define-fun .def_258 () Int (+ .def_8 .def_174))
(define-fun .def_259 () Bool (= .def_258 0))
(define-fun .def_82 () Int (* (- 1) .def_44))
(define-fun .def_164 () Int (+ .def_20 .def_82))
(define-fun .def_256 () Int (+ .def_16 .def_164))
...
(define-fun .def_48 () Bool (not .def_43))
...
(define-fun .def_230 () Bool (<= .def_30 .def_20))
...
(define-fun .def_214 () Bool (and .def_36 .def_48))
...
(define-fun .def_157 () Int (select .def_18 .def_67))
(define-fun .def_158 () (Array Int Int) (store .def_26 .def_44 .def_157))
...
(define-fun .def_166 () Int (+ .def_22 .def_82))
...
(define-fun .def_229 () Bool (and .def_176 .def_228))
(define-fun .def_232 () Bool (and .def_229 .def_231))
(define-fun .def_178 () Bool (or .def_46 .def_161))
(define-fun .def_233 () Bool (and .def_178 .def_232))
(define-fun .def_180 () Bool (or .def_43 .def_102))
...
(define-fun .def_98 () Bool (<= .def_24 .def_12))
...
(define-fun .def_139 () Bool (and .def_38 .def_48))
...
(define-fun .def_133 () Bool (<= .y.33 0))
(define-fun .def_134 () Bool (not .def_133))
(define-fun .def_130 () Bool (<= .y.35 0))
(define-fun .def_131 () Bool (not .def_130))
(define-fun .def_127 () Bool (<= .y.36 0))
(define-fun .def_128 () Bool (not .def_127))
(define-fun .def_124 () Bool (<= .y.37 0))
...
(define-fun .def_85 () Int (+ .def_16 .def_82))
...
(define-fun .def_71 () (Array Int Int) (store .def_18 .def_44 .def_66))
(define-fun .def_72 () Bool (= .y.34 .def_71))
(define-fun .def_68 () (Array Int Int) (store .def_14 .def_67 .def_66))
(define-fun .def_69 () Bool (= .y.32 .def_68))
