...
(define-fun .def_8 () Int (! A :next |.x.72|))
(define-fun .def_10 () (Array Int Int) (! R :next |.x.73|))
(define-fun .def_12 () (Array Int Int) (! C :next |.x.74|))
(define-fun .def_14 () (Array Int (Array Int Int)) (! D :next |.x.75|))
(define-fun .def_16 () (Array Int (Array Int Int)) (! E :next |.x.76|))
(define-fun .def_18 () Int (! S :next |.x.77|))
(define-fun .def_20 () Int (! G :next |.x.78|))
(define-fun .def_22 () (Array Int Int) (! H :next |.x.79|))
(define-fun .def_24 () (Array Int Int) (! I :next |.x.80|))
(define-fun .def_26 () Int (! T :next |.x.81|))
(define-fun .def_28 () Int (! K :next |.x.82|))
(define-fun .def_30 () Int (! L :next |.x.83|))
(define-fun .def_32 () Int (! M :next |.x.84|))
(define-fun .def_34 () Int (! N :next |.x.85|))
(define-fun .def_36 () Int (! O :next |.x.86|))
(define-fun .def_38 () Int (! P :next |.x.87|))
...
(define-fun .def_153 () Bool (= .def_14 .def_16))
(define-fun .def_152 () Bool (not .def_40))
...
(define-fun .def_149 () Bool (= .def_22 .def_24))
(define-fun .def_157 () Bool (and .def_149 .def_156))
(define-fun .def_148 () Bool (= .def_10 .def_12))
...
(define-fun .def_89 () (Array Int Int) (select .def_14 .x.83))
(define-fun .def_90 () (Array Int Int) (store .def_89 .x.84 0))
(define-fun .def_91 () (Array Int (Array Int Int)) (store .def_14 .x.83 .def_90))
(define-fun .def_92 () Bool (= .x.75 .def_91))
(define-fun .def_86 () (Array Int Int) (store .def_52 .x.83 1))
(define-fun .def_87 () Bool (= .x.73 .def_86))
(define-fun .def_82 () (Array Int Int) (store .def_22 .x.83 4))
(define-fun .def_83 () Bool (= .x.79 .def_82))
(define-fun .def_78 () Int (select .def_52 .x.83))
(define-fun .def_79 () Bool (= .def_78 0))
(define-fun .def_76 () Bool (= .x.84 0))
(define-fun .def_73 () Bool (= .x.83 0))
(define-fun .def_74 () Bool (not .def_73))
(define-fun .def_69 () (Array Int Int) (select .x.75 .x.83))
(define-fun .def_70 () Int (select .def_69 .x.84))
(define-fun .def_71 () Bool (= .x.87 .def_70))
...
(define-fun .def_103 () Bool (or Q_4 .def_102))
...
(define-fun .def_96 () Bool (and .def_40 Q_4))
...
(define-fun .def_94 () Bool (or Q_4 .def_93))
(define-fun .def_65 () Bool (or Q_4 .def_64))
