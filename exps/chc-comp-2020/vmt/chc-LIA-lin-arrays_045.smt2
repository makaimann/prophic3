...
(define-fun .def_160 () Bool (not .def_20))
(define-fun .def_137 () Bool (not .def_18))
(define-fun .def_162 () Bool (! (and .def_137 .def_160) :init true))
(define-fun .def_156 () Bool (not .loc.15))
(define-fun .def_118 () Bool (= .def_8 0))
(define-fun .def_152 () Bool (not .def_118))
(define-fun .def_148 () Int (select .def_10 .def_14))
(define-fun .def_149 () Bool (<= .def_12 .def_148))
(define-fun .def_150 () Int (ite .def_149 1 0))
(define-fun .def_151 () Bool (= .def_150 0))
(define-fun .def_153 () Bool (and .def_151 .def_152))
(define-fun .def_154 () Bool (and .def_18 .def_153))
(define-fun .def_155 () Bool (and .loc.16 .def_154))
...
(define-fun .def_163 () Bool (and .def_20 .def_137))
