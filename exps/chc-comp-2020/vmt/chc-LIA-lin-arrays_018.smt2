...
(declare-fun H_0 () Int)
(declare-fun H_5 () Int)
(define-fun .def_8 () Int (! F_5 :next |.y.15|))
(define-fun .def_10 () Int (! .y.10 :next |.y.16|))
(define-fun .def_12 () Int (! .y.11 :next |.y.17|))
(define-fun .def_14 () (Array Int Int) (! G_5 :next |.y.18|))
(define-fun .def_16 () Int (! A_6 :next |.y.19|))
(define-fun .def_18 () Int (! E_5 :next |.y.20|))
...
(define-fun .def_37 () Int (! H_0 :next |.xtv.1|))
(define-fun .def_38 () Int (! H_5 :next |.xtv.2|))
...
(define-fun .def_138 () Int (select .def_14 .def_38))
(define-fun .def_139 () Bool (<= .def_138 (- 1)))
(define-fun .def_89 () Bool (<= .def_8 0))
(define-fun .def_69 () Bool (<= .def_38 0))
(define-fun .def_70 () Bool (not .def_69))
(define-fun .def_136 () Bool (or .def_70 .def_89))
(define-fun .def_55 () Int (* (- 1) .def_38))
(define-fun .def_132 () Int (+ .def_18 .def_55))
(define-fun .def_133 () Int (+ .def_8 .def_132))
(define-fun .def_134 () Bool (= .def_133 0))
(define-fun .def_128 () Bool (<= .def_16 .def_18))
...
(define-fun .def_159 () Bool (and .def_110 .def_158))
...
(define-fun .def_86 () Bool (<= .y.16 0))
(define-fun .def_87 () Bool (not .def_86))
(define-fun .def_83 () Bool (<= .y.19 0))
...
(define-fun .def_71 () Bool (or .def_48 .def_70))
(define-fun .def_61 () Int (* (- 16777216) .def_16))
(define-fun .def_62 () Int (* (- 1) .def_61))
(define-fun .def_64 () Real (* (/ 1 16777216) (to_real .def_62)))
(define-fun .def_65 () Int (to_int .def_64))
(define-fun .def_66 () Bool (<= .def_65 .def_12))
...
(define-fun .def_43 () Int (* (- 1) .y.17))
(define-fun .def_44 () Int (+ .def_12 .def_43))
(define-fun .def_45 () Bool (= .def_44 (- 1)))
(define-fun .def_39 () (Array Int Int) (store .def_14 .def_38 .def_37))
(define-fun .def_40 () Bool (= .y.18 .def_39))
