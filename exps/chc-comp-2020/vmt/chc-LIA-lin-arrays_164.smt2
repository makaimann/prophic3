...
(define-fun .def_64 () Bool (= E_0 .def_63))
(define-fun .def_55 () Int (* (- 1) v_5))
(define-fun .def_56 () Int (+ .def_18 .def_55))
(define-fun .def_57 () Bool (= .def_56 (- 1)))
(define-fun .def_50 () Bool (= .def_20 .x.4))
