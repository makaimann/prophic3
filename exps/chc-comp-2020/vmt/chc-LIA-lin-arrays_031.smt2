...
(declare-fun F_13 () (Array Int Int))
...
(define-fun .def_8 () Int (! E_13 :next |.y.15|))
(define-fun .def_10 () Int (! .y.10 :next |.y.16|))
(define-fun .def_12 () (Array Int Int) (! F_13 :next |.y.17|))
(define-fun .def_14 () Int (! D_13 :next |.y.18|))
(define-fun .def_16 () Int (! A_14 :next |.y.19|))
...
(define-fun .def_27 () Int (! G_13 :next |.xtv.1|))
...
(define-fun .def_219 () Int (select .def_12 .def_27))
(define-fun .def_220 () Bool (= .def_219 47))
(define-fun .def_246 () Bool (not .def_220))
(define-fun .def_215 () Bool (<= .def_16 .def_14))
...
(define-fun .def_214 () Bool (and .def_32 .def_213))
...
(define-fun .def_218 () Bool (and .def_31 .def_217))
...
(define-fun .def_194 () (Array Int Int) (store .def_12 .def_27 47))
(define-fun .def_195 () Bool (= .y.17 .def_194))
...
(define-fun .def_174 () (Array Int Int) (store .def_12 .def_27 46))
...
(define-fun .def_150 () (Array Int Int) (store .def_12 .def_27 45))
...
(define-fun .def_123 () (Array Int Int) (store .def_12 .def_27 44))
...
(define-fun .def_96 () (Array Int Int) (store .def_12 .def_27 43))
...
(define-fun .def_64 () (Array Int Int) (store .def_12 .def_27 42))
