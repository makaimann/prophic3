...
(define-fun .def_133 () Bool (= .x.119 .x.125))
(define-fun .def_199 () Bool (not .def_133))
(define-fun .def_132 () Bool (= .x.122 .x.124))
(define-fun .def_197 () Bool (not .def_132))
(define-fun .def_198 () Bool (or .def_64 .def_197))
(define-fun .def_200 () Bool (or .def_198 .def_199))
(define-fun .def_150 () Bool (= .x.122 .x.127))
(define-fun .def_148 () Bool (= .x.101 .x.121))
(define-fun .def_146 () Bool (= .x.110 .x.118))
(define-fun .def_144 () Bool (= .x.124 .x.126))
(define-fun .def_142 () Bool (= .x.114 .x.127))
(define-fun .def_140 () Bool (= .x.118 .x.125))
(define-fun .def_138 () Bool (= .x.119 .x.121))
(define-fun .def_137 () Bool (= .x.106 .x.126))
...
(define-fun .def_193 () Bool (and C1_3 .def_71))
...
(define-fun .def_155 () Bool (or C1_3 .def_154))
...
(define-fun .def_152 () Bool (or C1_3 .def_151))
(define-fun .def_134 () Bool (and .def_132 .def_133))
(define-fun .def_135 () Bool (or C1_3 .def_134))
