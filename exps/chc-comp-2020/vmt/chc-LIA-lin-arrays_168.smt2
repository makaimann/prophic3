...
(define-fun .def_10 () (Array Int Int) (! B_0 :next |I|))
(define-fun .def_12 () Int (! C_0 :next |J|))
(define-fun .def_14 () Int (! D_0 :next |.x.2|))
(define-fun .def_66 () Int (! E_0 :next |.xpv.1|))
...
(define-fun .def_52 () Int (* (- 1) J))
(define-fun .def_53 () Int (+ .def_12 .def_52))
...
(define-fun .def_49 () Bool (= I .def_48))
...
(define-fun .def_75 () Bool (and .def_50 .def_74))
