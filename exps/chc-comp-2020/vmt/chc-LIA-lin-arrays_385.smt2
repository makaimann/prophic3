...
(define-fun .def_46 () Bool (= .def_12 .x.3))
(define-fun .def_39 () Bool (= v_3 2))
(define-fun .def_17 () Bool (<= .def_12 .def_10))
(define-fun .def_40 () Bool (and .def_17 .def_39))
(define-fun .def_38 () Bool (= .def_8 .x.2))
...
(define-fun .def_34 () Int (* 2 .def_32))
(define-fun .def_35 () (Array Int Int) (store .def_8 .def_10 .def_34))
(define-fun .def_36 () Bool (= .x.2 .def_35))
...
(define-fun .def_56 () Int (* 2 .def_51))
