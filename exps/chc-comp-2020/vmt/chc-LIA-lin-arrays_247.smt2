...
(define-fun .def_20 () Int (! .y.6 :next |.x.5|))
(define-fun .def_22 () Bool (! .loc.7 :next |.loc.10|))
(define-fun .def_76 () Int (! F_1 :next |.xpv.1|))
...
(define-fun .def_63 () Bool (= .def_14 .x.5))
...
(define-fun .def_45 () Bool (= .def_20 .x.5))
...
(define-fun .def_43 () Bool (= .def_10 .x.4))
...
(define-fun .def_85 () Bool (<= 0 .def_76))
