; llreve-bench/./muz/libc__strncmp_1_000.smt2
(set-logic HORN)
...
(let ((a!2 (or a!1 (= (select M J) 0) (not (= (select M J) (select M K))))))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int) (I Int) (J Int) (K (Array Int Int)) (L Int) (M Int) (N Int) (O (Array Int Int)) ) 
    (=>
      ...
      (a!2 (or (= J 1) (= (select K I) 0) (not (= (select K I) (select K H))))))
