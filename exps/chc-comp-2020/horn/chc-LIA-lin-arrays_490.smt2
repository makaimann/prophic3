; llreve-bench/./muz/libc__sbrk_1_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G (Array Int Int)) (H (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (- 1) (select H (- 9)))) (not (= G H)))))
  (and (= (select C (- 9)) 0)
       (= (select B (- 9)) 0)
       (= F 0)
       (= A F)
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C Int) (D Int) (E (Array Int Int)) (F (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (- 1) (select F (- 9)))) (not (= E F)))))
...
(assert
  (forall ( (A Int) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) (G (Array Int Int)) (H (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (select G (- 9)) (- 1))) (not (= G H)))))
  (and (= (select C (- 9)) 0)
       (= (select B (- 9)) 0)
       (= E 0)
       (= E A)
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G (Array Int Int)) (H (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (select G (- 9)) (select H (- 9)))) (not (= G H)))))
  (and (= (select A (- 9)) 0)
       (= (select B (- 9)) 0)
       (= D 0)
       (= D F)
...
(assert
  (forall ( (A (Array Int Int)) (B Int) (C Int) (D Int) (E (Array Int Int)) (F (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (select E (- 9)) (select F (- 9)))) (not (= E F)))))
  (and (= (select A (- 9)) 0)
       (not (= (select F (- 9)) 0))
       (= B 0)
       (= D 0)
...
(assert
  (forall ( (A Int) (B Int) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (select E (- 9)) (- 1))) (not (= E F)))))
  (and (= (select C (- 9)) 0)
       (not (= (select E (- 9)) 0))
       (= B 0)
       (= B A)
...
(assert
  (forall ( (A Int) (B Int) (C (Array Int Int)) (D (Array Int Int)) ) 
    (=>
      (and
        (let ((a!1 (or (not (= (select C (- 9)) (select D (- 9)))) (not (= C D)))))
...
(assert
  (forall ( (A Int) (B Int) (C (Array Int Int)) (D Int) (E (Array Int Int)) (F (Array Int Int)) (G (Array Int Int)) ) 
    (=>
      (and
        (INV_MAIN_0 B C A E)
        (let ((a!1 (not (= (- 1) (ite (<= 0 D) (select E (- 9)) (- 1))))))
  (and (not (<= B 0)) (or a!1 (not (= F G))) (not (<= 0 B))))
      )
      END_QUERY
    )
  )
