; llreve-bench/./muz/libc__strchr_1_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E (Array Int Int)) (F (Array Int Int)) ) 
    (=>
      (and
        ...
        (and (= (select F D) B) (or (not (= C D)) (not (= E F))) (= (select E C) A))
      )
      END_QUERY
    )
  )
