; llreve-bench/./muz/heap__selsort_000.smt2
(set-logic HORN)
  ...
  (forall ( (A (Array Int Int)) (B Int) (C (Array Int Int)) (D Int) (E Int) (F Int) (G (Array Int Int)) (H Int) (I Int) (J Int) (K Int) (L (Array Int Int)) (M Int) (N Int) ) 
    (=>
      (and
        ...
        (let ((a!1 (store G (+ H (* 4 I)) (select G (+ H (* 4 F)))))
      (a!3 (<= (select G (+ H (* 4 F))) (select G (+ H (* 4 I)))))
      (a!4 (<= (select L (+ M (* 4 N))) (select L (+ M (* 4 K)))))
      (a!5 (store L (+ M (* 4 N)) (select L (+ M (* 4 K))))))
(let ((a!2 (store a!1 (+ H (* 4 F)) (select G (+ H (* 4 I)))))
      (a!6 (store a!5 (+ M (* 4 K)) (select L (+ M (* 4 N))))))
  (and (= C a!2)
       (= B (+ 1 K))
       (= D (+ 1 F))
       a!3
