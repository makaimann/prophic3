; llreve-bench/./muz/heap__propagate_000.smt2
(set-logic HORN)
  ...
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G (Array Int Int)) (H (Array Int Int)) ) 
    (=>
      (and
        ...
        (and (<= C E) (or (not (= E F)) (not (= G H))) (<= D F))
      )
      END_QUERY
    )
  )
  ...
  (forall ( (A (Array Int Int)) (B Int) (C (Array Int Int)) (D Int) (E Int) (F (Array Int Int)) (G Int) (H Int) (I Int) (J Int) (K (Array Int Int)) (L Int) ) 
    (=>
      (and
        ...
        (let ((a!1 (store F (+ 4 G (* 4 H)) (select F (+ G (* 4 H)))))
      (a!2 (= A (store K (+ 4 L (* 4 J)) (select K L)))))
  (and (= C a!1) (= B (+ 1 J)) (= D (+ 1 H)) (not (<= E H)) (not (<= I J)) a!2))
      )
