; chc-comp19-benchmarks/./lia-lin-arr/chc-lia-lin-arr-0026_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C Int) (D Int) (E Int) (F (Array Int Int)) (G (Array Int Int)) (H Int) ) 
    (=>
      (and
        (inv1 A B C D)
        (and (= (store B C E) G) (= (store A C (+ D E)) F) (not (<= D C)) (= H (+ 1 C)))
      )
      (inv1 F G H D)
    )
  )
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (inv2 A B C D E)
        (and (>= D E) (not (<= E F)) (not (<= F 0)) (not (= (select C F) E)))
      )
      false
    )
  )
