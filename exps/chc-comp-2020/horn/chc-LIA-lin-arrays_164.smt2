; chc-comp19-benchmarks/./lia-lin-arr/chc-lia-lin-arr-0029_000.smt2
(set-logic HORN)
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C Int) (D Int) (E Int) (F Int) (G (Array Int Int)) (H (Array Int Int)) (I Int) ) 
    (=>
      (and
        (inv1 A B C D)
        (and (= (store B C (+ C E)) H)
...
(assert
  (forall ( (A (Array Int Int)) (B (Array Int Int)) (C (Array Int Int)) (D Int) (E Int) (F Int) ) 
    (=>
      (and
        (inv2 A B C D E)
        (and (<= 0 (select C F)) (not (<= E F)) (not (<= F 0)) (>= D E))
      )
      false
    )
  )
