...
(define-fun .def_104 () (Array Int Int) (! main@%shadow.mem.2_0 :next |.xtv.9|))
(define-fun .def_105 () (Array Int Int) (! main@%_19_0 :next |.xtv.10|))
(define-fun .def_115 () (Array Int Int) (! main@%shadow.mem.2_1 :next |.xtv.11|))
(define-fun .def_122 () Int (! main@%_10_0_0 :next |.xtv.12|))
(define-fun .def_148 () Int (! main@%_17_0 :next |.xtv.13|))
(define-fun .def_155 () Int (! main@%_18_0 :next |.xtv.14|))
...
(define-fun .def_126 () Int (+ .def_10 .def_123))
...
(define-fun .def_188 () Bool (and .def_23 .def_128))
(define-fun .def_131 () Bool (<= .def_122 0))
(define-fun .def_132 () Bool (not .def_131))
(define-fun .def_19 () Bool (<= .def_8 0))
(define-fun .def_133 () Bool (or .def_19 .def_132))
(define-fun .def_189 () Bool (and .def_133 .def_188))
(define-fun .def_20 () Bool (not .def_19))
(define-fun .def_190 () Bool (and .def_20 .def_189))
(define-fun .def_138 () Int (select .def_12 .def_122))
(define-fun .def_186 () Bool (= .def_138 10))
...
(define-fun .def_183 () Bool (= .def_12 .y.10))
...
(define-fun .def_176 () Bool (= .def_12 .def_115))
(define-fun .def_97 () Bool (and .def_75 .def_93))
(define-fun .def_98 () Bool (not .def_97))
(define-fun .def_177 () Bool (or .def_98 .def_176))
(define-fun .def_172 () (Array Int Int) (store .def_12 .def_155 20))
(define-fun .def_173 () Bool (= .def_105 .def_172))
(define-fun .def_85 () Bool (not .def_83))
(define-fun .def_174 () Bool (or .def_85 .def_173))
(define-fun .def_169 () Bool (or .def_20 .def_85))
(define-fun .def_164 () Bool (<= .def_155 0))
(define-fun .def_165 () Bool (not .def_164))
(define-fun .def_166 () Bool (or .def_19 .def_165))
(define-fun .def_167 () Bool (or .def_85 .def_166))
(define-fun .def_156 () Int (* (- 1) .def_155))
(define-fun .def_159 () Int (+ .def_148 .def_156))
(define-fun .def_160 () Int (+ .def_8 .def_159))
(define-fun .def_161 () Bool (= .def_160 0))
(define-fun .def_162 () Bool (or .def_85 .def_161))
(define-fun .def_150 () Int (* (- 1) .def_148))
(define-fun .def_151 () Int (+ .def_10 .def_150))
(define-fun .def_152 () Bool (= .def_151 (- 1)))
(define-fun .def_153 () Bool (or .def_85 .def_152))
(define-fun .def_143 () Bool (= .def_10 14999))
(define-fun .def_144 () Bool (= .def_88 .def_143))
(define-fun .def_77 () Bool (not .def_75))
(define-fun .def_145 () Bool (or .def_77 .def_144))
(define-fun .def_139 () Bool (= .def_39 .def_138))
(define-fun .def_69 () Bool (not .def_68))
(define-fun .def_140 () Bool (or .def_69 .def_139))
(define-fun .def_136 () Bool (or .def_20 .def_69))
(define-fun .def_134 () Bool (or .def_69 .def_133))
(define-fun .def_129 () Bool (or .def_69 .def_128))
(define-fun .def_119 () Bool (= .y.10 .def_104))
(define-fun .def_120 () Bool (or .def_85 .def_119))
(define-fun .def_116 () Bool (= .y.10 .def_115))
(define-fun .def_117 () Bool (or .def_98 .def_116))
(define-fun .def_106 () Bool (= .def_104 .def_105))
(define-fun .def_107 () Bool (or .def_85 .def_106))
(define-fun .def_102 () Bool (or .def_83 .def_97))
...
(define-fun .def_114 () Bool (and .def_34 .def_113))
...
(define-fun .def_52 () Bool (<= .def_39 0))
(define-fun .def_53 () Bool (not .def_52))
(define-fun .def_54 () Bool (or .def_19 .def_53))
(define-fun .def_47 () Int (* (- 1) .def_39))
