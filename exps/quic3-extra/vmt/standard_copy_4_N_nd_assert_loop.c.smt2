...
(define-fun .def_259 () Int (select .def_12 .def_43))
(define-fun .def_258 () Int (select .def_16 .def_49))
(define-fun .def_260 () Bool (= .def_258 .def_259))
(define-fun .def_282 () Bool (not .def_260))
(define-fun .def_84 () Int (* (- 1) .def_49))
(define-fun .def_157 () Int (+ .def_18 .def_84))
(define-fun .def_253 () Int (+ .def_14 .def_157))
(define-fun .def_254 () Bool (= .def_253 0))
(define-fun .def_247 () Bool (<= .def_20 .def_18))
(define-fun .def_248 () Bool (not .def_247))
(define-fun .def_91 () Int (* (- 1) .def_43))
(define-fun .def_169 () Int (+ .def_18 .def_91))
(define-fun .def_245 () Int (+ .def_8 .def_169))
...
(define-fun .def_251 () Bool (and .def_42 .def_250))
...
(define-fun .def_222 () Bool (<= .def_28 .def_18))
...
(define-fun .def_217 () Bool (and .def_153 .def_216))
(define-fun .def_155 () Bool (or .def_51 .def_152))
(define-fun .def_218 () Bool (and .def_155 .def_217))
(define-fun .def_159 () Int (+ .def_20 .def_84))
(define-fun .def_160 () Int (+ .def_18 .def_159))
(define-fun .def_161 () Bool (= .def_160 0))
(define-fun .def_219 () Bool (and .def_161 .def_218))
(define-fun .def_163 () Bool (or .def_45 .def_48))
(define-fun .def_220 () Bool (and .def_163 .def_219))
...
(define-fun .def_96 () Bool (<= .def_22 .def_10))
...
(define-fun .def_81 () (Array Int Int) (store .def_16 .def_49 .def_77))
(define-fun .def_82 () Bool (= .y.31 .def_81))
(define-fun .def_78 () (Array Int Int) (store .def_12 .def_43 .def_77))
(define-fun .def_79 () Bool (= .y.29 .def_78))
