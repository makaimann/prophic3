...
(define-fun .def_57 () Int (! main@%_23_0_0 :next |.xtv.3|))
(define-fun .def_91 () Bool (not .def_24))
(define-fun .def_38 () Bool (not .def_26))
(define-fun .def_168 () Bool (! (and .def_38 .def_91) :init true))
(define-fun .def_110 () Int (select .def_14 .def_57))
(define-fun .def_109 () Int (select .def_18 .def_31))
(define-fun .def_111 () Bool (= .def_109 .def_110))
(define-fun .def_158 () Bool (not .def_111))
(define-fun .def_80 () Int (* (- 1) .def_31))
(define-fun .def_124 () Int (+ .def_20 .def_80))
(define-fun .def_125 () Int (+ .def_16 .def_124))
(define-fun .def_126 () Bool (= .def_125 0))
(define-fun .def_118 () Bool (<= .def_8 0))
(define-fun .def_121 () Bool (not .def_118))
(define-fun .def_74 () Bool (<= .def_57 0))
(define-fun .def_75 () Bool (not .def_74))
(define-fun .def_119 () Bool (or .def_75 .def_118))
(define-fun .def_115 () Bool (<= .def_22 .def_20))
(define-fun .def_116 () Bool (not .def_115))
(define-fun .def_65 () Int (* (- 1) .def_57))
(define-fun .def_112 () Int (+ .def_20 .def_65))
...
(define-fun .def_129 () Bool (and .def_30 .def_128))
...
(define-fun .def_70 () Bool (<= .def_20 .def_12))
...
(define-fun .def_58 () (Array Int Int) (store .def_14 .def_57 .def_53))
(define-fun .def_59 () Bool (= .y.18 .def_58))
(define-fun .def_54 () (Array Int Int) (store .def_18 .def_31 .def_53))
