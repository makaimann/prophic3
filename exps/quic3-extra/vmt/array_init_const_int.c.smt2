...
(define-fun .def_85 () Int (select .def_12 .def_27))
(define-fun .def_86 () Bool (<= .def_14 .def_85))
(define-fun .def_112 () Bool (not .def_86))
(define-fun .def_80 () Bool (<= .def_18 .def_16))
(define-fun .def_81 () Bool (not .def_80))
(define-fun .def_52 () Int (* (- 1) .def_27))
(define-fun .def_75 () Int (* 4 .def_16))
(define-fun .def_77 () Int (+ .def_75 .def_52))
