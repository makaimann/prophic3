...
(define-fun .def_32 () Int (! main@%_17_0_0 :next |.xtv.1|))
(define-fun .def_72 () Int (! main@%_14_0_0 :next |.xtv.2|))
(define-fun .def_92 () Int (! main@%_19_0_0 :next |.xtv.3|))
...
(define-fun .def_50 () Bool (<= .def_32 0))
(define-fun .def_51 () Bool (not .def_50))
(define-fun .def_88 () Bool (or .def_51 .def_87))
(define-fun .def_41 () Int (* (- 1) .def_32))
(define-fun .def_83 () Int (+ .def_14 .def_41))
...
(define-fun .def_46 () Bool (<= .def_14 .def_8))
...
(define-fun .def_54 () Bool (not .def_49))
