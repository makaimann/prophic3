...
(define-fun .def_55 () Int (! main@%_21_0_0 :next |.xtv.2|))
(define-fun .def_59 () Int (! main@%_23_0_0 :next |.xtv.3|))
(define-fun .def_95 () Bool (not .def_28))
(define-fun .def_37 () Bool (not .def_30))
(define-fun .def_181 () Bool (! (and .def_37 .def_95) :init true))
(define-fun .def_134 () Int (select .def_20 .def_55))
(define-fun .def_133 () Int (select .def_14 .def_59))
(define-fun .def_135 () Bool (= .def_133 .def_134))
(define-fun .def_171 () Bool (not .def_135))
(define-fun .def_128 () Bool (<= .def_8 0))
(define-fun .def_131 () Bool (not .def_128))
(define-fun .def_63 () Bool (<= .def_59 0))
(define-fun .def_64 () Bool (not .def_63))
(define-fun .def_129 () Bool (or .def_64 .def_128))
(define-fun .def_67 () Int (* (- 1) .def_59))
(define-fun .def_124 () Int (+ .def_24 .def_67))
(define-fun .def_125 () Int (+ .def_8 .def_124))
(define-fun .def_126 () Bool (= .def_125 0))
(define-fun .def_75 () Bool (<= .def_55 0))
(define-fun .def_76 () Bool (not .def_75))
(define-fun .def_33 () Bool (<= .def_16 0))
(define-fun .def_119 () Bool (or .def_33 .def_76))
(define-fun .def_116 () Bool (<= .def_26 .def_22))
(define-fun .def_117 () Bool (not .def_116))
(define-fun .def_83 () Int (* (- 1) .def_55))
(define-fun .def_113 () Int (+ .def_24 .def_83))
...
(define-fun .def_161 () Bool (= .y.26 0))
(define-fun .def_159 () Bool (= .y.25 0))
...
(define-fun .def_88 () Bool (<= .def_22 .def_12))
...
(define-fun .def_68 () Int (+ .def_18 .def_67))
(define-fun .def_69 () Int (+ .def_16 .def_68))
(define-fun .def_70 () Bool (= .def_69 0))
(define-fun .def_65 () Bool (or .def_33 .def_64))
(define-fun .def_60 () (Array Int Int) (store .def_20 .def_59 .def_54))
(define-fun .def_61 () Bool (= .y.24 .def_60))
(define-fun .def_56 () (Array Int Int) (store .def_14 .def_55 .def_54))
(define-fun .def_57 () Bool (= .y.21 .def_56))
(define-fun .def_50 () Int (* (- 1) .y.23))
(define-fun .def_51 () Int (+ .def_18 .def_50))
(define-fun .def_52 () Bool (= .def_51 (- 1)))
(define-fun .def_46 () Int (* (- 1) .y.20))
