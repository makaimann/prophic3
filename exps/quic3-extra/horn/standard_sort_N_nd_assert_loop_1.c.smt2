...
(assert (forall ((main@%_12_0 Int)
         ...
         (main@%x.0.i_2 Int)
         (main@%_1_0 Int))
  (let ((a!1 (=> main@_bb3_0 (= main@%_15_0 (+ main@%_3_0 (* main@%x.0.i_0 1)))))
        (a!2 (=> main@_bb3_0 (= main@%_18_0 (+ main@%_3_0 (* main@%_17_0 1))))))
  (let ((a!3 (and (main@_bb2 main@%_3_0
                             main@%shadow.mem.0_0
                             main@%x.0.i_0
                             main@%_1_0)
                  true
                  (= main@%_12_0 (+ main@%_1_0 (- 1)))
                  (= main@%_13_0 (< main@%x.0.i_0 main@%_12_0))
                  main@%_13_0
                  (=> main@_bb3_0 (and main@_bb3_0 main@_bb2_0))
                  a!1
                  (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_15_0 0)))
                  (=> main@_bb3_0 (> main@%_3_0 0))
                  (=> main@_bb3_0
                      (= main@%_16_0 (select main@%shadow.mem.0_0 main@%_15_0)))
                  (=> main@_bb3_0 (= main@%_17_0 (+ main@%x.0.i_0 1)))
                  a!2
                  (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_18_0 0)))
                  (=> main@_bb3_0 (> main@%_3_0 0))
                  (=> main@_bb3_0
                      (= main@%_19_0 (select main@%shadow.mem.0_0 main@%_18_0)))
                  (=> main@_bb3_0 (= main@%_20_0 (< main@%_16_0 main@%_19_0)))
                  (=> main@_bb5_0 (and main@_bb5_0 main@_bb3_0))
                  (=> (and main@_bb5_0 main@_bb3_0) main@%_20_0)
                  (=> main@_bb5_0 (= main@%_23_0 (+ main@%x.0.i_0 1)))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb5_0))
                  main@_bb2_1
                  (=> (and main@_bb2_1 main@_bb5_0)
                      (= main@%x.0.i_1 main@%_23_0))
                  (=> (and main@_bb2_1 main@_bb5_0)
...
(assert (forall ((main@%_1_0 Int)
  ...
  (let ((a!3 (and (main@_bb2 main@%_3_0
                  ...
                  (=> (and main@_bb4_0 main@_bb3_0) (not main@%_20_0))
