...
(assert (forall ((main@%_2_0 Bool)
  ...
  (=> (and main@entry
      ...
      (main@_bb main@%i.0.i_1 main@%_3_0 main@%shadow.mem.0_1 main@%_1_0))))
(assert (forall ((main@_bb_0 Bool)
         ...
         (main@%_1_0 Int))
  (let ((a!1 (=> main@_bb1_0 (= main@%_8_0 (+ main@%_3_0 (* main@%i.0.i_0 1))))))
  (let ((a!2 (and (main@_bb main@%i.0.i_0
                  ...
                  (=> main@_bb1_0 (= main@%_7_0 main@%i.0.i_0))
                  a!1
                  (=> main@_bb1_0 (or (<= main@%_3_0 0) (> main@%_8_0 0)))
    ...
    (=> a!2 (main@_bb main@%i.0.i_2 main@%_3_0 main@%shadow.mem.0_2 main@%_1_0))))))
(assert (forall ((main@%i.0.i_0 Int)
         ...
         (main@%x.0.i_1 Int)
         (main@%_1_0 Int))
  (=> (and (main@_bb main@%i.0.i_0 main@%_3_0 main@%shadow.mem.0_0 main@%_1_0)
           true
           (= main@%_5_0 (< main@%i.0.i_0 main@%_1_0))
           (=> main@_bb2_0 (and main@_bb2_0 main@_bb_0))
           main@_bb2_0
           (=> (and main@_bb2_0 main@_bb_0) (not main@%_5_0))
           (=> (and main@_bb2_0 main@_bb_0) (= main@%x.0.i_0 0))
           (=> (and main@_bb2_0 main@_bb_0) (= main@%x.0.i_1 main@%x.0.i_0)))
      (main@_bb2 main@%_3_0 main@%shadow.mem.0_0 main@%x.0.i_1 main@%_1_0))))
(assert (forall ((main@%_12_0 Bool)
         ...
         (main@%x.0.i_2 Int)
         (main@%_1_0 Int))
  (let ((a!1 (=> main@_bb3_0 (= main@%_17_0 (+ main@%_3_0 (* main@%x.0.i_0 1)))))
        (a!2 (=> main@_bb3_0 (= main@%_19_0 (+ main@%_3_0 (* main@%_14_0 1))))))
  (let ((a!3 (and (main@_bb2 main@%_3_0
                             main@%shadow.mem.0_0
                             main@%x.0.i_0
                             main@%_1_0)
                  true
                  (= main@%_12_0 (< main@%x.0.i_0 main@%_1_0))
                  main@%_12_0
                  (=> main@_bb3_0 (and main@_bb3_0 main@_bb2_0))
                  (=> main@_bb3_0 (= main@%_15_0 (> main@%_14_0 main@%x.0.i_0)))
                  (=> main@_bb3_0 (= main@%_16_0 (< main@%_14_0 main@%_1_0)))
                  (=> main@_bb3_0 (= main@%..i_0 (and main@%_15_0 main@%_16_0)))
                  (=> main@_bb3_0 main@%..i_0)
                  a!1
                  (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_17_0 0)))
                  (=> main@_bb3_0 (> main@%_3_0 0))
                  (=> main@_bb3_0
                      (= main@%_18_0 (select main@%shadow.mem.0_0 main@%_17_0)))
                  a!2
                  (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_19_0 0)))
                  (=> main@_bb3_0 (> main@%_3_0 0))
                  (=> main@_bb3_0
                      (= main@%_20_0 (select main@%shadow.mem.0_0 main@%_19_0)))
                  (=> main@_bb3_0 (= main@%_21_0 (< main@%_18_0 main@%_20_0)))
                  (=> main@_bb5_0 (and main@_bb5_0 main@_bb3_0))
                  (=> (and main@_bb5_0 main@_bb3_0) main@%_21_0)
                  (=> main@_bb5_0 (= main@%_24_0 (+ main@%x.0.i_0 1)))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb5_0))
                  main@_bb2_1
                  (=> (and main@_bb2_1 main@_bb5_0)
                      (= main@%x.0.i_1 main@%_24_0))
                  (=> (and main@_bb2_1 main@_bb5_0)
                      (= main@%x.0.i_2 main@%x.0.i_1)))))
    (=> a!3
        (main@_bb2 main@%_3_0 main@%shadow.mem.0_0 main@%x.0.i_2 main@%_1_0))))))
(assert (forall ((main@%_12_0 Bool)
         (main@_bb2_0 Bool)
         (main@%_1_0 Int)
         (main@%_15_0 Bool)
  ...
  (let ((a!3 (and (main@_bb2 main@%_3_0
                  ...
                  (=> (and main@_bb4_0 main@_bb3_0) (not main@%_21_0))
