...
(assert (forall ((main@%_2_0 Bool)
  ...
  (=> (and main@entry
      ...
      (main@_bb main@%_3_0 main@%i.0.i_1 main@%shadow.mem.0_1 main@%_1_0))))
(assert (forall ((main@_bb_0 Bool)
  ...
  (let ((a!2 (and (main@_bb main@%_3_0
                  ...
                  (=> main@_bb1_0
                      (= main@%_8_0 (store main@%shadow.mem.0_0 main@%_7_0 0)))
    ...
    (=> a!2 (main@_bb main@%_3_0 main@%i.0.i_2 main@%shadow.mem.0_2 main@%_1_0))))))
(assert (forall ((main@%i.0.i_0 Int)
         ...
         (main@%x.0.i_1 Int)
         (main@%_1_0 Int))
  (=> (and (main@_bb main@%_3_0 main@%i.0.i_0 main@%shadow.mem.0_0 main@%_1_0)
           true
           (= main@%_5_0 (< main@%i.0.i_0 main@%_1_0))
...
(assert (forall ((main@%_11_0 Bool)
         ...
         (main@%x.0.i_2 Int)
         (main@%_1_0 Int))
  (let ((a!1 (=> main@_bb3_0 (= main@%_13_0 (+ main@%_3_0 (* main@%x.0.i_0 1)))))
        (a!2 (=> main@_bb3_0 (= main@%_15_0 (> main@%_14_0 (- 1))))))
  (let ((a!3 (and (main@_bb2 main@%_3_0
                  ...
                  a!1
                  (=> main@_bb3_0 (or (<= main@%_3_0 0) (> main@%_13_0 0)))
                  (=> main@_bb3_0 (> main@%_3_0 0))
                  (=> main@_bb3_0
                      (= main@%_14_0 (select main@%shadow.mem.0_0 main@%_13_0)))
                  a!2
                  (=> main@_bb5_0 (and main@_bb5_0 main@_bb3_0))
                  (=> (and main@_bb5_0 main@_bb3_0) main@%_15_0)
                  (=> main@_bb5_0 (= main@%_18_0 (+ main@%x.0.i_0 1)))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb5_0))
                  main@_bb2_1
                  (=> (and main@_bb2_1 main@_bb5_0)
                      (= main@%x.0.i_1 main@%_18_0))
                  (=> (and main@_bb2_1 main@_bb5_0)
...
(assert (forall ((main@%_1_0 Int)
  ...
  (let ((a!3 (and (main@_bb2 main@%_3_0
                  ...
                  (=> (and main@_bb4_0 main@_bb3_0) (not main@%_15_0))
