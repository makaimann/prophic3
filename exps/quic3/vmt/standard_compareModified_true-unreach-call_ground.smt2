...
(define-fun .def_71 () Int (! main@%tmp61.i_0_0 :next |.xtv.2|))
...
(define-fun .def_80 () Int (* (- 1) .def_41))
(define-fun .def_259 () Int (+ .def_30 .def_80))
...
(define-fun .def_146 () Int (* (- 1) .def_71))
(define-fun .def_251 () Int (+ .def_30 .def_146))
...
(define-fun .def_142 () Int (+ .def_20 .def_80))
(define-fun .def_143 () Int (+ .def_16 .def_142))
(define-fun .def_144 () Bool (= .def_143 0))
(define-fun .def_324 () Bool (and .def_144 .def_323))
...
(define-fun .def_168 () Int (select .def_14 .def_71))
(define-fun .def_173 () Bool (= .def_168 .def_172))
(define-fun .def_318 () Bool (not .def_173))
(define-fun .def_131 () Bool (<= .def_71 0))
...
(define-fun .def_305 () Bool (= .y.34 0))
(define-fun .def_287 () Bool (= .def_22 0))
(define-fun .def_303 () Bool (not .def_287))
...
(define-fun .def_190 () Bool (<= .def_30 .def_20))
...
(define-fun .def_289 () Bool (and .def_190 .def_288))
...
(define-fun .def_186 () Int (+ .def_26 .def_98))
(define-fun .def_187 () Int (+ .def_20 .def_186))
...
(define-fun .def_77 () (Array Int Int) (store .def_18 .def_41 .def_76))
(define-fun .def_78 () Bool (= .y.28 .def_77))
(define-fun .def_73 () (Array Int Int) (store .def_14 .def_72 .def_71))
(define-fun .def_74 () Bool (= .y.26 .def_73))
