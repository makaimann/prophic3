...
(define-fun .def_79 () Bool (<= .def_16 .def_14))
(define-fun .def_80 () Bool (not .def_79))
(define-fun .def_46 () Int (* (- 1) .def_25))
(define-fun .def_76 () Int (+ .def_14 .def_46))
...
(define-fun .def_83 () Bool (and .def_24 .def_82))
(define-fun .def_71 () Int (select .def_12 .def_25))
(define-fun .def_72 () Bool (<= .def_71 (- 1)))
(define-fun .def_107 () Bool (and .def_72 .def_83))
