...
(define-fun .def_82 () Bool (<= .def_20 .def_12))
...
(define-fun .def_71 () Bool (or .def_66 .def_70))
(define-fun .def_67 () Bool (not .def_66))
(define-fun .def_62 () Int (+ .def_16 .def_59))
(define-fun .def_63 () Int (+ .def_12 .def_62))
(define-fun .def_64 () Bool (= .def_63 0))
(define-fun .def_56 () (Array Int Int) (store .def_18 .def_31 .def_51))
(define-fun .def_57 () Bool (= .y.20 .def_56))
(define-fun .def_53 () (Array Int Int) (store .def_14 .def_52 .def_51))
(define-fun .def_54 () Bool (= .y.18 .def_53))
