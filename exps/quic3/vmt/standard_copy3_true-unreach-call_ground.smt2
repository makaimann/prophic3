...
(define-fun .def_75 () Int (! main@%tmp66.i_0_0 :next |.xtv.3|))
...
(define-fun .def_256 () Int (select .def_14 .def_75))
(define-fun .def_255 () Int (select .def_18 .def_45))
(define-fun .def_257 () Bool (= .def_255 .def_256))
(define-fun .def_295 () Bool (not .def_257))
(define-fun .def_98 () Int (* (- 1) .def_45))
(define-fun .def_171 () Int (+ .def_20 .def_98))
(define-fun .def_269 () Int (+ .def_16 .def_171))
(define-fun .def_270 () Bool (= .def_269 0))
(define-fun .def_263 () Bool (<= .def_8 0))
(define-fun .def_266 () Bool (not .def_263))
(define-fun .def_92 () Bool (<= .def_75 0))
(define-fun .def_93 () Bool (not .def_92))
(define-fun .def_264 () Bool (or .def_93 .def_263))
(define-fun .def_260 () Bool (<= .def_22 .def_20))
(define-fun .def_261 () Bool (not .def_260))
(define-fun .def_83 () Int (* (- 1) .def_75))
(define-fun .def_165 () Int (+ .def_20 .def_83))
(define-fun .def_258 () Int (+ .def_8 .def_165))
...
(define-fun .def_272 () Bool (and .def_48 .def_271))
...
(define-fun .def_289 () Bool (and .def_228 .def_288))
...
(define-fun .def_157 () Int (select .def_18 .def_75))
...
(define-fun .def_88 () Bool (<= .def_24 .def_12))
...
(define-fun .def_76 () (Array Int Int) (store .def_14 .def_75 .def_71))
(define-fun .def_77 () Bool (= .y.32 .def_76))
(define-fun .def_72 () (Array Int Int) (store .def_18 .def_45 .def_71))
(define-fun .def_73 () Bool (= .y.34 .def_72))
