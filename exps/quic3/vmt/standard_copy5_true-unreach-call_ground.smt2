...
(define-fun .def_381 () Int (select .def_14 .def_91))
(define-fun .def_380 () Int (select .def_18 .def_61))
(define-fun .def_382 () Bool (= .def_380 .def_381))
(define-fun .def_418 () Bool (not .def_382))
(define-fun .def_114 () Int (* (- 1) .def_61))
(define-fun .def_199 () Int (+ .def_20 .def_114))
(define-fun .def_394 () Int (+ .def_16 .def_199))
(define-fun .def_395 () Bool (= .def_394 0))
(define-fun .def_388 () Bool (<= .def_8 0))
(define-fun .def_391 () Bool (not .def_388))
(define-fun .def_108 () Bool (<= .def_91 0))
(define-fun .def_109 () Bool (not .def_108))
(define-fun .def_389 () Bool (or .def_109 .def_388))
(define-fun .def_385 () Bool (<= .def_22 .def_20))
(define-fun .def_386 () Bool (not .def_385))
(define-fun .def_99 () Int (* (- 1) .def_91))
(define-fun .def_193 () Int (+ .def_20 .def_99))
(define-fun .def_383 () Int (+ .def_8 .def_193))
...
(define-fun .def_397 () Bool (and .def_64 .def_396))
(define-fun .def_60 () Bool (not .def_59))
(define-fun .def_398 () Bool (and .def_60 .def_397))
(define-fun .def_419 () Bool (and .def_398 .def_418))
...
(define-fun .def_412 () Bool (and .def_361 .def_411))
...
(define-fun .def_399 () Bool (and .def_382 .def_398))
...
(define-fun .def_206 () Bool (or .def_63 .def_205))
...
(define-fun .def_323 () Bool (and .def_195 .def_322))
(define-fun .def_324 () Bool (and .def_197 .def_323))
...
(define-fun .def_271 () Bool (and .def_195 .def_270))
(define-fun .def_272 () Bool (and .def_197 .def_271))
(define-fun .def_273 () Bool (and .def_203 .def_272))
...
(define-fun .def_104 () Bool (<= .def_28 .def_12))
...
(define-fun .def_117 () Int (+ .def_16 .def_114))
