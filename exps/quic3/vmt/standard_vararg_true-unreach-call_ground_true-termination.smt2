...
(define-fun .def_61 () Int (* (- 1) .def_43))
(define-fun .def_131 () Int (+ .def_18 .def_61))
(define-fun .def_132 () Int (+ .def_8 .def_131))
(define-fun .def_133 () Bool (= .def_132 0))
(define-fun .def_89 () Bool (<= .def_8 0))
(define-fun .def_67 () Bool (<= .def_43 0))
(define-fun .def_68 () Bool (not .def_67))
(define-fun .def_128 () Bool (or .def_68 .def_89))
...
(define-fun .def_48 () Int (* (- 16777216) .def_16))
