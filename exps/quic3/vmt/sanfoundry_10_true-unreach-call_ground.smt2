...
(define-fun .def_192 () Int (! main@%tmp77.i_0_0 :next |.xtv.3|))
...
(define-fun .def_254 () Int (select .def_14 .def_192))
(define-fun .def_255 () Bool (= .def_10 .def_254))
(define-fun .def_243 () Bool (<= .def_192 0))
...
(define-fun .def_237 () Int (+ .def_16 .def_193))
...
(define-fun .def_264 () Bool (= .def_12 0))
...
(define-fun .def_204 () Int (* (- 1) .def_28))
(define-fun .def_205 () Int (+ .def_18 .def_204))
(define-fun .def_206 () Bool (<= (- 1) .def_205))
...
(define-fun .def_222 () Bool (= .y.29 .def_22))
...
(define-fun .def_121 () Bool (or .def_68 .def_100))
(define-fun .def_191 () Bool (and .def_121 .def_190))
...
(define-fun .def_130 () Bool (= .y.31 .def_129))
(define-fun .def_126 () Int (ite .def_125 1 .def_20))
(define-fun .def_127 () Bool (= .y.30 .def_126))
