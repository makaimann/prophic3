...
(assert (forall ((main@%i.1.i_0 Int)
  ...
  (=> (and (main@bb19.i main@%tmp8.i_0
           ...
           (=> (and main@bb29.i_0 main@bb19.i_0) (= main@%x.0.i_0 0))
      ...
      (main@bb29.i main@%tmp8.i_0
                   ...
                   main@%x.0.i_1
                   main@%tmp2.i_0))))
(assert (forall ((main@%tmp32.i_0 Bool)
         (main@bb29.i_0 Bool)
         (main@%tmp35.i_0 Int)
         (main@%tmp36.i_0 Int)
         (main@bb33.i_0 Bool)
  ...
  (let ((a!1 (=> main@bb33.i_0
                 (= main@%tmp35.i_0 (+ main@%tmp8.i_0 (* main@%x.0.i_0 1))))))
  (let ((a!2 (and (main@bb29.i main@%tmp8.i_0
                               main@%shadow.mem.1_0
                               main@%x.0.i_0
                               main@%tmp2.i_0)
                  true
                  (= main@%tmp32.i_0 (< main@%x.0.i_0 main@%tmp2.i_0))
                  main@%tmp32.i_0
                  ...
                  (=> main@bb33.i_0
                      (= main@%tmp36.i_0
                         (select main@%shadow.mem.1_0 main@%tmp35.i_0)))
                  (=> main@bb33.i_0 (= main@%tmp38.i_0 (= main@%tmp36.i_0 43)))
                  (=> main@bb43.i_0 (and main@bb43.i_0 main@bb33.i_0))
                  (=> (and main@bb43.i_0 main@bb33.i_0) main@%tmp38.i_0)
                  (=> main@bb43.i_0 (= main@%tmp45.i_0 (+ main@%x.0.i_0 1)))
                  (=> main@bb29.i_1 (and main@bb29.i_1 main@bb43.i_0))
                  main@bb29.i_1
                  (=> (and main@bb29.i_1 main@bb43.i_0)
                      (= main@%x.0.i_1 main@%tmp45.i_0))
                  (=> (and main@bb29.i_1 main@bb43.i_0)
  ...
  (let ((a!2 (and (main@bb29.i main@%tmp8.i_0
                  ...
                  (=> main@bb33.i_0
                      (= main@%tmp36.i_0
                         (select main@%shadow.mem.1_0 main@%tmp35.i_0)))
                  (=> main@bb33.i_0 (= main@%tmp38.i_0 (= main@%tmp36.i_0 43)))
                  (=> main@bb39.i_0 (and main@bb39.i_0 main@bb33.i_0))
                  (=> (and main@bb39.i_0 main@bb33.i_0) (not main@%tmp38.i_0))
                  (=> main@verifier.error_0
                      (and main@verifier.error_0 main@bb39.i_0))
