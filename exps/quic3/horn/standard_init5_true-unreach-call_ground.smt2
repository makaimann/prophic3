...
(assert (forall ((main@%i.4.i_0 Int)
  ...
  (=> (and (main@bb49.i main@%tmp8.i_0
           ...
           (=> (and main@bb59.i_0 main@bb49.i_0) (= main@%x.0.i_0 0))
      ...
      (main@bb59.i main@%tmp8.i_0
                   ...
                   main@%x.0.i_1
                   main@%tmp2.i_0))))
(assert (forall ((main@%tmp62.i_0 Bool)
         (main@bb59.i_0 Bool)
         (main@%tmp65.i_0 Int)
         (main@%tmp66.i_0 Int)
         (main@bb63.i_0 Bool)
  ...
  (let ((a!1 (=> main@bb63.i_0
                 (= main@%tmp65.i_0 (+ main@%tmp8.i_0 (* main@%x.0.i_0 1))))))
  (let ((a!2 (and (main@bb59.i main@%tmp8.i_0
                               main@%shadow.mem.4_0
                               main@%x.0.i_0
                               main@%tmp2.i_0)
                  true
                  (= main@%tmp62.i_0 (< main@%x.0.i_0 main@%tmp2.i_0))
                  main@%tmp62.i_0
                  ...
                  (=> main@bb63.i_0
                      (= main@%tmp66.i_0
                         (select main@%shadow.mem.4_0 main@%tmp65.i_0)))
                  (=> main@bb63.i_0 (= main@%tmp68.i_0 (= main@%tmp66.i_0 46)))
                  (=> main@bb73.i_0 (and main@bb73.i_0 main@bb63.i_0))
                  (=> (and main@bb73.i_0 main@bb63.i_0) main@%tmp68.i_0)
                  (=> main@bb73.i_0 (= main@%tmp75.i_0 (+ main@%x.0.i_0 1)))
                  (=> main@bb59.i_1 (and main@bb59.i_1 main@bb73.i_0))
                  main@bb59.i_1
                  (=> (and main@bb59.i_1 main@bb73.i_0)
  ...
  (let ((a!2 (and (main@bb59.i main@%tmp8.i_0
                  ...
                  (=> main@bb63.i_0
                      (= main@%tmp66.i_0
                         (select main@%shadow.mem.4_0 main@%tmp65.i_0)))
                  (=> main@bb63.i_0 (= main@%tmp68.i_0 (= main@%tmp66.i_0 46)))
                  (=> main@bb69.i_0 (and main@bb69.i_0 main@bb63.i_0))
                  (=> (and main@bb69.i_0 main@bb63.i_0) (not main@%tmp68.i_0))
