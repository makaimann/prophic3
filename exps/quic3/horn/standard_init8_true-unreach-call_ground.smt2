...
(assert (forall ((main@%i.5.i_0 Int)
  ...
  (=> (and (main@bb59.i main@%tmp8.i_0
      ...
      (main@bb69.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.6_1
                   main@%tmp2.i_0))))
(assert (forall ((main@bb69.i_0 Bool)
         (main@%tmp72.i_0 Bool)
         (main@%shadow.mem.6_0 (Array Int Int))
         (main@%tmp75.i_0 Int)
         (main@%i.6.i_0 Int)
  ...
  (let ((a!2 (and (main@bb69.i main@%tmp8.i_0
    ...
    (=> a!2
        (main@bb69.i main@%tmp8.i_0
                     ...
                     main@%shadow.mem.6_2
                     main@%tmp2.i_0))))))
(assert (forall ((main@%i.6.i_0 Int)
         (main@%tmp72.i_0 Bool)
         (main@%shadow.mem.6_0 (Array Int Int))
  ...
  (=> (and (main@bb69.i main@%tmp8.i_0
      ...
      (main@bb79.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.7_1
                   main@%tmp2.i_0))))
(assert (forall ((main@bb79.i_0 Bool)
         (main@%tmp82.i_0 Bool)
         (main@%shadow.mem.7_0 (Array Int Int))
         (main@%tmp85.i_0 Int)
         (main@%i.7.i_0 Int)
  ...
  (let ((a!2 (and (main@bb79.i main@%tmp8.i_0
    ...
    (=> a!2
        (main@bb79.i main@%tmp8.i_0
                     ...
                     main@%shadow.mem.7_2
                     main@%tmp2.i_0))))))
(assert (forall ((main@%i.7.i_0 Int)
         (main@%tmp82.i_0 Bool)
         (main@bb89.i_0 Bool)
         (main@bb79.i_0 Bool)
         (main@%x.0.i_0 Int)
  ...
  (=> (and (main@bb79.i main@%tmp8.i_0
           ...
           (=> (and main@bb89.i_0 main@bb79.i_0) (= main@%x.0.i_0 0))
...
(assert (forall ((main@%tmp92.i_0 Bool)
  ...
  (let ((a!1 (=> main@bb93.i_0
                 (= main@%tmp95.i_0 (+ main@%tmp8.i_0 (* main@%x.0.i_0 1))))))
  (let ((a!2 (and (main@bb89.i main@%tmp8.i_0
                               main@%shadow.mem.7_0
                               main@%x.0.i_0
                               main@%tmp2.i_0)
                  true
                  (= main@%tmp92.i_0 (< main@%x.0.i_0 main@%tmp2.i_0))
                  main@%tmp92.i_0
                  ...
                  (=> main@bb93.i_0
                      (= main@%tmp96.i_0
                         (select main@%shadow.mem.7_0 main@%tmp95.i_0)))
                  (=> main@bb93.i_0 (= main@%tmp98.i_0 (= main@%tmp96.i_0 49)))
                  (=> main@bb103.i_0 (and main@bb103.i_0 main@bb93.i_0))
                  (=> (and main@bb103.i_0 main@bb93.i_0) main@%tmp98.i_0)
                  (=> main@bb103.i_0 (= main@%tmp105.i_0 (+ main@%x.0.i_0 1)))
                  (=> main@bb89.i_1 (and main@bb89.i_1 main@bb103.i_0))
                  main@bb89.i_1
                  (=> (and main@bb89.i_1 main@bb103.i_0)
                      (= main@%x.0.i_1 main@%tmp105.i_0))
                  (=> (and main@bb89.i_1 main@bb103.i_0)
  ...
  (let ((a!2 (and (main@bb89.i main@%tmp8.i_0
                  ...
                  (=> main@bb93.i_0
                      (= main@%tmp96.i_0
                         (select main@%shadow.mem.7_0 main@%tmp95.i_0)))
                  (=> main@bb93.i_0 (= main@%tmp98.i_0 (= main@%tmp96.i_0 49)))
                  (=> main@bb99.i_0 (and main@bb99.i_0 main@bb93.i_0))
                  (=> (and main@bb99.i_0 main@bb93.i_0) (not main@%tmp98.i_0))
                  (=> main@verifier.error_0
                      (and main@verifier.error_0 main@bb99.i_0))
