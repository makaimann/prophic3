...
(assert (forall ((main@%_5_0 Int)
  ...
  (=> (and (main@entry @nd_char_0 @nd_0)
      ...
      (main@bb17.i @nd_char_0
                   ...
                   main@%_0_0
                   main@%_4_0))))
(assert (forall ((main@bb17.i_0 Bool)
         (main@%tmp20.i_0 Bool)
         (main@%_6_0 Int)
         (main@%shadow.mem2.0_0 (Array Int Int))
         (main@%tmp24.i_0 Int)
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main@bb17.i @nd_char_0
      ...
      (main@bb34.i main@%tmp8.i_0
                   ...
                   main@%_1_0
                   main@%_0_0))))
(assert (forall ((main@bb34.i_0 Bool)
         (main@%tmp37.i_0 Bool)
         (main@%tmp40.i_0 Int)
         (main@%shadow.mem4.0_0 (Array Int Int))
         (main@%tmp43.i_0 Int)
...
(assert (forall ((main@%tmp10.i_0 Int)
  ...
  (=> (and (main@bb34.i main@%tmp8.i_0
      ...
      (main@bb48.i main@%tmp8.i_0
                   ...
                   main@%tmp2.i_0
                   main@%_1_0))))
(assert (forall ((main@bb48.i_0 Bool)
         (main@%tmp51.i_0 Bool)
         (main@%tmp54.i_0 Int)
         (main@%shadow.mem.0_0 (Array Int Int))
         (main@%tmp57.i_0 Int)
...
(assert (forall ((main@%tmp12.i_0 Int)
  ...
  (=> (and (main@bb48.i main@%tmp8.i_0
      ...
      (main@bb62.i main@%tmp8.i_0
                   ...
                   main@%tmp2.i_0))))
(assert (forall ((main@bb62.i_0 Bool)
         (main@%tmp65.i_0 Bool)
         (main@%tmp68.i_0 Int)
         (main@%shadow.mem1.0_0 (Array Int Int))
         (main@%tmp71.i_0 Int)
...
(assert (forall ((main@%tmp14.i_0 Int)
  ...
  (=> (and (main@bb62.i main@%tmp8.i_0
      ...
      (main@bb76.i main@%tmp8.i_0
                   ...
                   main@%x.0.i_1
                   main@%tmp2.i_0))))
(assert (forall ((main@%tmp79.i_0 Bool)
         (main@bb76.i_0 Bool)
         (main@%tmp82.i_0 Int)
         (main@%tmp86.i_0 Int)
         (main@%tmp83.i_0 Int)
