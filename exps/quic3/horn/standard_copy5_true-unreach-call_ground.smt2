...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main@bb19.i @nd_char_0
      ...
      (main@bb36.i main@%tmp8.i_0
                   ...
                   main@%_0_0
                   main@%_3_0))))
(assert (forall ((main@bb36.i_0 Bool)
         (main@%tmp39.i_0 Bool)
         (main@%tmp42.i_0 Int)
         (main@%shadow.mem4.0_0 (Array Int Int))
         (main@%tmp45.i_0 Int)
...
(assert (forall ((main@%tmp10.i_0 Int)
  ...
  (=> (and (main@bb36.i main@%tmp8.i_0
      ...
      (main@bb50.i main@%tmp8.i_0
                   ...
                   main@%_5_0
                   main@%_0_0))))
(assert (forall ((main@bb50.i_0 Bool)
         (main@%tmp53.i_0 Bool)
         (main@%tmp56.i_0 Int)
         (main@%shadow.mem3.0_0 (Array Int Int))
         (main@%tmp59.i_0 Int)
...
(assert (forall ((main@%tmp12.i_0 Int)
  ...
  (=> (and (main@bb50.i main@%tmp8.i_0
      ...
      (main@bb64.i main@%tmp8.i_0
                   ...
                   main@%tmp2.i_0
                   main@%_5_0))))
(assert (forall ((main@bb64.i_0 Bool)
         (main@%tmp67.i_0 Bool)
         (main@%tmp70.i_0 Int)
         (main@%shadow.mem.0_0 (Array Int Int))
         (main@%tmp73.i_0 Int)
...
(assert (forall ((main@%tmp14.i_0 Int)
  ...
  (=> (and (main@bb64.i main@%tmp8.i_0
      ...
      (main@bb78.i main@%tmp8.i_0
                   ...
                   main@%tmp2.i_0))))
(assert (forall ((main@bb78.i_0 Bool)
         (main@%tmp81.i_0 Bool)
         (main@%tmp84.i_0 Int)
         (main@%shadow.mem5.0_0 (Array Int Int))
         (main@%tmp87.i_0 Int)
...
(assert (forall ((main@%tmp16.i_0 Int)
  ...
  (=> (and (main@bb78.i main@%tmp8.i_0
      ...
      (main@bb92.i main@%tmp8.i_0
                   ...
                   main@%x.0.i_1
                   main@%tmp2.i_0))))
(assert (forall ((main@%tmp95.i_0 Bool)
         (main@bb92.i_0 Bool)
         (main@%tmp98.i_0 Int)
         (main@%tmp102.i_0 Int)
         (main@%tmp99.i_0 Int)
