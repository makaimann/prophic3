...
(assert (forall ((main@%_7_0 Int)
  ...
  (=> (and (main@entry @nd_char_0 @nd_0)
      ...
      (main@bb21.i @nd_char_0
                   ...
                   main@%_1_0
                   main@%_2_0))))
(assert (forall ((main@bb21.i_0 Bool)
         (main@%tmp24.i_0 Bool)
         (main@%_8_0 Int)
         (main@%shadow.mem5.0_0 (Array Int Int))
         (main@%tmp28.i_0 Int)
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main@bb21.i @nd_char_0
      ...
      (main@bb38.i main@%tmp8.i_0
                   ...
                   main@%_6_0
                   main@%_1_0))))
(assert (forall ((main@bb38.i_0 Bool)
         (main@%tmp41.i_0 Bool)
         (main@%tmp44.i_0 Int)
         (main@%shadow.mem2.0_0 (Array Int Int))
         (main@%tmp47.i_0 Int)
...
(assert (forall ((main@%tmp10.i_0 Int)
  ...
  (=> (and (main@bb38.i main@%tmp8.i_0
      ...
      (main@bb52.i main@%tmp8.i_0
                   ...
                   main@%_3_0
                   main@%_6_0))))
(assert (forall ((main@bb52.i_0 Bool)
         (main@%tmp55.i_0 Bool)
         (main@%tmp58.i_0 Int)
         (main@%shadow.mem1.0_0 (Array Int Int))
         (main@%tmp61.i_0 Int)
...
(assert (forall ((main@%tmp12.i_0 Int)
  ...
  (=> (and (main@bb52.i main@%tmp8.i_0
      ...
      (main@bb66.i main@%tmp8.i_0
                   ...
                   main@%_0_0
                   main@%_3_0))))
(assert (forall ((main@bb66.i_0 Bool)
         (main@%tmp69.i_0 Bool)
         (main@%tmp72.i_0 Int)
         (main@%shadow.mem6.0_0 (Array Int Int))
         (main@%tmp75.i_0 Int)
...
(assert (forall ((main@%tmp14.i_0 Int)
  ...
  (=> (and (main@bb66.i main@%tmp8.i_0
      ...
      (main@bb80.i main@%tmp8.i_0
                   ...
                   main@%tmp2.i_0
                   main@%_0_0))))
(assert (forall ((main@bb80.i_0 Bool)
         (main@%tmp83.i_0 Bool)
         (main@%tmp86.i_0 Int)
         (main@%shadow.mem3.0_0 (Array Int Int))
         (main@%tmp89.i_0 Int)
...
(assert (forall ((main@%tmp16.i_0 Int)
  ...
  (=> (and (main@bb80.i main@%tmp8.i_0
      ...
      (main@bb94.i main@%tmp8.i_0
                   ...
                   main@%shadow.mem.0_1
                   main@%tmp2.i_0))))
(assert (forall ((main@bb94.i_0 Bool)
         (main@%tmp97.i_0 Bool)
         (main@%tmp100.i_0 Int)
         (main@%shadow.mem.0_0 (Array Int Int))
         (main@%tmp103.i_0 Int)
...
(assert (forall ((main@%tmp18.i_0 Int)
  ...
  (=> (and (main@bb94.i main@%tmp8.i_0
      ...
      (main@bb108.i main@%tmp8.i_0
                    ...
                    main@%x.0.i_1
                    main@%tmp2.i_0))))
(assert (forall ((main@%tmp111.i_0 Bool)
         (main@bb108.i_0 Bool)
         (main@%tmp114.i_0 Int)
         (main@%tmp118.i_0 Int)
         (main@%tmp115.i_0 Int)
