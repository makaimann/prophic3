...
(assert (forall ((main@%i.6.i_0 Int)
  ...
  (=> (and (main@bb69.i main@%tmp8.i_0
           ...
           (=> (and main@bb79.i_0 main@bb69.i_0) (= main@%x.0.i_0 0))
      ...
      (main@bb79.i main@%tmp8.i_0
                   ...
                   main@%x.0.i_1
                   main@%tmp2.i_0))))
(assert (forall ((main@%tmp82.i_0 Bool)
         (main@bb79.i_0 Bool)
         (main@%tmp85.i_0 Int)
         (main@%tmp86.i_0 Int)
         (main@bb83.i_0 Bool)
  ...
  (let ((a!1 (=> main@bb83.i_0
                 (= main@%tmp85.i_0 (+ main@%tmp8.i_0 (* main@%x.0.i_0 1))))))
  (let ((a!2 (and (main@bb79.i main@%tmp8.i_0
                  ...
                  (=> main@bb83.i_0
                      (= main@%tmp86.i_0
                         (select main@%shadow.mem.6_0 main@%tmp85.i_0)))
                  (=> main@bb83.i_0 (= main@%tmp88.i_0 (= main@%tmp86.i_0 48)))
                  (=> main@bb93.i_0 (and main@bb93.i_0 main@bb83.i_0))
                  (=> (and main@bb93.i_0 main@bb83.i_0) main@%tmp88.i_0)
                  (=> main@bb93.i_0 (= main@%tmp95.i_0 (+ main@%x.0.i_0 1)))
                  (=> main@bb79.i_1 (and main@bb79.i_1 main@bb93.i_0))
                  main@bb79.i_1
                  (=> (and main@bb79.i_1 main@bb93.i_0)
                      (= main@%x.0.i_1 main@%tmp95.i_0))
                  (=> (and main@bb79.i_1 main@bb93.i_0)
  ...
  (let ((a!2 (and (main@bb79.i main@%tmp8.i_0
                  ...
                  (=> main@bb83.i_0
                      (= main@%tmp86.i_0
                         (select main@%shadow.mem.6_0 main@%tmp85.i_0)))
                  (=> main@bb83.i_0 (= main@%tmp88.i_0 (= main@%tmp86.i_0 48)))
                  (=> main@bb89.i_0 (and main@bb89.i_0 main@bb83.i_0))
                  (=> (and main@bb89.i_0 main@bb83.i_0) (not main@%tmp88.i_0))
