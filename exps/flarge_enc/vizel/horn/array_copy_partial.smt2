(set-info :original "./vizel/llvm/array_copy_partial.bc")
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@._crit_edge_0 main@entry_0) (not main@%_6_0))
...
(assert (forall ((main@%_20_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb2_0) (not main@%_26_0))
