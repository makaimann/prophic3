(set-info :original "./flarge_enc/vizel/llvm/standard_copy_3_N_nd_assert_loop.bc")
...
(assert (forall ((main@%_10_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%shadow.mem.0_1 main@%_14_1)
...
(assert (forall ((main@%_18_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (> main@%_8_0 0)
                  (= main@%_21_0
                     (store main@%shadow.mem2.0_0 main@%_20_0 main@%_19_0))
                  ...
                  (= main@%shadow.mem2.0_1 main@%_21_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%shadow.mem2.1_1 main@%_21_0)
