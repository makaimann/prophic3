(set-info :original "./flarge_enc/vizel/llvm/standard_copy_4_N_nd_assert_loop.bc")
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (= main@%shadow.mem3.1_1 main@%_3_1)
...
(assert (forall ((main@%_20_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%shadow.mem.0_1 main@%_23_1)
...
(assert (forall ((main@%_27_0 Int)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (> main@%_10_0 0)
                  (= main@%_30_0
                     (store main@%shadow.mem3.0_0 main@%_29_0 main@%_28_0))
                  ...
                  (= main@%shadow.mem3.0_1 main@%_30_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (= main@%shadow.mem3.1_1 main@%_30_0)
                  (= main@%shadow.mem2.1_1 main@%_14_0)
                  (=> (and main@._crit_edge_0 main@._crit_edge.loopexit_0)
                      (= main@%shadow.mem3.1_2 main@%shadow.mem3.1_1))
                  (=> (and main@._crit_edge_0 main@._crit_edge.loopexit_0)
...
(assert (forall ((main@%_34_0 Bool)
  ...
  (let ((a!1 (and (main 4
                  ...
                  (> main@%_7_0 0)
                  (= main@%_37_0 (select main@%shadow.mem2.1_0 main@%_36_0))
