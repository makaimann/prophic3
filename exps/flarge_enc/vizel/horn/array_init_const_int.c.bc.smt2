(set-info :original "./flarge_enc/llvm/array_init_const_int.c.bc")
...
(assert (forall ((main@%_10_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        main@%shadow.mem.0.0_0)
                  true
                  (= main@%_10_0 (< main@%.1.i_0 main@%_0_0))
                  (= main@%_11_0 (and main@%assume.flag.0_0 main@%_10_0))
                  (= main@%_12_0 (+ main@%_4_0 (* main@%.1.i_0 4)))
                  (or (<= main@%_4_0 0) (> main@%_12_0 0))
                  (> main@%_4_0 0)
                  (= main@%_13_0 (select main@%shadow.mem.0.1_0 main@%_12_0))
                  (= main@%_14_0 (< main@%_13_0 main@%_1_0))
                  (= main@%_15_0 (+ main@%.1.i_0 1))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb2_0))
                  (=> (and main@_bb2_1 main@_bb2_0) (not main@%_14_0))
...
(assert (forall ((main@%_10_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb2_0) main@%_14_0)
