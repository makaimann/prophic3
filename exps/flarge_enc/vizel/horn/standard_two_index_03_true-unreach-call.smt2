(set-info :original "./flarge_enc/vizel/llvm/standard_two_index_03_true-unreach-call.bc")
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main 0
           ...
           (> main@%_6_1 0)
           (> main@%_7_1 0)
           (= main@%_8_1 (> main@%_3_1 1))
           (=> main@.lr.ph5_0 (and main@.lr.ph5_0 main@entry_0))
           (=> (and main@.lr.ph5_0 main@entry_0) main@%_8_1)
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@._crit_edge.thread_0 main@entry_0) (not main@%_8_1))
           (= main@%_9_0 (and main@%_5_1 main@%_8_1))
           (=> main@.lr.ph_0 (and main@.lr.ph_0 main@._crit_edge.thread_0))
           (= main@%assume.flag.0_0 main@%_9_0)
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge_0 main@_bb_0) (not main@%_19_0))
                  (= main@%.pre_0 (select main@%_16_0 main@%_6_0))
                  (= main@%.phi.trans.insert_0 (+ main@%_7_0 (* 1 1)))
                  (=> main@._crit_edge_0
                      (or (<= main@%_7_0 0) (> main@%.phi.trans.insert_0 0)))
                  (=> main@._crit_edge_0 (> main@%_7_0 0))
                  (= main@%.pre6_0
                     (select main@%_14_0 main@%.phi.trans.insert_0))
                  (= main@%_20_0 (and main@%_5_0 main@%_8_0))
                  (= main@%_21_0 (= main@%.pre_0 main@%.pre6_0))
                  (=> main@.lr.ph_0 (and main@.lr.ph_0 main@._crit_edge_0))
                  (=> (and main@.lr.ph_0 main@._crit_edge_0) main@%_21_0)
                  (= main@%assume.flag.0_0 main@%_20_0)
...
(assert (forall ((main@%.pre_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@verifier.error_0 main@._crit_edge_0)
                      (not main@%_21_0))
                  (= main@%assume.flag.2_0 main@%_20_0)
                  (=> (and main@verifier.error_0 main@._crit_edge_0)
...
(assert (forall ((main@%_25_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_0)
                  true
                  (= main@%_23_0 (+ main@%.12.i1_0 3))
                  (= main@%_24_0 (+ main@%.1.i2_0 1))
                  (= main@%_25_0 (< main@%_23_0 main@%_3_0))
                  (= main@%_26_0 (and main@%assume.flag.1_0 main@%_25_0))
                  (= main@%_27_0 (+ main@%_6_0 (* main@%_24_0 1)))
                  (or (<= main@%_6_0 0) (> main@%_27_0 0))
                  (> main@%_6_0 0)
                  (= main@%_28_0 (select main@%shadow.mem1.1_0 main@%_27_0))
                  (= main@%_29_0 (* main@%_24_0 3))
                  (= main@%_30_0 (+ main@%_29_0 1))
                  (= main@%_31_0 (+ main@%_7_0 (* main@%_30_0 1)))
                  (or (<= main@%_7_0 0) (> main@%_31_0 0))
                  (> main@%_7_0 0)
                  (= main@%_32_0 (select main@%shadow.mem.1_0 main@%_31_0))
                  (= main@%_33_0 (= main@%_28_0 main@%_32_0))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb2_0))
                  (=> (and main@_bb2_1 main@_bb2_0) main@%_33_0)
                  (= main@%assume.flag.1_1 main@%_26_0)
                  (= main@%.1.i2_1 main@%_24_0)
                  (= main@%.12.i1_1 main@%_23_0)
...
(assert (forall ((main@%_25_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%assume.flag.2_0 main@%_26_0)
                  (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                      (= main@%assume.flag.2_1 main@%assume.flag.2_0))
                  (=> main@verifier.error_0 main@%assume.flag.2_1)
                  (=> main@verifier.error.split_0
