(set-info :original "./flarge_enc/llvm/array_2d_init_const.c.bc")
...
(assert (forall ((main@%shadow.mem.0.0_2 (Array Int Int))
  ...
  (=> (and (main 0
                 ...
                 main@%shadow.mem.0.1_0)
           true
           (= main@%_3_0 (> main@%_0_1 0))
           (= main@%_4_1 (> main@%_1_1 0))
           (= main@%_5_0 (and main@%_3_0 main@%_4_1))
           (= main@%_6_1 (and true main@%_5_0))
           (> main@%_8_1 0)
           (=> main@.lr.ph7_0 (and main@.lr.ph7_0 main@entry_0))
           (=> (and main@.lr.ph7_0 main@entry_0) main@%_3_0)
           (=> main@.lr.ph7.split.us_0
               (and main@.lr.ph7.split.us_0 main@.lr.ph7_0))
           (=> (and main@.lr.ph7.split.us_0 main@.lr.ph7_0) main@%_4_1)
           (=> main@.lr.ph4.us_0
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@._crit_edge8_0 main@entry_0) (not main@%_3_0))
           ...
           (=> |tuple(main@.lr.ph7_0, main@.split_0)| (not main@%_4_1))
           (=> |tuple(main@._crit_edge8_0, main@.split_0)| (not main@%_4_1))
           (=> main@_bb4_0 (and main@_bb4_0 main@.split_0))
           (= main@%assume.flag.1_1 main@%_6_1)
           (= main@%.12.i_1 0)
           (=> (and main@_bb4_0 main@.split_0)
               (= main@%assume.flag.1_2 main@%assume.flag.1_1))
           (=> (and main@_bb4_0 main@.split_0) (= main@%.12.i_2 main@%.12.i_1))
           main@_bb4_0)
      (main 3
            main@%_18_0
            main@%.12.i.us_0
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@.split.us_0 main@._crit_edge8_0) main@%_4_1)
...
(assert (forall ((main@%_9_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%shadow.mem.0.1_0)
                  true
                  (= main@%_10_1 (+ main@%_8_0 (* main@%_9_0 1)))
                  (or (<= main@%_8_0 0) (> main@%_10_1 0))
...
(assert (forall ((main@%_16_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        main@%shadow.mem.0.1_0)
                  true
                  (= main@%_12_0 (+ main@%_10_0 (* main@%.0.i2.us_0 1)))
                  (or (<= main@%_10_0 0) (> main@%_12_0 0))
                  (> main@%_10_0 0)
                  (= main@%sm_0
                     (store main@%shadow.mem.0.1_0 main@%_12_0 main@%_2_0))
                  (= main@%_13_0 (+ main@%.0.i2.us_0 1))
                  (= main@%_14_0 (< main@%_13_0 main@%_1_0))
                  (=> main@._crit_edge5.us_0
                      (and main@._crit_edge5.us_0 main@_bb_0))
                  (=> (and main@._crit_edge5.us_0 main@_bb_0) (not main@%_14_0))
                  (= main@%_15_0 (+ main@%.01.i6.us_0 1))
                  (= main@%_16_0 (< main@%_15_0 main@%_0_0))
                  (=> main@.lr.ph4.us_0
                      (and main@.lr.ph4.us_0 main@._crit_edge5.us_0))
                  (=> (and main@.lr.ph4.us_0 main@._crit_edge5.us_0)
                      main@%_16_0)
                  (= main@%shadow.mem.0.0_1 main@%sm_0)
                  (= main@%.01.i6.us_1 main@%_15_0)
                  (=> (and main@.lr.ph4.us_0 main@._crit_edge5.us_0)
                      (= main@%shadow.mem.0.0_2 main@%shadow.mem.0.0_1))
                  (=> (and main@.lr.ph4.us_0 main@._crit_edge5.us_0)
                      (= main@%.01.i6.us_2 main@%.01.i6.us_1))
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@.split_0 main@._crit_edge8_0) (not main@%_4_0))
                  (=> main@_bb4_0 (and main@_bb4_0 main@.split_0))
                  (= main@%assume.flag.1_1 main@%_6_0)
                  (= main@%.12.i_1 0)
                  (=> (and main@_bb4_0 main@.split_0)
                      (= main@%assume.flag.1_2 main@%assume.flag.1_1))
                  (=> (and main@_bb4_0 main@.split_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@.split.us_0 main@._crit_edge8_0) main@%_4_0)
                  (=> main@.lr.ph.us_0 (and main@.lr.ph.us_0 main@.split.us_0))
...
(assert (forall ((main@%_30_0 Bool)
  ...
  (=> (and (main 3
                 ...
                 main@%shadow.mem.0.1_0)
           true
           (= main@%_30_0 (< main@%.12.i_0 main@%_0_0))
           (= main@%_31_0 (and main@%assume.flag.1_0 main@%_30_0))
           (= main@%_32_0 (+ main@%.12.i_0 1))
           (=> main@_bb4_1 (and main@_bb4_1 main@_bb4_0))
           (= main@%assume.flag.1_1 main@%_31_0)
           (= main@%.12.i_1 main@%_32_0)
           (=> (and main@_bb4_1 main@_bb4_0)
               (= main@%assume.flag.1_2 main@%assume.flag.1_1))
           (=> (and main@_bb4_1 main@_bb4_0) (= main@%.12.i_2 main@%.12.i_1))
           main@_bb4_1)
      (main 3
            main@%_18_0
            main@%.12.i.us_0
...
(assert (forall ((main@%_17_0 Bool)
  ...
  (let ((a!1 (and (main 4
                        ...
                        main@%shadow.mem.0.1_0)
                  true
                  (= main@%_17_0 (< main@%.12.i.us_0 main@%_0_0))
                  (= main@%_18_1 (and main@%assume.flag.0_0 main@%_17_0))
                  (= main@%_20_1 (+ main@%_8_0 (* main@%_19_0 1)))
                  (or (<= main@%_8_0 0) (> main@%_20_1 0))
...
(assert (forall ((main@%_22_0 Bool)
  ...
  (let ((a!1 (and (main 5
                        ...
                        main@%shadow.mem.0.1_0)
                  true
                  (= main@%_24_0 (+ main@%_20_0 (* main@%.1.i1.us_0 1)))
                  (or (<= main@%_20_0 0) (> main@%_24_0 0))
                  (> main@%_20_0 0)
                  (= main@%_25_0 (select main@%shadow.mem.0.2_0 main@%_24_0))
                  (= main@%_26_0 (< main@%_25_0 main@%_2_0))
                  (= main@%_27_0 (+ main@%.1.i1.us_0 1))
                  (=> main@_bb2_0 (and main@_bb2_0 main@_bb3_0))
                  (=> (and main@_bb2_0 main@_bb3_0) (not main@%_26_0))
                  (= main@%_22_0 (< main@%_27_0 main@%_1_0))
                  (=> main@._crit_edge.us_0
                      (and main@._crit_edge.us_0 main@_bb2_0))
                  (=> (and main@._crit_edge.us_0 main@_bb2_0) (not main@%_22_0))
                  (= main@%_28_0 (+ main@%.12.i.us_0 1))
                  (=> main@.lr.ph.us_0
                      (and main@.lr.ph.us_0 main@._crit_edge.us_0))
                  (= main@%assume.flag.0_1 main@%_18_0)
                  (= main@%.12.i.us_1 main@%_28_0)
                  (=> (and main@.lr.ph.us_0 main@._crit_edge.us_0)
                      (= main@%assume.flag.0_2 main@%assume.flag.0_1))
                  (=> (and main@.lr.ph.us_0 main@._crit_edge.us_0)
                      (= main@%.12.i.us_2 main@%.12.i.us_1))
...
(assert (forall ((main@%_22_0 Bool)
  ...
  (let ((a!1 (and (main 5
                  ...
                  (=> (and main@_bb2_0 main@_bb3_0) (not main@%_26_0))
                  (= main@%_22_0 (< main@%_27_0 main@%_1_0))
                  (=> main@_bb3_1 (and main@_bb3_1 main@_bb2_0))
                  (=> (and main@_bb3_1 main@_bb2_0) main@%_22_0)
                  (= main@%.1.i1.us_1 main@%_27_0)
                  (=> (and main@_bb3_1 main@_bb2_0)
                      (= main@%.1.i1.us_2 main@%.1.i1.us_1))
                  main@_bb3_1)))
    (=> a!1
        (main 5
...
(assert (forall ((main@%_24_0 Int)
  ...
  (let ((a!1 (and (main 5
                  ...
                  (=> (and main@verifier.error_0 main@_bb3_0) main@%_26_0)
