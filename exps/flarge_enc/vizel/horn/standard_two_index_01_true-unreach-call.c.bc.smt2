(set-info :original "./flarge_enc/llvm/standard_two_index_01_true-unreach-call.c.bc")
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main 0
           ...
           (=> (and main@.lr.ph5_0 main@entry_0) main@%_2_1)
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@._crit_edge.thread_0 main@entry_0) (not main@%_2_1))
           (= main@%_6_0 (and main@%_3_1 main@%_2_1))
           (=> main@.lr.ph_0 (and main@.lr.ph_0 main@._crit_edge.thread_0))
           (= main@%assume.flag.0_0 main@%_6_0)
...
(assert (forall ((main@%_8_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  true
                  (= main@%_8_0 @nd_char_0)
                  (= main@%_10_0 (+ main@%_5_0 (* main@%.01.i3_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_10_0 0))
                  (> main@%_5_0 0)
                  (= main@%sm_0
                     (store main@%shadow.mem.1.0_0 main@%_10_0 main@%_9_0))
                  (= main@%_11_0 (+ main@%_4_0 (* main@%.0.i4_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_11_0 0))
                  (> main@%_4_0 0)
                  (= main@%sm1_0
                     (store main@%shadow.mem.0.0_0 main@%_11_0 main@%_9_0))
                  (= main@%_12_0 (+ main@%.01.i3_0 1))
                  (= main@%_13_0 (+ main@%.0.i4_0 1))
                  (= main@%_14_0 (< main@%_12_0 main@%_1_0))
                  (=> main@_bb_1 (and main@_bb_1 main@_bb_0))
                  (=> (and main@_bb_1 main@_bb_0) main@%_14_0)
                  (= main@%shadow.mem.1.0_1 main@%sm_0)
                  (= main@%shadow.mem.0.0_1 main@%sm1_0)
                  (= main@%.0.i4_1 main@%_13_0)
...
(assert (forall ((main@%assume.flag.1_2 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%.pre6_0 (select main@%sm_0 main@%_5_0))
                  (= main@%_15_0 (and main@%_3_0 main@%_2_0))
                  (= main@%_16_0 (= main@%.pre_0 main@%.pre6_0))
                  (=> main@.lr.ph_0 (and main@.lr.ph_0 main@._crit_edge_0))
                  (=> (and main@.lr.ph_0 main@._crit_edge_0) main@%_16_0)
                  (= main@%assume.flag.0_0 main@%_15_0)
...
(assert (forall ((main@%.pre_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@verifier.error_0 main@._crit_edge_0)
                      (not main@%_16_0))
                  (= main@%assume.flag.2_0 main@%_15_0)
                  (=> (and main@verifier.error_0 main@._crit_edge_0)
...
(assert (forall ((main@%_20_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_0)
                  true
                  (= main@%_18_0 (+ main@%.12.i1_0 1))
                  (= main@%_19_0 (+ main@%.1.i2_0 1))
                  (= main@%_20_0 (< main@%_18_0 main@%_1_0))
                  (= main@%_21_0 (and main@%assume.flag.1_0 main@%_20_0))
                  (= main@%_22_0 (+ main@%_4_0 (* main@%_19_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_22_0 0))
                  (> main@%_4_0 0)
                  (= main@%_23_0 (select main@%shadow.mem.0.1_0 main@%_22_0))
                  (= main@%_24_0 (+ main@%_5_0 (* main@%_19_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_24_0 0))
                  (> main@%_5_0 0)
                  (= main@%_25_0 (select main@%shadow.mem.1.1_0 main@%_24_0))
                  (= main@%_26_0 (= main@%_23_0 main@%_25_0))
                  (=> main@_bb4_1 (and main@_bb4_1 main@_bb4_0))
                  (=> (and main@_bb4_1 main@_bb4_0) main@%_26_0)
                  (= main@%assume.flag.1_1 main@%_21_0)
                  (= main@%.1.i2_1 main@%_19_0)
                  (= main@%.12.i1_1 main@%_18_0)
...
(assert (forall ((main@%_20_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%assume.flag.2_0 main@%_21_0)
                  (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                      (= main@%assume.flag.2_1 main@%assume.flag.2_0))
                  (=> main@verifier.error_0 main@%assume.flag.2_1)
                  (=> main@verifier.error.split_0
