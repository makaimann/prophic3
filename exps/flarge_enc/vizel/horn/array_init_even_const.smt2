(set-info :original "./flarge_enc/vizel/llvm/array_init_even_const.bc")
(set-info :authors "SeaHorn v.0.1.0-rc3")
(set-logic HORN)
(declare-fun verifier.error (Bool Bool Bool) Bool)
(declare-fun main
             (Int Int Int Bool Int (Array Int Int) Int Bool Int (Array Int Int))
             Bool)
...
(assert (forall ((main@%_7_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%shadow.mem.0_0)
                  true
                  (= main@%_7_0 (+ main@%_5_0 (* main@%.0.i1_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_7_0 0))
                  (> main@%_5_0 0)
                  (= main@%_8_0
                     (store main@%shadow.mem.0_0 main@%_7_0 main@%_2_0))
                  (= main@%_9_0 (+ main@%.0.i1_0 2))
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        main@%shadow.mem.0_0)
                  true
                  (= main@%_12_0 (< main@%.1.i_0 main@%_1_0))
                  (= main@%_13_0 (and main@%assume.flag.0_0 main@%_12_0))
                  (= main@%_14_0 (+ main@%_5_0 (* main@%.1.i_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_14_0 0))
                  (> main@%_5_0 0)
                  (= main@%_15_0 (select main@%shadow.mem.1_0 main@%_14_0))
                  (= main@%_16_0 (< main@%_15_0 main@%_2_0))
                  (= main@%_17_0 (+ main@%.1.i_0 2))
                  (=> main@_bb1_1 (and main@_bb1_1 main@_bb1_0))
                  (=> (and main@_bb1_1 main@_bb1_0) (not main@%_16_0))
                  (= main@%assume.flag.0_1 main@%_13_0)
                  (= main@%.1.i_1 main@%_17_0)
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb1_0) main@%_16_0)
