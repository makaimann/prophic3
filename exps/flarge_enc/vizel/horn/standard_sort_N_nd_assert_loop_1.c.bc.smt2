(set-info :original "./flarge_enc/llvm/standard_sort_N_nd_assert_loop_1.c.bc")
...
(assert (forall ((main@%_9_1 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge.loopexit_0 main@_bb_0)
                      (not main@%_8_0))
                  (= main@%.pre.pre_0 (select main@%sm_0 main@%_3_0))
                  (=> main@._crit_edge_0
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        main@%shadow.mem.0.0_0)
                  true
                  (= main@%_12_0 (< main@%.0.i_0 main@%_9_0))
                  (= main@%_13_0 (and main@%assume.flag.0_0 main@%_12_0))
                  (= main@%_14_0 (+ main@%.0.i_0 1))
                  (= main@%_15_0 (+ main@%_3_0 (* main@%_14_0 1)))
                  (or (<= main@%_3_0 0) (> main@%_15_0 0))
                  (> main@%_3_0 0)
                  (= main@%_16_0 (select main@%shadow.mem.0.1_0 main@%_15_0))
                  (= main@%_17_0 (< main@%_11_0 main@%_16_0))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb2_0))
                  (=> (and main@_bb2_1 main@_bb2_0) main@%_17_0)
                  (= main@%assume.flag.0_1 main@%_13_0)
                  (= main@%_11_1 main@%_16_0)
                  (= main@%.0.i_1 main@%_14_0)
                  (=> (and main@_bb2_1 main@_bb2_0)
                      (= main@%assume.flag.0_2 main@%assume.flag.0_1))
                  (=> (and main@_bb2_1 main@_bb2_0) (= main@%_11_2 main@%_11_1))
                  (=> (and main@_bb2_1 main@_bb2_0)
                      (= main@%.0.i_2 main@%.0.i_1))
                  main@_bb2_1)))
    (=> a!1
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb2_0) (not main@%_17_0))
                  (=> main@verifier.error_0 main@%_13_0)
