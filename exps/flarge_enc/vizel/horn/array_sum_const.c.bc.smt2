(set-info :original "./flarge_enc/llvm/array_sum_const.c.bc")
...
(assert (forall ((main@%shadow.mem.0.0_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 0
                  ...
                  (= main@%.off.i_0 (+ main@%_0_1 (- 1)))
                  (= main@%_4_0
                     (ite (>= main@%.off.i_0 0) (< main@%.off.i_0 99) false))
                  (= main@%_5_1 (and main@%_3_0 main@%_4_0))
                  (> main@%_6_1 0)
                  (= main@%_7_1 (> main@%_0_1 0))
                  (=> main@.lr.ph4_0 (and main@.lr.ph4_0 main@entry_0))
                  (=> (and main@.lr.ph4_0 main@entry_0) main@%_7_1)
...
(assert (forall ((main@%_19_0 Bool)
  ...
  (let ((a!1 (and (main 0
                  ...
                  (=> (and main@verifier.error_0 main@entry_0) (not main@%_7_1))
                  (= main@%.0.i.lcssa_0 true)
                  (=> (and main@verifier.error_0 main@entry_0)
                      (= main@%.0.i.lcssa_1 main@%.0.i.lcssa_0))
                  (= main@%_19_0 (xor main@%.0.i.lcssa_1 true))
                  (= main@%_20_0 (and main@%_5_1 main@%_19_0))
...
(assert (forall ((main@%_9_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%shadow.mem.0.0_0)
                  true
                  (= main@%_9_0 (+ main@%_6_0 (* main@%.01.i3_0 1)))
                  (or (<= main@%_6_0 0) (> main@%_9_0 0))
                  (> main@%_6_0 0)
                  (= main@%sm_1 (store main@%shadow.mem.0.0_0 main@%_9_0 0))
                  (= main@%_10_0 (+ main@%.01.i3_0 1))
                  (= main@%_11_0 (< main@%_10_0 main@%_0_0))
                  (=> main@_bb_1 (and main@_bb_1 main@_bb_0))
                  (=> (and main@_bb_1 main@_bb_0) main@%_11_0)
                  (= main@%shadow.mem.0.0_1 main@%sm_1)
                  (= main@%.01.i3_1 main@%_10_0)
...
(assert (forall ((main@%.0.i2_2 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge_0 main@_bb_0) (not main@%_11_0))
                  (=> main@.lr.ph_0 (and main@.lr.ph_0 main@._crit_edge_0))
                  (=> (and main@.lr.ph_0 main@._crit_edge_0) main@%_7_0)
...
(assert (forall ((main@%_19_0 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@verifier.error_0 main@._crit_edge_0)
                      (= main@%.0.i.lcssa_1 main@%.0.i.lcssa_0))
                  (= main@%_19_0 (xor main@%.0.i.lcssa_1 true))
                  (= main@%_20_0 (and main@%_5_0 main@%_19_0))
                  (=> main@verifier.error_0 main@%_20_0)
                  (=> main@verifier.error.split_0
                      (and main@verifier.error.split_0 main@verifier.error_0))
                  main@verifier.error.split_0)))
