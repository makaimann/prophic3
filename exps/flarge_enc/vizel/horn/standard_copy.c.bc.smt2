(set-info :original "./flarge_enc/llvm/standard_copy.c.bc")
...
(assert (forall ((main@%_16_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb4_0) (not main@%_22_0))
