(set-info :original "./flarge_enc/llvm/standard_copy_N_nd_assert_loop.c.bc")
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        main@%shadow.mem.1.0_0)
                  true
                  (= main@%_12_0 (< main@%.0.i_0 main@%_0_0))
                  (= main@%_13_0 (and main@%assume.flag.0_0 main@%_12_0))
                  (= main@%_14_0 (+ main@%_3_0 (* main@%.0.i_0 1)))
                  (or (<= main@%_3_0 0) (> main@%_14_0 0))
                  (> main@%_3_0 0)
                  (= main@%_15_0 (select main@%shadow.mem.0.1_0 main@%_14_0))
                  (= main@%_16_0 (+ main@%_4_0 (* main@%.0.i_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_16_0 0))
                  (> main@%_4_0 0)
                  (= main@%_17_0 (select main@%shadow.mem.1.1_0 main@%_16_0))
