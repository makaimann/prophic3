(set-info :original "./flarge_enc/llvm/array_shadowinit_true-unreach-call.c.bc")
...
(assert (forall ((main@%_6_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%.01.i1_0)
                  true
                  (= main@%_6_0 main@%.0.i2_0)
                  (= main@%_7_0 (+ main@%_4_0 (* main@%_6_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_7_0 0))
                  (> main@%_4_0 0)
                  (= main@%sm_0
                     (store main@%shadow.mem.0.0_0 main@%_7_0 main@%.0.i2_0))
                  (= main@%_8_0 (+ main@%.01.i1_0 1))
                  (= main@%_9_0 (+ main@%.0.i2_0 1))
                  (= main@%_10_0 (< main@%_8_0 main@%_0_0))
