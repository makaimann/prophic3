(set-info :original "./flarge_enc/llvm/array_monotonic_true-unreach-call_1.c.bc")
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (= main@%shadow.mem.1.2_1 main@%sm3_0)
...
(assert (forall ((main@%_15_0 Bool)
  ...
  (let ((a!1 (and (main 1
                        ...
                        @nondet_int_0)
                  true
                  (= main@%_7_0 @nondet_char_0)
                  (= main@%_9_0 (+ main@%_4_0 (* main@%.0.i1_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_9_0 0))
                  (> main@%_4_0 0)
                  (= main@%sm_0
                     (store main@%shadow.mem.0.0_0 main@%_9_0 main@%_8_0))
                  (= main@%_10_0 (= main@%_8_0 10))
                  (=> main@_bb4_0 (and main@_bb4_0 main@_bb_0))
                  (=> (and main@_bb4_0 main@_bb_0) main@%_10_0)
                  (= main@%_12_0 (+ main@%_5_0 (* main@%.0.i1_0 1)))
                  (=> main@_bb4_0 (or (<= main@%_5_0 0) (> main@%_12_0 0)))
                  (=> main@_bb4_0 (> main@%_5_0 0))
                  (= main@%sm1_0 (store main@%shadow.mem.1.0_0 main@%_12_0 20))
                  (=> |tuple(main@_bb_0, main@_bb5_0)| main@_bb_0)
                  (=> main@_bb5_0
                      (or (and main@_bb5_0 main@_bb4_0)
                          |tuple(main@_bb_0, main@_bb5_0)|))
                  (=> |tuple(main@_bb_0, main@_bb5_0)| (not main@%_10_0))
                  ...
                  (= main@%_14_0 (+ main@%.0.i1_0 1))
                  (= main@%_15_0 (< main@%_14_0 main@%_1_0))
                  (=> main@_bb_1 (and main@_bb_1 main@_bb5_0))
                  (=> (and main@_bb_1 main@_bb5_0) main@%_15_0)
                  (= main@%shadow.mem.1.0_1 main@%shadow.mem.1.1_2)
                  (= main@%shadow.mem.0.0_1 main@%sm_0)
                  (= main@%.0.i1_1 main@%_14_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%shadow.mem.1.2_1 main@%shadow.mem.1.1_2)
...
(assert (forall ((main@%_23_0 Int)
         ...
         (main@_bb7_0 Bool)
         (main@_bb8_0 Bool)
         (|tuple(main@_bb7_0, main@_bb8_0)| Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%_19_0 (+ main@%_4_0 (* main@%.1.i_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_19_0 0))
                  (> main@%_4_0 0)
                  (= main@%_20_0 (select main@%shadow.mem.0.1_0 main@%_19_0))
                  (= main@%_21_0 (= main@%_20_0 10))
                  (=> main@_bb7_0 (and main@_bb7_0 main@_bb6_0))
                  (=> (and main@_bb7_0 main@_bb6_0) main@%_21_0)
                  (= main@%_23_0 (+ main@%_5_0 (* main@%.1.i_0 1)))
                  (=> main@_bb7_0 (or (<= main@%_5_0 0) (> main@%_23_0 0)))
                  (=> main@_bb7_0 (> main@%_5_0 0))
                  (= main@%_24_0 (select main@%shadow.mem.1.2_0 main@%_23_0))
                  (= main@%_25_0 (= main@%_24_0 20))
                  (=> |tuple(main@_bb7_0, main@_bb8_0)| main@_bb7_0)
                  (=> |tuple(main@_bb6_0, main@_bb8_0)| main@_bb6_0)
                  (=> main@_bb8_0
                      (or |tuple(main@_bb7_0, main@_bb8_0)|
                          |tuple(main@_bb6_0, main@_bb8_0)|))
                  (=> |tuple(main@_bb7_0, main@_bb8_0)| main@%_25_0)
                  (=> |tuple(main@_bb6_0, main@_bb8_0)| (not main@%_21_0))
                  (= main@%_27_0 (+ main@%.1.i_0 1))
