(set-info :original "./flarge_enc/vizel/llvm/array_init_const_int.bc")
...
(assert (forall ((main@%_7_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%shadow.mem.0_0)
                  true
                  (= main@%_7_0 (+ main@%_5_0 (* main@%.0.i1_0 4)))
