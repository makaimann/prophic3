...
(define-fun .def_20 () Int (! main@%_13_0_0 :next |.x.19|))
...
(define-fun .def_164 () Bool (<= main@%_0_1 0))
(define-fun .def_174 () Bool (not .def_164))
(define-fun .def_188 () Bool (= main@%_3_1 .def_174))
(define-fun .def_185 () Bool (<= main@%_4_1 0))
...
(define-fun .def_173 () Bool (= main@%_1_1 main@%_5_1))
...
(define-fun .def_167 () Bool (= .x.19 main@%_1_1))
(define-fun .def_163 () Bool (= .x.17 main@%_3_1))
...
(define-fun .def_42 () Bool (= .def_28 main@%_5_1))
(define-fun .def_171 () Bool (and .def_42 .def_170))
(define-fun .def_44 () Bool (= .def_30 main@%shadow.mem.0.0_2))
...
(define-fun .def_137 () (Array Int Int) (store .def_30 .def_114 main@%_9_0))
(define-fun .def_146 () Bool (= main@%shadow.mem.0.0_2 .def_137))
...
(define-fun .def_120 () Int (* (- 1) main@%_9_0))
...
(define-fun .def_50 () Bool (= .def_12 main@%_0_1))
(define-fun .def_159 () Bool (and .def_50 .def_158))
(define-fun .def_52 () Bool (= .def_16 main@%_4_1))
(define-fun .def_160 () Bool (and .def_52 .def_159))
(define-fun .def_54 () Bool (= .def_22 main@%_1_1))
(define-fun .def_161 () Bool (and .def_54 .def_160))
(define-fun .def_56 () Bool (= .def_24 main@%_3_1))
