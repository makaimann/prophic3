...
(define-fun .def_137 () Int (! main@%_2_0 :next |.xtv.1|))
(define-fun .def_193 () Bool (! (= .def_8 0) :init true))
(define-fun .def_197 () Bool (<= .def_137 0))
(define-fun .def_198 () Bool (not .def_197))
(define-fun .def_195 () Bool (<= main@%_3_1 .def_137))
(define-fun .def_172 () Bool (<= main@%_3_1 0))
(define-fun .def_179 () Bool (not .def_172))
(define-fun .def_196 () Bool (and .def_179 .def_195))
(define-fun .def_199 () Bool (and .def_196 .def_198))
(define-fun .def_200 () Bool (= main@%_8_1 .def_199))
(define-fun .def_190 () Bool (<= main@%_9_1 0))
(define-fun .def_191 () Bool (not .def_190))
(define-fun .def_188 () Bool (<= main@%_10_1 0))
...
(define-fun .def_185 () Bool (= main@%.0.i1_2 0))
...
(define-fun .def_171 () Bool (= .x.17 main@%_8_1))
...
(define-fun .def_162 () Int (* (- 1) main@%.0.i1_2))
...
(define-fun .def_53 () Bool (= .def_12 main@%_3_1))
(define-fun .def_167 () Bool (and .def_53 .def_166))
(define-fun .def_55 () Bool (= .def_16 main@%_9_1))
(define-fun .def_168 () Bool (and .def_55 .def_167))
(define-fun .def_57 () Bool (= .def_20 main@%_10_1))
(define-fun .def_169 () Bool (and .def_57 .def_168))
(define-fun .def_59 () Bool (= .def_24 main@%_8_1))
(define-fun .def_170 () Bool (and .def_59 .def_169))
(define-fun .def_203 () Bool (or .def_170 .def_202))
...
(define-fun .def_204 () Bool (or .def_145 .def_203))
...
(define-fun .def_205 () Bool (or .def_108 .def_204))
...
(define-fun .def_206 () Bool (! (or .def_84 .def_205) :trans true))
(define-fun .def_207 () Bool (= .def_8 3))
(define-fun .def_208 () Bool (! (not .def_207) :invar-property 0))
(assert true)
