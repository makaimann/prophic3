...
(define-fun .def_139 () Int (! main@%_2_0 :next |.xtv.1|))
(define-fun .def_193 () Bool (! (= .def_8 0) :init true))
(define-fun .def_197 () Bool (<= .def_139 0))
(define-fun .def_198 () Bool (not .def_197))
(define-fun .def_195 () Bool (<= main@%_3_1 .def_139))
...
(define-fun .def_143 () (Array Int Int) (store .def_30 .def_120 .def_139))
(define-fun .def_158 () Bool (= main@%shadow.mem1.0_2 .def_143))
...
(define-fun .def_140 () (Array Int Int) (store .def_28 .def_126 .def_139))
(define-fun .def_151 () Bool (= main@%shadow.mem.0_2 .def_140))
