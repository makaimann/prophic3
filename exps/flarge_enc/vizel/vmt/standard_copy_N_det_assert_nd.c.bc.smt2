...
(define-fun .def_109 () Bool (<= main@%_0_1 0))
(define-fun .def_110 () Bool (not .def_109))
(define-fun .def_107 () Bool (<= main@%_1_1 0))
...
(define-fun .def_95 () (Array Int Int) (store .def_20 .def_38 main@%_6_0))
...
(define-fun .def_87 () (Array Int Int) (store .def_22 .def_30 main@%_6_0))
(define-fun .def_88 () Bool (= main@%shadow.mem.1.0_2 .def_87))
...
(define-fun .def_46 () Bool (= .def_12 main@%_0_1))
(define-fun .def_105 () Bool (and .def_46 .def_104))
(define-fun .def_48 () Bool (= .def_14 main@%_1_1))
