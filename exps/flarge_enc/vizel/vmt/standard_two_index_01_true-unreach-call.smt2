...
(define-fun .def_80 () Int (! main@%_28_0 :next |.xtv.1|))
(define-fun .def_81 () Int (! main@%_11_0 :next |.xtv.2|))
(define-fun .def_284 () Bool (! (= .def_8 0) :init true))
(define-fun .def_293 () Bool (= .def_30 .x.21))
(define-fun .def_292 () Bool (= .def_40 .x.22))
(define-fun .def_294 () Bool (and .def_292 .def_293))
(define-fun .def_281 () Bool (<= main@%_7_1 0))
(define-fun .def_282 () Bool (not .def_281))
(define-fun .def_278 () Bool (<= main@%_6_1 0))
(define-fun .def_279 () Bool (not .def_278))
(define-fun .def_274 () Bool (<= main@%_3_1 0))
(define-fun .def_275 () Bool (not .def_274))
(define-fun .def_276 () Bool (= main@%_4_1 .def_275))
(define-fun .def_273 () Bool (= main@%_5_1 main@%_4_1))
...
(define-fun .def_242 () Int (+ .def_32 .def_241))
(define-fun .def_243 () Bool (= .def_242 (- 1)))
(define-fun .def_236 () Int (* (- 1) main@%.0.i4_2))
(define-fun .def_237 () Int (+ .def_36 .def_236))
(define-fun .def_238 () Bool (= .def_237 (- 1)))
(define-fun .def_165 () Int (+ .def_22 .def_32))
(define-fun .def_186 () (Array Int Int) (store .def_34 .def_165 .def_81))
(define-fun .def_232 () Bool (= main@%shadow.mem.0_2 .def_186))
(define-fun .def_160 () Int (+ .def_18 .def_36))
(define-fun .def_184 () (Array Int Int) (store .def_38 .def_160 .def_81))
(define-fun .def_230 () Bool (= main@%shadow.mem1.0_2 .def_184))
(define-fun .def_173 () Int (* (- 1) .def_32))
(define-fun .def_174 () Int (+ .def_14 .def_173))
(define-fun .def_175 () Bool (<= .def_174 1))
(define-fun .def_228 () Bool (not .def_175))
(define-fun .def_219 () Bool (and .def_42 .def_218))
(define-fun .def_220 () Bool (and .def_44 .def_219))
(define-fun .def_221 () Bool (and .def_46 .def_220))
(define-fun .def_222 () Bool (and .def_48 .def_221))
...
(define-fun .def_163 () Bool (or .def_64 .def_162))
...
(define-fun .def_225 () Bool (and .def_168 .def_224))
(define-fun .def_62 () Bool (not .def_61))
(define-fun .def_226 () Bool (and .def_62 .def_225))
...
(define-fun .def_287 () Bool (or .def_250 .def_286))
(define-fun .def_216 () Bool (= .x.20 .def_186))
(define-fun .def_214 () Bool (= .x.19 .def_184))
(define-fun .def_150 () Bool (and .def_26 .def_28))
(define-fun .def_212 () Bool (= .x.18 .def_150))
(define-fun .def_194 () Bool (and .def_192 .def_193))
(define-fun .def_195 () Bool (and .def_119 .def_194))
...
(define-fun .def_204 () Bool (and .def_175 .def_203))
(define-fun .def_205 () Bool (and .def_177 .def_204))
(define-fun .def_206 () Bool (and .def_67 .def_205))
(define-fun .def_207 () Bool (and .def_69 .def_206))
(define-fun .def_208 () Bool (and .def_71 .def_207))
(define-fun .def_209 () Bool (and .def_73 .def_208))
(define-fun .def_210 () Bool (and .def_75 .def_209))
(define-fun .def_187 () Int (select .def_186 .def_22))
(define-fun .def_185 () Int (select .def_184 .def_18))
(define-fun .def_188 () Bool (= .def_185 .def_187))
...
(define-fun .def_152 () Bool (and .def_44 .def_151))
...
(define-fun .def_180 () Bool (and .def_69 .def_179))
(define-fun .def_181 () Bool (and .def_71 .def_180))
...
(define-fun .def_145 () Int (* (- 1) .x.16))
(define-fun .def_146 () Int (+ .def_10 .def_145))
(define-fun .def_147 () Bool (= .def_146 (- 1)))
(define-fun .def_92 () Int (* (- 1) .def_80))
(define-fun .def_93 () Int (+ .def_22 .def_92))
(define-fun .def_142 () Int (+ .x.17 .def_93))
(define-fun .def_143 () Bool (= .def_142 0))
(define-fun .def_105 () Int (* (- 1) .def_14))
(define-fun .def_106 () Int (+ .def_10 .def_105))
(define-fun .def_107 () Bool (<= (- 1) .def_106))
(define-fun .def_108 () Bool (not .def_107))
(define-fun .def_137 () Bool (and .def_16 .def_108))
(define-fun .def_138 () Bool (= .x.18 .def_137))
(define-fun .def_118 () Bool (and .def_48 .def_50))
...
(define-fun .def_123 () Bool (and .def_56 .def_122))
...
(define-fun .def_128 () Bool (and .def_69 .def_127))
(define-fun .def_129 () Bool (and .def_71 .def_128))
(define-fun .def_130 () Bool (and .def_73 .def_129))
(define-fun .def_131 () Bool (and .def_75 .def_130))
(define-fun .def_83 () Int (* (- 1) .def_81))
(define-fun .def_84 () Int (+ .def_80 .def_83))
(define-fun .def_85 () Int (* (- 1) .def_22))
(define-fun .def_88 () Int (+ .def_85 .def_84))
(define-fun .def_89 () Int (+ .def_18 .def_88))
(define-fun .def_90 () Bool (= .def_89 0))
(define-fun .def_132 () Bool (and .def_90 .def_131))
(define-fun .def_94 () Int (+ .def_12 .def_93))
(define-fun .def_95 () Bool (= .def_94 (- 1)))
(define-fun .def_133 () Bool (and .def_95 .def_132))
(define-fun .def_97 () Bool (<= .def_81 0))
(define-fun .def_98 () Bool (not .def_97))
(define-fun .def_99 () Bool (or .def_64 .def_98))
(define-fun .def_134 () Bool (and .def_99 .def_133))
(define-fun .def_101 () Bool (<= .def_80 0))
(define-fun .def_102 () Bool (not .def_101))
(define-fun .def_103 () Bool (or .def_61 .def_102))
(define-fun .def_135 () Bool (and .def_103 .def_134))
(define-fun .def_114 () Int (select .def_24 .def_80))
(define-fun .def_113 () Int (select .def_20 .def_81))
...
(define-fun .def_111 () Bool (= .def_8 2))
(define-fun .def_149 () Bool (and .def_111 .def_148))
(define-fun .def_290 () Bool (or .def_149 .def_289))
...
(define-fun .def_291 () Bool (or .def_117 .def_290))
(define-fun .def_295 () Bool (! (and .def_291 .def_294) :trans true))
(define-fun .def_296 () Bool (= .def_8 3))
(define-fun .def_297 () Bool (! (not .def_296) :invar-property 0))
(assert true)
