...
(define-fun .def_86 () Int (! main@%_28_0 :next |.xtv.1|))
(define-fun .def_96 () Int (! main@%_11_0 :next |.xtv.2|))
...
(define-fun .def_181 () (Array Int Int) (store .def_38 .def_161 .def_96))
(define-fun .def_232 () Bool (= main@%shadow.mem1.0_2 .def_181))
(define-fun .def_167 () Int (+ .def_22 .def_32))
(define-fun .def_179 () (Array Int Int) (store .def_34 .def_167 .def_96))
...
(define-fun .def_110 () Int (select .def_24 .def_86))
(define-fun .def_109 () Int (select .def_20 .def_96))
...
(define-fun .def_91 () Int (* (- 1) .def_86))
...
(define-fun .def_101 () Int (* (- 1) .def_96))
