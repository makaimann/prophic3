...
(define-fun .def_28 () Bool (! main@%_6_0_0 :next |main@%_6_1|))
...
(define-fun .def_279 () Bool (and main@%_6_1 .def_220))
...
(define-fun .def_272 () Bool (not main@%_6_1))
(define-fun .def_268 () Bool (and main@%_3_1 main@%_6_1))
...
(define-fun .def_264 () Bool (<= main@%_1_1 0))
(define-fun .def_265 () Bool (not .def_264))
(define-fun .def_266 () Bool (= main@%_3_1 .def_265))
(define-fun .def_258 () Bool (<= main@%_1_1 1))
(define-fun .def_259 () Bool (not .def_258))
(define-fun .def_260 () Bool (= main@%_6_1 .def_259))
(define-fun .def_255 () Bool (<= main@%_4_1 0))
(define-fun .def_256 () Bool (not .def_255))
(define-fun .def_253 () Bool (<= main@%_5_1 0))
...
(define-fun .def_185 () (Array Int Int) (store .def_34 .def_167 main@%_10_0))
(define-fun .def_239 () Bool (= main@%shadow.mem.1.0_2 .def_185))
(define-fun .def_161 () Int (+ .def_18 .def_36))
(define-fun .def_187 () (Array Int Int) (store .def_38 .def_161 main@%_10_0))
(define-fun .def_237 () Bool (= main@%shadow.mem.0.0_2 .def_187))
...
(define-fun .def_108 () Int (select .def_20 main@%_10_0))
