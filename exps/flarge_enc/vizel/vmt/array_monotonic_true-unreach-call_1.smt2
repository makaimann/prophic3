...
(define-fun .def_121 () Bool (! |tuple(main@_bb4_0, main@_bb6_0)| :next |.xtv.3|))
(define-fun .def_125 () Bool (! |tuple(main@_bb_0, main@_bb3_0)| :next |.xtv.4|))
...
(define-fun .def_192 () (Array Int Int) (store .def_28 .def_172 .def_144))
...
(define-fun .def_142 () Bool (or .def_95 .def_126))
...
(define-fun .def_151 () Bool (or .def_94 .def_125))
...
(define-fun .def_133 () Bool (or .def_94 .def_126))
(define-fun .def_122 () Bool (not .def_121))
(define-fun .def_131 () Bool (or .def_95 .def_122))
(define-fun .def_129 () Bool (or .def_121 .def_125))
