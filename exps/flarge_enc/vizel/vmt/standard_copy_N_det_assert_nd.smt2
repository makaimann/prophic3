...
(define-fun .def_52 () Int (! main@%_8_0_0 :next |.xtv.2|))
...
(define-fun .def_95 () (Array Int Int) (store .def_20 .def_38 .def_50))
...
(define-fun .def_87 () (Array Int Int) (store .def_22 .def_30 .def_50))
...
(define-fun .def_55 () Int (+ .def_12 .def_50))
...
(define-fun .def_65 () Bool (<= 100 .def_50))
(define-fun .def_66 () Bool (not .def_65))
(define-fun .def_61 () Bool (<= 0 .def_50))
(define-fun .def_63 () Bool (not .def_61))
(define-fun .def_67 () Bool (or .def_63 .def_66))
(define-fun .def_56 () (Array Int Int) (store .def_20 .def_38 .def_52))
(define-fun .def_57 () Int (select .def_56 .def_55))
(define-fun .def_53 () (Array Int Int) (store .def_22 .def_30 .def_52))
