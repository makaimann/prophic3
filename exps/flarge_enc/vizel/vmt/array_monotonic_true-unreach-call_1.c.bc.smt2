...
(define-fun .def_16 () (Array Int Int) (! main@%shadow.mem.1.2_0_0 :next |.x.18|))
...
(define-fun .def_28 () (Array Int Int) (! main@%shadow.mem.1.0_0_0 :next |main@%shadow.mem.1.0_2|))
...
(define-fun .def_234 () Bool (<= main@%_1_1 0))
...
(define-fun .def_238 () Bool (= .x.17 main@%_3_1))
...
(define-fun .def_46 () Bool (= .def_28 main@%shadow.mem.1.0_2))
(define-fun .def_243 () Bool (and .def_46 .def_242))
(define-fun .def_48 () Bool (= .def_30 main@%shadow.mem.0.0_2))
(define-fun .def_244 () Bool (and .def_48 .def_243))
(define-fun .def_252 () Bool (or .def_244 .def_251))
(define-fun .def_236 () Bool (= main@%_3_1 .def_235))
(define-fun .def_229 () Bool (<= main@%_4_1 0))
(define-fun .def_230 () Bool (not .def_229))
(define-fun .def_227 () Bool (<= main@%_5_1 0))
...
(define-fun .def_215 () Bool (= main@%shadow.mem.1.0_2 .def_183))
(define-fun .def_97 () Bool (not main@_bb4_0))
...
(define-fun .def_192 () (Array Int Int) (store .def_30 .def_172 main@%_8_0))
(define-fun .def_207 () Bool (= main@%shadow.mem.0.0_2 .def_192))
(define-fun .def_126 () Bool (not |tuple(main@_bb_0, main@_bb5_0)|))
...
(define-fun .def_96 () Bool (and main@_bb4_0 main@_bb_0_0))
...
(define-fun .def_145 () Bool (= main@%_8_0 10))
...
(define-fun .def_151 () Bool (or main@_bb4_0 |tuple(main@_bb_0, main@_bb5_0)|))
...
(define-fun .def_57 () Bool (= .def_14 main@%_5_1))
...
(define-fun .def_61 () Bool (= .def_20 main@%_4_1))
...
(define-fun .def_133 () Bool (or main@_bb4_0 .def_126))
(define-fun .def_122 () Bool (not |tuple(main@_bb6_0, main@_bb8_0)|))
(define-fun .def_131 () Bool (or main@_bb_0_0 .def_122))
(define-fun .def_129 () Bool (or |tuple(main@_bb6_0, main@_bb8_0)| |tuple(main@_bb_0, main@_bb5_0)|))
