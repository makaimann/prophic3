...
(define-fun .def_127 () (Array Int Int) (! main@%shadow.mem.1_1 :next |.xtv.8|))
...
(define-fun .def_137 () Bool (<= main@%_5_1 0))
...
(define-fun .def_115 () Bool (= .def_14 .def_70))
...
(define-fun .def_105 () (Array Int Int) (store .def_20 .def_54 .def_70))
...
(define-fun .def_98 () Bool (= .def_14 .def_71))
...
(define-fun .def_90 () Bool (= .def_16 .def_39))
(define-fun .def_91 () Bool (or .def_29 .def_90))
(define-fun .def_86 () Int (+ .def_39 .def_77))
...
(define-fun .def_72 () (Array Int Int) (store .def_20 .def_54 .def_71))
