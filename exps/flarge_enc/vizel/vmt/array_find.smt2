...
(define-fun .def_115 () Bool (= .def_14 main@%_17_0))
...
(define-fun .def_105 () (Array Int Int) (store .def_20 .def_54 main@%_17_0))
...
(define-fun .def_24 () Bool (and main@_bb1_0_0 main@_bb_0_1))
(define-fun .def_102 () Bool (not .def_24))
(define-fun .def_98 () Bool (= .def_14 main@%_7_0_0))
...
(define-fun .def_33 () Bool (not |tuple(main@_bb1_0, main@verifier.error.loopexit_0)|))
...
(define-fun .def_72 () (Array Int Int) (store .def_20 .def_54 main@%_7_0_0))
(define-fun .def_73 () Int (select .def_72 main@%_17_0))
...
(define-fun .def_36 () Bool (or |tuple(main@_bb_0, main@verifier.error.loopexit_0)| |tuple(main@_bb1_0, main@verifier.error.loopexit_0)|))
(define-fun .def_34 () Bool (or main@_bb1_0_0 .def_33))
(define-fun .def_30 () Bool (or main@_bb_0_1 .def_29))
(define-fun .def_25 () Bool (not main@_bb1_0_0))
