...
(define-fun .def_95 () Int (! main@%_12_0 :next |.xtv.1|))
...
(define-fun .def_185 () (Array Int Int) (store .def_34 .def_167 .def_95))
(define-fun .def_239 () Bool (= main@%shadow.mem1.0_2 .def_185))
(define-fun .def_161 () Int (+ .def_18 .def_36))
(define-fun .def_187 () (Array Int Int) (store .def_38 .def_161 .def_95))
(define-fun .def_237 () Bool (= main@%shadow.mem.0_2 .def_187))
...
(define-fun .def_108 () Int (select .def_20 .def_95))
