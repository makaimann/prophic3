(set-info :original "/tmp/t/array_copy_partial.pp.ms.o.bc")
(set-info :authors "SeaHorn v.0.1.0-rc3")
(declare-rel verifier.error (Bool Bool Bool ))
(declare-rel main@entry ())
(declare-rel main@_bb (Int Int (Array Int Int) Int (Array Int Int) Int ))
(declare-rel main@_bb3 (Int (Array Int Int) Int (Array Int Int) Int Int ))
...
(rule (=> (and main@entry
    ...
    (main@_bb main@%_7_0
              ...
              main@%_3_0)))
(rule (let ((a!1 (=> main@_bb2_0 (= main@%_13_0 (+ main@%_7_0 (* main@%i.0.i_0 1)))))
...
(let ((a!3 (and (main@_bb main@%_7_0
                ...
                (=> (and main@_bb_1 main@_bb2_0) (= main@%i.0.i_1 main@%_17_0))
                (=> (and main@_bb_1 main@_bb2_0)
...
(rule (=> (and (main@_bb main@%_7_0
    ...
    (main@_bb3 main@%_7_0
               ...
               main@%i.1.i_1
               main@%_3_0)))
(rule (let ((a!1 (=> main@_bb4_0 (= main@%_21_0 (+ main@%_7_0 (* main@%i.1.i_0 1)))))
