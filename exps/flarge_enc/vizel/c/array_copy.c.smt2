(set-info :original "/tmp/t/array_copy.pp.ms.o.bc")
...
(rule (=> (and (main@_bb main@%_4_0
    ...
    (main@_bb3 main@%_4_0
               ...
               main@%x.0.i_1
               main@%_2_0)))
(rule (let ((a!1 (=> main@_bb4_0 (= main@%_18_0 (+ main@%_4_0 (* main@%x.0.i_0 1)))))
...
(let ((a!3 (and (main@_bb3 main@%_4_0
                ...
                main@_bb3_1
                (=> (and main@_bb3_1 main@_bb6_0) (= main@%x.0.i_1 main@%_25_0))
