...
(define-fun .def_118 () Int (! main@%.15.i_0 :next |.xtv.4|))
(define-fun .def_123 () Int (! main@%_6_0 :next |.xtv.5|))
...
(define-fun .def_199 () Bool (<= .def_123 0))
...
(define-fun .def_209 () Int (* 16777216 .def_123))
...
(define-fun .def_156 () (Array Int Int) (store .def_26 .def_129 .def_123))
...
(define-fun .def_180 () Bool (= main@%.04.i1_2 .def_118))
...
(define-fun .def_119 () Int (* (- 1) .def_118))
...
(define-fun .def_153 () Bool (= .x.17 .def_118))
