...
(define-fun .def_97 () Bool (! |tuple(main@_bb_0, main@_bb2_0)| :next |.xtv.1|))
(define-fun .def_99 () Bool (! main@_bb_0_0 :next |.xtv.2|))
(define-fun .def_101 () Bool (! main@_bb1_0 :next |.xtv.3|))
(define-fun .def_114 () Int (! main@%.15.i_0 :next |.xtv.4|))
(define-fun .def_125 () Int (! main@%_6_0 :next |.xtv.5|))
...
(define-fun .def_223 () Bool (= main@%.04.i1_2 0))
(define-fun .def_221 () Bool (= main@%.02.i2_2 0))
(define-fun .def_199 () Bool (<= .def_125 0))
...
(define-fun .def_204 () Int (* 16777216 .def_125))
(define-fun .def_206 () Real (* (/ 1 16777216) (to_real .def_204)))
(define-fun .def_207 () Int (to_int .def_206))
(define-fun .def_208 () Bool (= main@%_8_1 .def_207))
...
(define-fun .def_212 () Bool (= .x.18 main@%_5_1))
(define-fun .def_210 () Bool (= .x.17 0))
...
(define-fun .def_187 () Int (* (- 1) main@%.02.i2_2))
(define-fun .def_188 () Int (+ .def_22 .def_187))
(define-fun .def_189 () Bool (= .def_188 (- 1)))
(define-fun .def_135 () Int (* (- 1) .def_24))
(define-fun .def_136 () Int (+ .def_22 .def_135))
(define-fun .def_137 () Bool (<= (- 1) .def_136))
(define-fun .def_183 () Bool (not .def_137))
(define-fun .def_180 () Bool (= main@%.04.i1_2 .def_114))
(define-fun .def_103 () Bool (not .def_101))
(define-fun .def_181 () Bool (or .def_103 .def_180))
(define-fun .def_119 () Int (+ .def_16 .def_28))
(define-fun .def_151 () (Array Int Int) (store .def_26 .def_119 .def_125))
(define-fun .def_172 () Bool (= main@%shadow.mem.0_2 .def_151))
(define-fun .def_173 () Bool (or .def_103 .def_172))
(define-fun .def_98 () Bool (not .def_97))
(define-fun .def_170 () Bool (or .def_44 .def_98))
(define-fun .def_168 () Bool (or .def_46 .def_98))
...
(define-fun .def_106 () Bool (or .def_97 .def_101))
...
(define-fun .def_116 () Int (+ .def_28 .def_115))
...
(define-fun .def_176 () Bool (and .def_123 .def_175))
(define-fun .def_128 () Bool (not .def_102))
(define-fun .def_126 () Bool (<= .def_125 (- 1)))
(define-fun .def_127 () Bool (not .def_126))
(define-fun .def_129 () Bool (or .def_127 .def_128))
(define-fun .def_177 () Bool (and .def_129 .def_176))
(define-fun .def_50 () Bool (not .def_49))
(define-fun .def_131 () Bool (or .def_50 .def_103))
(define-fun .def_178 () Bool (and .def_131 .def_177))
(define-fun .def_133 () Bool (or .def_98 .def_126))
(define-fun .def_179 () Bool (and .def_133 .def_178))
...
(define-fun .def_158 () Bool (= .x.18 .def_20))
(define-fun .def_155 () Bool (= .x.19 .def_26))
(define-fun .def_156 () Bool (or .def_98 .def_155))
(define-fun .def_152 () Bool (= .x.19 .def_151))
(define-fun .def_153 () Bool (or .def_103 .def_152))
(define-fun .def_148 () Bool (= .x.17 .def_114))
(define-fun .def_149 () Bool (or .def_103 .def_148))
