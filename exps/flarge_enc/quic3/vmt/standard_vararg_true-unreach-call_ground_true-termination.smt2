...
(define-fun .def_104 () Int (! main@%_6_0 :next |.xtv.1|))
...
(define-fun .def_108 () Bool (<= .def_104 0))
...
(define-fun .def_197 () Int (* 16777216 .def_104))
...
(define-fun .def_168 () (Array Int Int) (store .def_28 .def_157 .def_104))
...
(define-fun .def_116 () Int (* (- 1) .def_104))
