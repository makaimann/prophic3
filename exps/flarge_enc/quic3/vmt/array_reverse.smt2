...
(define-fun .def_81 () Int (! main@%_30_0 :next |.xtv.2|))
(define-fun .def_177 () Int (! main@%.pre_phi_0 :next |.xtv.3|))
(define-fun .def_189 () Int (! main@%.pre_phi_0_0 :next |.xtv.4|))
(define-fun .def_273 () (Array Int Int) (! main@%shadow.mem1.3_1 :next |.xtv.5|))
(define-fun .def_275 () (Array Int Int) (! main@%shadow.mem.2_1 :next |.xtv.6|))
...
(define-fun .def_299 () Bool (not .def_270))
(define-fun .def_264 () Bool (<= main@%_5_1 0))
(define-fun .def_297 () Bool (not .def_264))
(define-fun .def_293 () Bool (<= main@%_2_1 0))
(define-fun .def_294 () Bool (not .def_293))
(define-fun .def_295 () Bool (= main@%_3_1 .def_294))
(define-fun .def_292 () Bool (= main@%_4_1 main@%_3_1))
...
(define-fun .def_227 () Bool (= .x.15 1))
(define-fun .def_287 () Bool (and main@%_3_1 .def_227))
(define-fun .def_289 () Bool (and .def_287 .def_288))
(define-fun .def_280 () Bool (<= main@%_2_1 .def_43))
(define-fun .def_281 () Bool (not .def_280))
(define-fun .def_267 () Int (+ main@%_6_1 .def_81))
(define-fun .def_276 () Int (select .def_275 .def_267))
(define-fun .def_261 () Int (+ main@%_5_1 .def_43))
(define-fun .def_274 () Int (select .def_273 .def_261))
(define-fun .def_277 () Bool (= .def_274 .def_276))
...
(define-fun .def_251 () Int (* (- 1) .def_177))
(define-fun .def_258 () Int (+ main@%_2_1 .def_251))
(define-fun .def_259 () Bool (= .def_258 1))
(define-fun .def_256 () Bool (not main@%_3_1))
(define-fun .def_252 () Int (+ .def_81 .def_251))
...
(define-fun .def_279 () Bool (and .def_272 .def_278))
...
(define-fun .def_240 () Int (* (- 1) main@%.0.i2_2))
(define-fun .def_241 () Int (+ .def_28 .def_240))
(define-fun .def_242 () Bool (= .def_241 (- 1)))
(define-fun .def_237 () Bool (= .x.16 main@%shadow.mem.0_2))
(define-fun .def_158 () Int (+ .def_14 .def_28))
(define-fun .def_221 () (Array Int Int) (store .def_30 .def_158 .def_43))
(define-fun .def_235 () Bool (= main@%shadow.mem1.0_2 .def_221))
(define-fun .def_165 () Int (* (- 1) .def_28))
(define-fun .def_166 () Int (+ .def_10 .def_165))
(define-fun .def_167 () Bool (<= .def_166 1))
(define-fun .def_233 () Bool (not .def_167))
(define-fun .def_153 () Int (+ .def_16 .def_28))
(define-fun .def_203 () (Array Int Int) (store .def_32 .def_153 .def_43))
(define-fun .def_204 () Bool (= .x.16 .def_203))
...
(define-fun .def_156 () Bool (or .def_60 .def_155))
...
(define-fun .def_224 () Bool (= .x.18 0))
(define-fun .def_222 () Bool (= .x.19 .def_221))
(define-fun .def_217 () Int (* (- 1) .x.17))
(define-fun .def_218 () Int (+ .def_10 .def_217))
...
(define-fun .def_206 () Bool (and .def_156 .def_205))
...
(define-fun .def_194 () Int (+ .def_81 .def_190))
(define-fun .def_195 () Int (+ .def_43 .def_194))
(define-fun .def_196 () Bool (= .def_195 0))
(define-fun .def_191 () Int (+ .def_10 .def_190))
(define-fun .def_192 () Bool (= .def_191 1))
(define-fun .def_187 () Bool (not .def_26))
(define-fun .def_184 () (Array Int Int) (store .def_32 .def_153 .def_177))
(define-fun .def_185 () Bool (= .x.16 .def_184))
(define-fun .def_76 () Int (+ .def_14 .def_43))
(define-fun .def_178 () (Array Int Int) (store .def_30 .def_158 .def_177))
(define-fun .def_179 () Int (select .def_178 .def_76))
(define-fun .def_82 () Int (+ .def_16 .def_81))
(define-fun .def_176 () Int (select .x.16 .def_82))
(define-fun .def_180 () Bool (= .def_176 .def_179))
...
(define-fun .def_140 () Int (* (- 1) .x.18))
(define-fun .def_141 () Int (+ .def_22 .def_140))
(define-fun .def_142 () Bool (= .def_141 (- 1)))
(define-fun .def_92 () Int (* (- 1) .def_22))
(define-fun .def_93 () Int (+ .def_20 .def_92))
(define-fun .def_94 () Int (+ .def_16 .def_93))
(define-fun .def_107 () Int (select .def_18 .def_94))
(define-fun .def_87 () Int (+ .def_14 .def_22))
(define-fun .def_108 () (Array Int Int) (store .def_24 .def_87 .def_107))
(define-fun .def_138 () Bool (= .x.19 .def_108))
(define-fun .def_100 () Int (+ .def_10 .def_92))
(define-fun .def_101 () Bool (<= .def_100 1))
(define-fun .def_136 () Bool (not .def_101))
...
(define-fun .def_113 () Int (* (- 1) .def_81))
...
(define-fun .def_109 () Int (select .def_108 .def_76))
(define-fun .def_106 () Int (select .def_18 .def_82))
(define-fun .def_110 () Bool (= .def_106 .def_109))
