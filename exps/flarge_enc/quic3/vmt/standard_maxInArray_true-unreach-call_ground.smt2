...
(define-fun .def_155 () Bool (<= main@%_6_0 0))
...
(define-fun .def_165 () Int (* 16777216 main@%_6_0))
...
(define-fun .def_121 () (Array Int Int) (store .def_28 .def_108 main@%_6_0))
(define-fun .def_141 () Bool (= main@%shadow.mem.0_2 .def_121))
(define-fun .def_124 () Bool (<= main@%_6_0 .def_30))
(define-fun .def_125 () Bool (not .def_124))
(define-fun .def_126 () Int (ite .def_125 main@%_6_0 .def_30))
