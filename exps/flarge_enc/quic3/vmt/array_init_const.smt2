...
(define-fun .def_92 () Int (+ .def_16 .def_24))
(define-fun .def_109 () (Array Int Int) (store .def_26 .def_92 .def_20))
...
(define-fun .def_120 () Bool (not .def_101))
...
(define-fun .def_95 () Bool (or .def_39 .def_94))
...
(define-fun .def_112 () Bool (= .x.17 .def_22))
