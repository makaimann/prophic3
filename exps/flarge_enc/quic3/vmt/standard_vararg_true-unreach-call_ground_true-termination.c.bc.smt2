...
(define-fun .def_30 () Int (! main@%_7_0_0 :next |main@%_7_1|))
...
(define-fun .def_108 () Bool (<= main@%_5_0 0))
...
(define-fun .def_46 () Bool (= .def_28 main@%shadow.mem.0.0_2))
(define-fun .def_206 () Bool (and .def_46 .def_205))
(define-fun .def_211 () Bool (or .def_206 .def_210))
(define-fun .def_194 () Bool (= main@%_4_1 .def_109))
(define-fun .def_191 () Bool (<= main@%_6_1 0))
...
(define-fun .def_168 () (Array Int Int) (store .def_28 .def_157 main@%_5_0))
(define-fun .def_171 () Bool (= main@%shadow.mem.0.0_2 .def_168))
...
(define-fun .def_56 () Bool (= .def_30 main@%_7_1))
...
(define-fun .def_105 () Int (select .def_18 main@%_5_0))
...
(define-fun .def_116 () Int (* (- 1) main@%_5_0))
