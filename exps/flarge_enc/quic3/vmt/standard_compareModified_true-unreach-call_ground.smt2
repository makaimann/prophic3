...
(define-fun .def_408 () Int (! main@%_16_0 :next |.xtv.1|))
(define-fun .def_418 () Int (! main@%_12_0 :next |.xtv.2|))
...
(define-fun .def_410 () (Array Int Int) (store .def_52 .def_409 .def_408))
...
(define-fun .def_420 () (Array Int Int) (store .def_50 .def_419 .def_418))
