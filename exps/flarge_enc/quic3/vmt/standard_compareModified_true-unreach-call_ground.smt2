...
(define-fun .def_404 () Int (! main@%_16_0 :next |.xtv.1|))
(define-fun .def_413 () Int (! main@%_12_0 :next |.xtv.2|))
...
(define-fun .def_520 () Bool (= .x.17 main@%_6_1))
(define-fun .def_518 () Bool (not main@%_5_1))
(define-fun .def_517 () Bool (= .x.19 main@%_0_1))
(define-fun .def_519 () Bool (and .def_517 .def_518))
(define-fun .def_521 () Bool (and .def_519 .def_520))
(define-fun .def_213 () Bool (= .x.16 0))
(define-fun .def_522 () Bool (and .def_213 .def_521))
...
(define-fun .def_487 () Int (* (- 1) main@%.03.i6_2))
(define-fun .def_488 () Int (+ .def_48 .def_487))
(define-fun .def_489 () Bool (= .def_488 (- 1)))
(define-fun .def_484 () Bool (= .x.20 main@%shadow.mem1.0_2))
(define-fun .def_482 () Bool (= .x.23 main@%shadow.mem2.0_2))
(define-fun .def_424 () Int (* (- 1) .def_48))
(define-fun .def_425 () Int (+ .def_12 .def_424))
(define-fun .def_426 () Bool (<= .def_425 1))
(define-fun .def_480 () Bool (not .def_426))
...
(define-fun .def_405 () Int (+ .def_32 .def_48))
(define-fun .def_406 () (Array Int Int) (store .def_52 .def_405 .def_404))
(define-fun .def_407 () Bool (= .x.23 .def_406))
(define-fun .def_474 () Bool (and .def_407 .def_473))
(define-fun .def_409 () Bool (<= .def_405 0))
(define-fun .def_410 () Bool (not .def_409))
(define-fun .def_178 () Bool (<= .def_32 0))
(define-fun .def_411 () Bool (or .def_178 .def_410))
(define-fun .def_475 () Bool (and .def_411 .def_474))
(define-fun .def_414 () Int (+ .def_16 .def_48))
(define-fun .def_415 () (Array Int Int) (store .def_50 .def_414 .def_413))
(define-fun .def_416 () Bool (= .x.20 .def_415))
(define-fun .def_476 () Bool (and .def_416 .def_475))
(define-fun .def_418 () Bool (<= .def_414 0))
(define-fun .def_419 () Bool (not .def_418))
(define-fun .def_85 () Bool (<= .def_16 0))
(define-fun .def_420 () Bool (or .def_85 .def_419))
(define-fun .def_477 () Bool (and .def_420 .def_476))
(define-fun .def_86 () Bool (not .def_85))
(define-fun .def_478 () Bool (and .def_86 .def_477))
(define-fun .def_179 () Bool (not .def_178))
(define-fun .def_479 () Bool (and .def_179 .def_478))
...
(define-fun .def_466 () Bool (= .x.24 0))
(define-fun .def_464 () Bool (= .x.25 1))
(define-fun .def_462 () Bool (= .x.26 .def_44))
...
(define-fun .def_447 () Bool (and .def_407 .def_446))
(define-fun .def_448 () Bool (and .def_411 .def_447))
(define-fun .def_449 () Bool (and .def_416 .def_448))
(define-fun .def_450 () Bool (and .def_420 .def_449))
...
(define-fun .def_439 () Bool (= .x.18 .x.20))
(define-fun .def_437 () Bool (not .def_36))
...
(define-fun .def_443 () Bool (and .def_228 .def_442))
(define-fun .def_539 () Bool (or .def_443 .def_538))
(define-fun .def_66 () Bool (= .def_28 .x.21))
(define-fun .def_540 () Bool (and .def_66 .def_539))
(define-fun .def_392 () Int (* (- 1) .x.24))
(define-fun .def_393 () Int (+ .def_38 .def_392))
(define-fun .def_394 () Bool (= .def_393 (- 1)))
(define-fun .def_306 () Int (+ .def_32 .def_38))
(define-fun .def_323 () Int (select .def_34 .def_306))
(define-fun .def_296 () Int (+ .def_16 .def_38))
(define-fun .def_297 () Int (select .def_26 .def_296))
(define-fun .def_324 () Bool (= .def_297 .def_323))
(define-fun .def_325 () Int (ite .def_324 .def_40 0))
(define-fun .def_390 () Bool (= .x.25 .def_325))
(define-fun .def_388 () Bool (= .x.21 .x.26))
(define-fun .def_316 () Int (* (- 1) .def_38))
(define-fun .def_317 () Int (+ .def_12 .def_316))
(define-fun .def_318 () Bool (<= .def_317 1))
(define-fun .def_386 () Bool (not .def_318))
...
(define-fun .def_371 () Bool (and .def_179 .def_370))
...
(define-fun .def_298 () Int (+ .def_20 .def_38))
(define-fun .def_299 () (Array Int Int) (store .def_42 .def_298 .def_297))
(define-fun .def_300 () Bool (= .x.21 .def_299))
(define-fun .def_381 () Bool (and .def_300 .def_380))
(define-fun .def_302 () Bool (<= .def_298 0))
(define-fun .def_303 () Bool (not .def_302))
(define-fun .def_102 () Bool (<= .def_20 0))
(define-fun .def_304 () Bool (or .def_102 .def_303))
(define-fun .def_382 () Bool (and .def_304 .def_381))
(define-fun .def_307 () Bool (<= .def_306 0))
(define-fun .def_308 () Bool (not .def_307))
(define-fun .def_309 () Bool (or .def_178 .def_308))
(define-fun .def_383 () Bool (and .def_309 .def_382))
(define-fun .def_311 () Bool (<= .def_296 0))
(define-fun .def_312 () Bool (not .def_311))
(define-fun .def_313 () Bool (or .def_85 .def_312))
(define-fun .def_384 () Bool (and .def_313 .def_383))
...
(define-fun .def_347 () Bool (and .def_179 .def_346))
...
(define-fun .def_355 () Bool (and .def_300 .def_354))
(define-fun .def_356 () Bool (and .def_304 .def_355))
(define-fun .def_357 () Bool (and .def_309 .def_356))
(define-fun .def_358 () Bool (and .def_313 .def_357))
...
(define-fun .def_332 () Bool (= .x.19 .x.21))
...
(define-fun .def_271 () Int (* (- 1) .x.22))
(define-fun .def_272 () Int (+ .def_30 .def_271))
(define-fun .def_273 () Bool (= .def_272 (- 1)))
(define-fun .def_236 () Int (* (- 1) .def_30))
(define-fun .def_237 () Int (+ .def_12 .def_236))
(define-fun .def_238 () Bool (<= .def_237 1))
(define-fun .def_269 () Bool (not .def_238))
...
(define-fun .def_256 () Bool (and .def_179 .def_255))
...
(define-fun .def_191 () Bool (or .def_178 .def_190))
(define-fun .def_266 () Bool (and .def_191 .def_265))
...
(define-fun .def_202 () Int (select .def_34 .def_188))
(define-fun .def_201 () Int (select .def_26 .def_193))
...
(define-fun .def_219 () Bool (and .def_86 .def_218))
...
(define-fun .def_232 () Bool (and .def_191 .def_231))
...
(define-fun .def_158 () Int (* (- 1) .x.16))
(define-fun .def_159 () Int (+ .def_10 .def_158))
(define-fun .def_160 () Bool (= .def_159 (- 1)))
(define-fun .def_118 () Bool (<= .def_12 .def_10))
(define-fun .def_119 () Bool (not .def_118))
(define-fun .def_154 () Bool (and .def_14 .def_119))
(define-fun .def_155 () Bool (= .x.17 .def_154))
...
(define-fun .def_108 () Int (+ .def_10 .def_20))
(define-fun .def_109 () Bool (<= .def_108 0))
(define-fun .def_110 () Bool (not .def_109))
(define-fun .def_111 () Bool (or .def_102 .def_110))
(define-fun .def_151 () Bool (and .def_111 .def_150))
(define-fun .def_113 () Int (+ .def_10 .def_16))
...
(define-fun .def_125 () Int (select .def_22 .def_108))
(define-fun .def_124 () Int (select .def_18 .def_113))
