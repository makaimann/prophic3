...
(define-fun .def_26 () (Array Int Int) (! main@%sm2_0_0 :next |.x.20|))
(define-fun .def_28 () (Array Int Int) (! main@%sm_0_0 :next |.x.21|))
(define-fun .def_30 () Int (! main@%.0.i2_0_0 :next |.x.22|))
(define-fun .def_32 () Int (! main@%_5_0_0 :next |main@%_5_1|))
(define-fun .def_34 () (Array Int Int) (! main@%sm1_0_0 :next |.x.23|))
(define-fun .def_36 () Bool (! main@%_2_0_0 :next |main@%_2_1|))
(define-fun .def_38 () Int (! main@%.14.i3_0_0 :next |.x.24|))
(define-fun .def_40 () Int (! main@%.01.i4_0_0 :next |.x.25|))
(define-fun .def_42 () (Array Int Int) (! main@%shadow.mem.2.0_0_0 :next |.x.26|))
(define-fun .def_44 () (Array Int Int) (! main@%sm5_0_0 :next |main@%sm5_1|))
...
(define-fun .def_52 () (Array Int Int) (! main@%shadow.mem.1.0_0_0 :next |main@%shadow.mem.1.0_2|))
(define-fun .def_54 () Int (! @nd_0_0 :next |.x.28|))
(define-fun .def_514 () Bool (! (= .def_8 0) :init true))
(define-fun .def_552 () Bool (= .def_46 .x.27))
(define-fun .def_551 () Bool (= .def_54 .x.28))
(define-fun .def_553 () Bool (and .def_551 .def_552))
(define-fun .def_533 () Bool (= main@%.03.i6_2 0))
(define-fun .def_470 () Bool (= .x.15 1))
(define-fun .def_528 () Bool (and main@%_2_1 .def_470))
...
(define-fun .def_520 () Bool (= .x.17 main@%_3_1))
(define-fun .def_213 () Bool (= .x.16 0))
(define-fun .def_521 () Bool (and .def_213 .def_520))
(define-fun .def_519 () Bool (= .x.19 main@%sm5_1))
(define-fun .def_522 () Bool (and .def_519 .def_521))
(define-fun .def_518 () Bool (not main@%_2_1))
(define-fun .def_523 () Bool (and .def_518 .def_522))
(define-fun .def_137 () Bool (= .x.15 4))
(define-fun .def_524 () Bool (and .def_137 .def_523))
(define-fun .def_78 () Bool (= .def_48 main@%.03.i6_2))
(define-fun .def_525 () Bool (and .def_78 .def_524))
(define-fun .def_80 () Bool (= .def_50 main@%shadow.mem.0.0_2))
(define-fun .def_526 () Bool (and .def_80 .def_525))
(define-fun .def_82 () Bool (= .def_52 main@%shadow.mem.1.0_2))
(define-fun .def_527 () Bool (and .def_82 .def_526))
(define-fun .def_535 () Bool (or .def_527 .def_534))
(define-fun .def_511 () Bool (<= main@%_6_1 0))
(define-fun .def_512 () Bool (not .def_511))
(define-fun .def_508 () Bool (<= main@%_5_1 0))
(define-fun .def_509 () Bool (not .def_508))
(define-fun .def_505 () Bool (<= main@%_4_1 0))
(define-fun .def_506 () Bool (not .def_505))
(define-fun .def_501 () Bool (<= main@%_1_1 0))
(define-fun .def_502 () Bool (not .def_501))
(define-fun .def_503 () Bool (= main@%_2_1 .def_502))
(define-fun .def_500 () Bool (= main@%_3_1 main@%_2_1))
...
(define-fun .def_516 () Bool (and .def_66 .def_515))
(define-fun .def_70 () Bool (= .def_34 .x.23))
(define-fun .def_517 () Bool (and .def_70 .def_516))
(define-fun .def_536 () Bool (and .def_517 .def_535))
(define-fun .def_405 () Int (* (- 1) .def_48))
(define-fun .def_406 () Int (+ .def_12 .def_405))
(define-fun .def_407 () Bool (<= .def_406 1))
(define-fun .def_484 () Bool (not .def_407))
(define-fun .def_482 () Bool (= .x.21 main@%shadow.mem.0.0_2))
(define-fun .def_478 () Int (* (- 1) main@%.03.i6_2))
(define-fun .def_479 () Int (+ .def_48 .def_478))
(define-fun .def_480 () Bool (= .def_479 (- 1)))
(define-fun .def_475 () Bool (= .x.23 main@%shadow.mem.1.0_2))
(define-fun .def_471 () Bool (and .def_56 .def_470))
(define-fun .def_472 () Bool (and .def_58 .def_471))
...
(define-fun .def_410 () Int (+ .def_32 .def_48))
(define-fun .def_411 () (Array Int Int) (store .def_52 .def_410 main@%_12_0))
(define-fun .def_412 () Bool (= .x.23 .def_411))
...
(define-fun .def_415 () Bool (<= .def_410 0))
(define-fun .def_416 () Bool (not .def_415))
(define-fun .def_417 () Bool (or .def_177 .def_416))
(define-fun .def_488 () Bool (and .def_417 .def_487))
(define-fun .def_420 () Int (+ .def_16 .def_48))
(define-fun .def_421 () (Array Int Int) (store .def_50 .def_420 main@%_9_0))
(define-fun .def_422 () Bool (= .x.21 .def_421))
(define-fun .def_489 () Bool (and .def_422 .def_488))
(define-fun .def_85 () Bool (<= .def_16 0))
(define-fun .def_86 () Bool (not .def_85))
(define-fun .def_490 () Bool (and .def_86 .def_489))
(define-fun .def_425 () Bool (<= .def_420 0))
(define-fun .def_426 () Bool (not .def_425))
(define-fun .def_427 () Bool (or .def_85 .def_426))
(define-fun .def_491 () Bool (and .def_427 .def_490))
(define-fun .def_429 () Bool (= .def_8 1))
(define-fun .def_492 () Bool (and .def_429 .def_491))
(define-fun .def_88 () Bool (= .def_12 main@%_1_1))
(define-fun .def_493 () Bool (and .def_88 .def_492))
(define-fun .def_90 () Bool (= .def_16 main@%_4_1))
...
(define-fun .def_94 () Bool (= .def_24 main@%_3_1))
(define-fun .def_496 () Bool (and .def_94 .def_495))
(define-fun .def_96 () Bool (= .def_32 main@%_5_1))
...
(define-fun .def_100 () Bool (= .def_44 main@%sm5_1))
(define-fun .def_499 () Bool (and .def_100 .def_498))
(define-fun .def_537 () Bool (or .def_499 .def_536))
(define-fun .def_74 () Bool (= .def_40 .x.25))
(define-fun .def_72 () Bool (= .def_38 .x.24))
(define-fun .def_398 () Bool (and .def_72 .def_74))
(define-fun .def_76 () Bool (= .def_42 .x.26))
(define-fun .def_399 () Bool (and .def_76 .def_398))
(define-fun .def_538 () Bool (and .def_399 .def_537))
(define-fun .def_467 () Bool (= .x.26 .def_44))
(define-fun .def_465 () Bool (= .x.24 0))
(define-fun .def_463 () Bool (= .x.25 1))
...
(define-fun .def_445 () Bool (and .def_78 .def_337))
...
(define-fun .def_449 () Bool (and .def_412 .def_448))
(define-fun .def_450 () Bool (and .def_178 .def_449))
(define-fun .def_451 () Bool (and .def_417 .def_450))
(define-fun .def_452 () Bool (and .def_422 .def_451))
...
(define-fun .def_456 () Bool (and .def_88 .def_455))
(define-fun .def_457 () Bool (and .def_90 .def_456))
(define-fun .def_458 () Bool (and .def_92 .def_457))
(define-fun .def_459 () Bool (and .def_94 .def_458))
(define-fun .def_460 () Bool (and .def_96 .def_459))
(define-fun .def_461 () Bool (and .def_98 .def_460))
...
(define-fun .def_380 () Bool (= .x.15 2))
(define-fun .def_469 () Bool (and .def_380 .def_468))
(define-fun .def_539 () Bool (or .def_469 .def_538))
(define-fun .def_443 () Bool (not .def_36))
(define-fun .def_441 () Bool (= .x.19 .def_44))
(define-fun .def_439 () Bool (= .x.18 .x.21))
(define-fun .def_400 () Bool (and .def_213 .def_399))
...
(define-fun .def_438 () Bool (and .def_228 .def_437))
...
(define-fun .def_540 () Bool (or .def_444 .def_539))
(define-fun .def_64 () Bool (= .def_26 .x.20))
(define-fun .def_541 () Bool (and .def_64 .def_540))
(define-fun .def_296 () Int (* (- 1) .def_38))
(define-fun .def_297 () Int (+ .def_12 .def_296))
(define-fun .def_298 () Bool (<= .def_297 1))
(define-fun .def_390 () Bool (not .def_298))
(define-fun .def_388 () Bool (= .x.20 .x.26))
(define-fun .def_384 () Int (* (- 1) .x.24))
(define-fun .def_385 () Int (+ .def_38 .def_384))
...
(define-fun .def_366 () Bool (and .def_66 .def_245))
...
(define-fun .def_375 () Bool (and .def_92 .def_374))
(define-fun .def_376 () Bool (and .def_94 .def_375))
(define-fun .def_377 () Bool (and .def_96 .def_376))
(define-fun .def_378 () Bool (and .def_98 .def_377))
(define-fun .def_379 () Bool (and .def_100 .def_378))
...
(define-fun .def_304 () Bool (= .x.20 .def_303))
(define-fun .def_392 () Bool (and .def_304 .def_391))
...
(define-fun .def_394 () Bool (and .def_309 .def_393))
...
(define-fun .def_542 () Bool (or .def_397 .def_541))
(define-fun .def_68 () Bool (= .def_30 .x.22))
(define-fun .def_543 () Bool (and .def_68 .def_542))
...
(define-fun .def_544 () Bool (or .def_365 .def_543))
(define-fun .def_332 () Bool (= .x.19 .x.20))
(define-fun .def_328 () Bool (and .def_36 .def_327))
(define-fun .def_329 () Bool (not .def_328))
(define-fun .def_276 () Bool (and .def_66 .def_68))
...
(define-fun .def_230 () Bool (= .x.18 .def_28))
(define-fun .def_331 () Bool (and .def_230 .def_330))
(define-fun .def_333 () Bool (and .def_331 .def_332))
(define-fun .def_545 () Bool (or .def_333 .def_544))
...
(define-fun .def_202 () Int (select .def_28 .def_193))
...
(define-fun .def_546 () Bool (or .def_275 .def_545))
(define-fun .def_241 () Bool (= .x.19 .def_26))
...
(define-fun .def_547 () Bool (or .def_242 .def_546))
...
(define-fun .def_548 () Bool (or .def_206 .def_547))
...
(define-fun .def_549 () Bool (or .def_162 .def_548))
...
(define-fun .def_550 () Bool (or .def_128 .def_549))
(define-fun .def_554 () Bool (! (and .def_550 .def_553) :trans true))
(define-fun .def_555 () Bool (= .def_8 5))
(define-fun .def_556 () Bool (! (not .def_555) :invar-property 0))
(assert true)
