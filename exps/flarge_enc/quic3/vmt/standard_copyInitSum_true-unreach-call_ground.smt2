...
(define-fun .def_309 () Bool (= .x.17 main@%_5_1))
(define-fun .def_305 () Int (* (- 1) main@%_9_1))
(define-fun .def_306 () Int (+ .x.19 .def_305))
(define-fun .def_307 () Bool (= .def_306 42))
(define-fun .def_302 () Bool (not main@%_4_1))
(define-fun .def_301 () Bool (= .x.18 main@%_1_1))
...
(define-fun .def_275 () Int (* (- 1) main@%.01.i2_2))
(define-fun .def_276 () Int (+ .def_38 .def_275))
(define-fun .def_277 () Bool (= .def_276 (- 1)))
(define-fun .def_272 () Bool (= .x.21 main@%shadow.mem.0_2))
(define-fun .def_220 () Int (* (- 1) .def_38))
(define-fun .def_221 () Int (+ .def_12 .def_220))
(define-fun .def_222 () Bool (<= .def_221 1))
(define-fun .def_270 () Bool (not .def_222))
...
(define-fun .def_211 () Int (+ .def_26 .def_38))
(define-fun .def_212 () (Array Int Int) (store .def_40 .def_211 42))
(define-fun .def_213 () Bool (= .x.21 .def_212))
(define-fun .def_267 () Bool (and .def_213 .def_266))
(define-fun .def_215 () Bool (<= .def_211 0))
(define-fun .def_216 () Bool (not .def_215))
(define-fun .def_134 () Bool (<= .def_26 0))
(define-fun .def_217 () Bool (or .def_134 .def_216))
...
(define-fun .def_233 () Bool (not .def_36))
...
(define-fun .def_149 () Int (+ .x.19 .def_148))
(define-fun .def_150 () Bool (= .def_149 42))
(define-fun .def_237 () Bool (and .def_150 .def_236))
(define-fun .def_152 () Bool (= .x.17 .def_24))
(define-fun .def_238 () Bool (and .def_152 .def_237))
(define-fun .def_327 () Bool (or .def_238 .def_326))
(define-fun .def_201 () Int (* (- 1) .x.20))
(define-fun .def_202 () Int (+ .def_28 .def_201))
(define-fun .def_203 () Bool (= .def_202 (- 1)))
(define-fun .def_159 () Int (+ .def_26 .def_28))
(define-fun .def_173 () Int (select .def_30 .def_159))
(define-fun .def_174 () Int (+ .def_22 .def_173))
(define-fun .def_154 () Int (+ .def_16 .def_28))
(define-fun .def_175 () (Array Int Int) (store .def_32 .def_154 .def_174))
(define-fun .def_199 () Bool (= .x.22 .def_175))
(define-fun .def_166 () Int (* (- 1) .def_28))
(define-fun .def_167 () Int (+ .def_12 .def_166))
(define-fun .def_168 () Bool (<= .def_167 1))
(define-fun .def_197 () Bool (not .def_168))
...
(define-fun .def_157 () Bool (or .def_79 .def_156))
...
(define-fun .def_195 () Bool (and .def_162 .def_194))
...
(define-fun .def_122 () Int (* (- 1) .x.16))
(define-fun .def_123 () Int (+ .def_10 .def_122))
(define-fun .def_124 () Bool (= .def_123 (- 1)))
(define-fun .def_87 () Bool (<= .def_12 .def_10))
(define-fun .def_88 () Bool (not .def_87))
(define-fun .def_118 () Bool (and .def_14 .def_88))
(define-fun .def_119 () Bool (= .x.17 .def_118))
...
(define-fun .def_82 () Int (+ .def_10 .def_16))
(define-fun .def_93 () Int (select .def_18 .def_82))
(define-fun .def_94 () Bool (= .def_20 .def_93))
(define-fun .def_116 () Bool (and .def_94 .def_115))
(define-fun .def_83 () Bool (<= .def_82 0))
(define-fun .def_84 () Bool (not .def_83))
(define-fun .def_85 () Bool (or .def_79 .def_84))
(define-fun .def_117 () Bool (and .def_85 .def_116))
