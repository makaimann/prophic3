...
(define-fun .def_18 () (Array Int Int) (! main@%shadow.mem.1.2_0_0 :next |.x.18|))
...
(define-fun .def_26 () Int (! main@%_5_0_0 :next |main@%_5_1|))
...
(define-fun .def_34 () (Array Int Int) (! main@%shadow.mem.1.0_0_0 :next |.x.23|))
...
(define-fun .def_367 () Bool (and main@%_2_1 .def_321))
...
(define-fun .def_352 () Bool (<= main@%_6_1 0))
(define-fun .def_353 () Bool (not .def_352))
(define-fun .def_349 () Bool (<= main@%_5_1 0))
(define-fun .def_350 () Bool (not .def_349))
(define-fun .def_345 () Bool (<= main@%_1_1 0))
(define-fun .def_346 () Bool (not .def_345))
(define-fun .def_347 () Bool (= main@%_2_1 .def_346))
(define-fun .def_344 () Bool (= main@%_3_1 main@%_2_1))
...
(define-fun .def_325 () Bool (= .x.21 main@%shadow.mem.0.0_2))
...
(define-fun .def_66 () Bool (= .def_16 main@%_6_1))
(define-fun .def_339 () Bool (and .def_66 .def_338))
(define-fun .def_68 () Bool (= .def_20 main@%_3_1))
(define-fun .def_340 () Bool (and .def_68 .def_339))
(define-fun .def_70 () Bool (= .def_26 main@%_5_1))
...
(define-fun .def_74 () Bool (= .def_36 main@%sm4_1))
