...
(define-fun .def_176 () Int (! main@%_11_0 :next |.xtv.1|))
...
(define-fun .def_460 () Int (* (- 1) main@%_3_1))
...
(define-fun .def_439 () Bool (= .x.25 main@%shadow.mem.0_2))
...
(define-fun .def_353 () (Array Int Int) (store .def_50 .def_352 .def_176))
...
(define-fun .def_193 () Int (select .def_28 .def_176))
...
(define-fun .def_181 () Int (* (- 1) .def_176))
