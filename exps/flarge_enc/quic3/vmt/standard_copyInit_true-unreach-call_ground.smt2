...
(define-fun .def_275 () Bool (= .x.17 main@%_5_1))
(define-fun .def_273 () Bool (not main@%_4_1))
(define-fun .def_272 () Bool (= .x.18 main@%_0_1))
...
(define-fun .def_247 () Int (* (- 1) main@%.01.i2_2))
(define-fun .def_248 () Int (+ .def_34 .def_247))
(define-fun .def_249 () Bool (= .def_248 (- 1)))
(define-fun .def_244 () Bool (= .x.20 main@%shadow.mem1.0_2))
(define-fun .def_197 () Int (* (- 1) .def_34))
(define-fun .def_198 () Int (+ .def_12 .def_197))
(define-fun .def_199 () Bool (<= .def_198 1))
(define-fun .def_242 () Bool (not .def_199))
...
(define-fun .def_188 () Int (+ .def_22 .def_34))
(define-fun .def_189 () (Array Int Int) (store .def_36 .def_188 42))
(define-fun .def_190 () Bool (= .x.20 .def_189))
(define-fun .def_239 () Bool (and .def_190 .def_238))
(define-fun .def_192 () Bool (<= .def_188 0))
(define-fun .def_193 () Bool (not .def_192))
(define-fun .def_123 () Bool (<= .def_22 0))
(define-fun .def_194 () Bool (or .def_123 .def_193))
(define-fun .def_240 () Bool (and .def_194 .def_239))
...
(define-fun .def_211 () Bool (= .x.18 .def_30))
(define-fun .def_209 () Bool (not .def_32))
...
(define-fun .def_178 () Int (* (- 1) .x.19))
(define-fun .def_179 () Int (+ .def_24 .def_178))
(define-fun .def_180 () Bool (= .def_179 (- 1)))
(define-fun .def_139 () Int (+ .def_22 .def_24))
(define-fun .def_153 () Int (select .def_26 .def_139))
(define-fun .def_134 () Int (+ .def_16 .def_24))
(define-fun .def_154 () (Array Int Int) (store .def_28 .def_134 .def_153))
(define-fun .def_176 () Bool (= .x.21 .def_154))
(define-fun .def_146 () Int (* (- 1) .def_24))
(define-fun .def_147 () Int (+ .def_12 .def_146))
(define-fun .def_148 () Bool (<= .def_147 1))
(define-fun .def_174 () Bool (not .def_148))
...
(define-fun .def_137 () Bool (or .def_69 .def_136))
...
(define-fun .def_172 () Bool (and .def_142 .def_171))
...
(define-fun .def_107 () Bool (and .def_14 .def_78))
(define-fun .def_108 () Bool (= .x.17 .def_107))
