...
(define-fun .def_190 () (Array Int Int) (store .def_30 .def_165 .def_144))
(define-fun .def_216 () Bool (= main@%shadow.mem.0_2 .def_190))
...
(define-fun .def_186 () (Array Int Int) (store .def_28 .def_159 20))
(define-fun .def_207 () Bool (= main@%shadow.mem1.0_2 .def_186))
(define-fun .def_97 () Bool (not .def_94))
(define-fun .def_208 () Bool (or .def_97 .def_207))
(define-fun .def_119 () Bool (not .def_118))
(define-fun .def_205 () Bool (or .def_46 .def_119))
...
(define-fun .def_183 () Bool (= .x.18 .def_28))
