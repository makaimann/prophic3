...
(define-fun .def_20 () Int (! main@%_20_0_0 :next |.x.19|))
(define-fun .def_22 () Int (! main@%_7_0_0 :next |main@%_7_1|))
(define-fun .def_24 () Bool (! main@%_3_0_0 :next |main@%_3_1|))
(define-fun .def_26 () Int (! main@%_4_0_0 :next |main@%_4_1|))
(define-fun .def_28 () Int (! main@%.1.i1_0_0 :next |.x.20|))
(define-fun .def_30 () (Array Int Int) (! main@%sm_0_0 :next |.x.21|))
(define-fun .def_32 () (Array Int Int) (! main@%shadow.mem.1.0_0_0 :next |.x.22|))
(define-fun .def_34 () (Array Int Int) (! main@%sm3_0_0 :next |main@%sm3_1|))
...
(define-fun .def_315 () Bool (and main@%_2_1 .def_262))
...
(define-fun .def_295 () Bool (<= main@%_5_1 0))
(define-fun .def_296 () Bool (not .def_295))
(define-fun .def_292 () Bool (<= main@%_4_1 0))
(define-fun .def_293 () Bool (not .def_292))
(define-fun .def_288 () Bool (<= main@%_1_1 0))
(define-fun .def_289 () Bool (not .def_288))
(define-fun .def_290 () Bool (= main@%_2_1 .def_289))
(define-fun .def_287 () Bool (= main@%_3_1 main@%_2_1))
...
(define-fun .def_267 () Bool (= .x.21 main@%shadow.mem.0.0_2))
...
(define-fun .def_64 () Bool (= .def_12 main@%_1_1))
(define-fun .def_280 () Bool (and .def_64 .def_279))
(define-fun .def_66 () Bool (= .def_16 main@%_5_1))
(define-fun .def_281 () Bool (and .def_66 .def_280))
(define-fun .def_68 () Bool (= .def_22 main@%_7_1))
(define-fun .def_282 () Bool (and .def_68 .def_281))
(define-fun .def_70 () Bool (= .def_24 main@%_3_1))
(define-fun .def_283 () Bool (and .def_70 .def_282))
(define-fun .def_72 () Bool (= .def_26 main@%_4_1))
(define-fun .def_284 () Bool (and .def_72 .def_283))
(define-fun .def_74 () Bool (= .def_34 main@%sm3_1))
(define-fun .def_285 () Bool (and .def_74 .def_284))
(define-fun .def_76 () Bool (= .def_36 main@%_2_1))
