...
(declare-fun main@%shadow.mem.0.3_1 () (Array Int Int))
(define-fun .def_8 () Int (! .x.14 :next |.x.15|))
(define-fun .def_10 () Int (! main@%_0_0_0 :next |main@%_0_1|))
(define-fun .def_12 () Bool (! main@%_2_0_0 :next |main@%_2_1|))
(define-fun .def_14 () Int (! main@%_3_0_0 :next |main@%_3_1|))
(define-fun .def_16 () Int (! main@%_4_0_0 :next |main@%_4_1|))
(define-fun .def_18 () (Array Int Int) (! main@%sm1_0_0 :next |.x.16|))
(define-fun .def_20 () Int (! main@%_11_0_0 :next |.x.17|))
(define-fun .def_22 () Int (! main@%.1.i1_0_0 :next |.x.18|))
(define-fun .def_24 () (Array Int Int) (! main@%shadow.mem.0.2_0_0 :next |.x.19|))
(define-fun .def_26 () Bool (! main@%_1_0_0 :next |main@%_1_1|))
...
(define-fun .def_270 () Bool (<= main@%_4_1 0))
(define-fun .def_298 () Bool (not .def_270))
(define-fun .def_275 () Bool (<= main@%_3_1 0))
(define-fun .def_296 () Bool (not .def_275))
(define-fun .def_292 () Bool (<= main@%_0_1 0))
(define-fun .def_293 () Bool (not .def_292))
(define-fun .def_294 () Bool (= main@%_1_1 .def_293))
(define-fun .def_291 () Bool (= main@%_2_1 main@%_1_1))
...
(define-fun .def_287 () Bool (and main@%_1_1 .def_228))
(define-fun .def_289 () Bool (and .def_287 .def_288))
(define-fun .def_281 () Bool (not main@%_1_1))
(define-fun .def_251 () Int (* (- 1) main@%.pre_phi_0))
(define-fun .def_278 () Int (+ main@%_0_1 .def_251))
(define-fun .def_279 () Bool (= .def_278 1))
(define-fun .def_259 () Int (+ main@%_3_1 main@%_19_0))
(define-fun .def_273 () Bool (<= .def_259 0))
(define-fun .def_274 () Bool (not .def_273))
(define-fun .def_276 () Bool (or .def_274 .def_275))
(define-fun .def_256 () Int (+ main@%_4_1 main@%_25_0))
(define-fun .def_268 () Bool (<= .def_256 0))
(define-fun .def_269 () Bool (not .def_268))
(define-fun .def_271 () Bool (or .def_269 .def_270))
(define-fun .def_265 () Bool (<= main@%_0_1 main@%_19_0))
(define-fun .def_266 () Bool (not .def_265))
(define-fun .def_261 () Int (select main@%shadow.mem.0.3_1 .def_259))
(define-fun .def_258 () Int (select main@%shadow.mem.1.2_1 .def_256))
(define-fun .def_262 () Bool (= .def_258 .def_261))
(define-fun .def_263 () Bool (not .def_262))
(define-fun .def_252 () Int (+ main@%_25_0 .def_251))
(define-fun .def_253 () Int (+ main@%_19_0 .def_252))
(define-fun .def_254 () Bool (= .def_253 0))
(define-fun .def_44 () Bool (<= main@%_19_0 (- 1)))
(define-fun .def_45 () Bool (not .def_44))
(define-fun .def_250 () Bool (and main@%_2_1 .def_45))
...
(define-fun .def_52 () Bool (= .def_30 main@%shadow.mem.0.0_2))
(define-fun .def_285 () Bool (and .def_52 .def_284))
(define-fun .def_54 () Bool (= .def_32 main@%shadow.mem.1.0_2))
...
(define-fun .def_235 () Bool (= .x.16 main@%shadow.mem.1.0_2))
...
(define-fun .def_217 () (Array Int Int) (store .def_30 .def_164 main@%_19_0))
(define-fun .def_227 () Bool (= main@%shadow.mem.0.0_2 .def_217))
...
(define-fun .def_204 () (Array Int Int) (store .def_32 .def_158 main@%_19_0))
...
(define-fun .def_63 () Bool (= .def_10 main@%_0_1))
(define-fun .def_245 () Bool (and .def_63 .def_244))
(define-fun .def_65 () Bool (= .def_12 main@%_2_1))
...
(define-fun .def_69 () Bool (= .def_16 main@%_4_1))
(define-fun .def_248 () Bool (and .def_69 .def_247))
(define-fun .def_71 () Bool (= .def_26 main@%_1_1))
...
(define-fun .def_188 () Int (+ main@%_25_0 .def_187))
(define-fun .def_189 () Int (+ main@%_19_0 .def_188))
(define-fun .def_190 () Bool (= .def_189 0))
(define-fun .def_77 () Int (+ .def_16 main@%_25_0))
(define-fun .def_179 () Int (select .x.16 .def_77))
(define-fun .def_82 () Int (+ .def_14 main@%_19_0))
...
(define-fun .def_73 () Bool (<= .def_10 main@%_19_0))
...
(define-fun .def_113 () Int (* (- 1) main@%_25_0))
(define-fun .def_114 () Int (* (- 1) main@%_19_0))
