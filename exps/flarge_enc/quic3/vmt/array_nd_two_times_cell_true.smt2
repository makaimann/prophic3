...
(define-fun .def_74 () Int (! main@%_28_0 :next |.xtv.2|))
(define-fun .def_81 () Int (! main@%_30_0 :next |.xtv.3|))
(define-fun .def_82 () Int (! main@%.lcssa_0 :next |.xtv.4|))
(define-fun .def_126 () Int (! main@%_21_0_0 :next |.xtv.5|))
...
(define-fun .def_110 () Bool (<= .def_81 0))
...
(define-fun .def_178 () Int (select .def_177 .def_74))
(define-fun .def_185 () Int (* (- 2) .def_178))
(define-fun .def_176 () Int (select .def_175 .def_81))
...
(define-fun .def_151 () (Array Int Int) (store .def_24 .def_57 .def_74))
...
(define-fun .def_141 () Int (* 2 .def_74))
(define-fun .def_84 () Bool (= .def_18 0))
(define-fun .def_142 () Int (ite .def_84 .def_141 .def_74))
...
(define-fun .def_129 () Int (* (- 1) .def_126))
(define-fun .def_130 () Int (+ .def_28 .def_129))
(define-fun .def_131 () Bool (= .def_130 (- 1)))
(define-fun .def_127 () Bool (<= .def_10 .def_126))
...
(define-fun .def_88 () (Array Int Int) (store .def_24 .def_57 .def_82))
(define-fun .def_89 () Int (select .def_88 .def_74))
(define-fun .def_105 () Int (* (- 2) .def_89))
(define-fun .def_83 () Int (* 2 .def_82))
(define-fun .def_85 () Int (ite .def_84 .def_83 .def_82))
(define-fun .def_86 () (Array Int Int) (store .def_26 .def_49 .def_85))
(define-fun .def_87 () Int (select .def_86 .def_81))
