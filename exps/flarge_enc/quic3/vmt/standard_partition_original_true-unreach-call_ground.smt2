...
(define-fun .def_118 () Int (! main@%.15.i_1 :next |.xtv.4|))
...
(define-fun .def_153 () (Array Int Int) (store .def_26 .def_129 .def_123))
(define-fun .def_183 () Bool (= main@%shadow.mem.0_2 .def_153))
...
(define-fun .def_150 () Bool (= .x.17 .def_118))
