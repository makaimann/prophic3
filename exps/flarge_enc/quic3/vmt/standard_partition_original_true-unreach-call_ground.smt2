...
(define-fun .def_114 () Int (! main@%.15.i_1 :next |.xtv.4|))
...
(define-fun .def_221 () Bool (= main@%.03.i2_2 0))
...
(define-fun .def_187 () Int (* (- 1) main@%.03.i2_2))
...
(define-fun .def_177 () Bool (= main@%shadow.mem.0_2 .def_151))
(define-fun .def_178 () Bool (or .def_103 .def_177))
...
(define-fun .def_172 () Bool (and .def_117 .def_171))
...
(define-fun .def_174 () Bool (and .def_129 .def_173))
...
(define-fun .def_155 () Bool (= .x.17 .def_114))
(define-fun .def_156 () Bool (or .def_103 .def_155))
(define-fun .def_152 () Bool (= .x.19 .def_151))
(define-fun .def_153 () Bool (or .def_103 .def_152))
(define-fun .def_148 () Bool (= .x.19 .def_26))
