(set-info :original "./flarge_enc/llvm/sanfoundry_27_true-unreach-call_ground.c.bc")
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main 0
           ...
           (=> (and main@.lr.ph4_0 main@entry_0) main@%_2_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (= main@%_19_0 (> main@%_1_1 0))
           (= main@%_20_0 (and main@%_3_1 main@%_19_0))
           (= main@%_21_0 (< main@%.01.i.lcssa_2 main@%_18_1))
...
(assert (forall ((main@%_19_0 Bool)
  ...
  (=> (and (main 0
           ...
           (=> (and main@verifier.error_0 main@._crit_edge_0) main@%_21_0)
           (= main@%assume.flag.1_0 main@%_20_0)
           (=> (and main@verifier.error_0 main@._crit_edge_0)
...
(assert (forall ((main@%.01.i2_2 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge5_0 main@_bb_0) (not main@%_10_0))
                  (= main@%.pre_1 (select main@%sm_1 main@%_4_0))
                  (= main@%_11_0 (> main@%_1_0 1))
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge_0 main@._crit_edge5_0)
                      (= main@%.01.i.lcssa_2 main@%.01.i.lcssa_1))
                  (= main@%_19_0 (> main@%_1_0 0))
                  (= main@%_20_0 (and main@%_3_0 main@%_19_0))
                  (= main@%_21_0 (< main@%.01.i.lcssa_2 main@%_18_1))
                  (=> main@._crit_edge6.lr.ph_0
                      (and main@._crit_edge6.lr.ph_0 main@._crit_edge_0))
                  (=> (and main@._crit_edge6.lr.ph_0 main@._crit_edge_0)
...
(assert (forall ((main@%_13_0 Int)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_0)
                  true
                  (= main@%_13_0 (+ main@%_4_0 (* main@%.13.i1_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_13_0 0))
                  (> main@%_4_0 0)
                  (= main@%_14_0 (select main@%sm_0 main@%_13_0))
                  (= main@%_15_0 (< main@%.01.i2_0 main@%_14_0))
                  (= main@%..01.i_0
                     (ite main@%_15_0 main@%_14_0 main@%.01.i2_0))
                  (= main@%_16_0 (+ main@%.13.i1_0 1))
                  (= main@%_17_0 (< main@%_16_0 main@%_1_0))
                  (=> main@_bb2_1 (and main@_bb2_1 main@_bb2_0))
                  (=> (and main@_bb2_1 main@_bb2_0) main@%_17_0)
                  (= main@%.01.i2_1 main@%..01.i_0)
                  (= main@%.13.i1_1 main@%_16_0)
...
(assert (forall ((main@%.phi.trans.insert_0 Int)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (= main@%assume.flag.1_0 main@%_24_0)
                  (=> (and main@verifier.error_0 main@verifier.error.loopexit_0)
                      (= main@%assume.flag.1_1 main@%assume.flag.1_0))
                  (=> main@verifier.error_0 main@%assume.flag.1_1)
                  (=> main@verifier.error.split_0
