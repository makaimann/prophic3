(set-info :original "./flarge_enc/llvm/standard_copy1_true-unreach-call_ground.c.bc")
...
(assert (forall ((main@%_14_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb4_0) (not main@%_20_0))
