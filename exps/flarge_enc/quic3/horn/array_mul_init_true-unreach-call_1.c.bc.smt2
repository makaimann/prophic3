(set-info :original "./flarge_enc/llvm/array_mul_init_true-unreach-call_1.c.bc")
...
(assert (forall ((main@%shadow.mem.1.0_2 (Array Int Int))
  ...
  (=> (and (main 0
           ...
           (=> (and main@.lr.ph3_0 main@entry_0) main@%_2_1)
...
(assert (forall ((main@%_7_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@.lr.ph_0 main@._crit_edge4_0) main@%_2_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge_0 main@._crit_edge4_0)
                      (not main@%_2_0))
                  (= main@%shadow.mem.1.3_1 main@%sm1_0)
...
(assert (forall ((main@%_26_0 Bool)
         ...
         (main@_bb8_0 Bool)
         (|tuple(main@_bb6_0, main@_bb8_0)| Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nondet_int_0)
                  true
                  (= main@%_13_0 @__VERIFIER_nondet_short_0)
                  ...
                  (= main@%_20_0 (+ main@%_4_0 (* main@%.1.i1_0 1)))
                  (=> main@_bb7_0 (or (<= main@%_4_0 0) (> main@%_20_0 0)))
                  (=> main@_bb7_0 (> main@%_4_0 0))
                  (= main@%sm2_0
                     (store main@%shadow.mem.0.1_0 main@%_20_0 main@%_19_0))
                  (= main@%_22_0 main@%_21_0)
                  (= main@%_23_0 (+ main@%_5_0 (* main@%.1.i1_0 1)))
                  (=> main@_bb7_0 (or (<= main@%_5_0 0) (> main@%_23_0 0)))
                  (=> main@_bb7_0 (> main@%_5_0 0))
                  (= main@%sm3_0
                     (store main@%shadow.mem.1.1_0 main@%_23_0 main@%_22_0))
                  (=> |tuple(main@_bb6_0, main@_bb8_0)| main@_bb6_0)
                  (=> main@_bb8_0
                      (or (and main@_bb8_0 main@_bb7_0)
                          |tuple(main@_bb6_0, main@_bb8_0)|))
                  (=> |tuple(main@_bb6_0, main@_bb8_0)| main@%_15_0)
                  (= main@%shadow.mem.1.2_0 main@%sm3_0)
                  (= main@%shadow.mem.0.2_0 main@%sm2_0)
                  (= main@%shadow.mem.1.2_1 main@%shadow.mem.1.1_0)
                  ...
                  (= main@%_25_0 (+ main@%.1.i1_0 1))
                  (= main@%_26_0 (< main@%_25_0 main@%_1_0))
                  (=> main@_bb6_1 (and main@_bb6_1 main@_bb8_0))
                  (=> (and main@_bb6_1 main@_bb8_0) main@%_26_0)
                  (= main@%shadow.mem.1.1_1 main@%shadow.mem.1.2_2)
                  (= main@%shadow.mem.0.1_1 main@%shadow.mem.0.2_2)
                  (= main@%.1.i1_1 main@%_25_0)
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%shadow.mem.1.3_1 main@%shadow.mem.1.2_2)
...
(assert (forall ((main@%_36_0 Int)
         ...
         (main@_bb10_0 Bool)
         (main@_bb11_0 Bool)
         (|tuple(main@_bb10_0, main@_bb11_0)| Bool)
         (|tuple(main@_bb9_0, main@_bb11_0)| Bool)
         (main@%_41_0 Int)
         (main@_bb9_1 Bool))
  (let ((a!1 (and (main 3
                        main@%.2.i_0
                        ...
                        @nondet_int_0)
                  true
                  (= main@%_28_0 (< main@%.2.i_0 main@%_1_0))
                  (= main@%_29_0 (and main@%assume.flag.0_0 main@%_28_0))
                  (= main@%_30_0 (+ main@%_4_0 (* main@%.2.i_0 1)))
                  (or (<= main@%_4_0 0) (> main@%_30_0 0))
                  (> main@%_4_0 0)
                  (= main@%_31_0 (select main@%shadow.mem.0.3_0 main@%_30_0))
                  (= main@%_32_0 (+ main@%_5_0 (* main@%.2.i_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_32_0 0))
                  (> main@%_5_0 0)
                  (= main@%_33_0 (select main@%shadow.mem.1.3_0 main@%_32_0))
                  (= main@%_34_0 (= main@%_31_0 main@%_33_0))
                  (=> main@_bb10_0 (and main@_bb10_0 main@_bb9_0))
                  (=> (and main@_bb10_0 main@_bb9_0) (not main@%_34_0))
                  (= main@%_36_0 main@%_33_0)
                  (= main@%_37_0 main@%_31_0)
                  (= main@%_39_0 (= main@%_38_0 main@%_36_0))
                  (=> |tuple(main@_bb10_0, main@_bb11_0)| main@_bb10_0)
                  (=> |tuple(main@_bb9_0, main@_bb11_0)| main@_bb9_0)
                  (=> main@_bb11_0
                      (or |tuple(main@_bb10_0, main@_bb11_0)|
                          |tuple(main@_bb9_0, main@_bb11_0)|))
                  (=> |tuple(main@_bb10_0, main@_bb11_0)| main@%_39_0)
                  (=> |tuple(main@_bb9_0, main@_bb11_0)| main@%_34_0)
                  (= main@%_41_0 (+ main@%.2.i_0 1))
                  (=> main@_bb9_1 (and main@_bb9_1 main@_bb11_0))
                  (= main@%assume.flag.0_1 main@%_29_0)
...
(assert (forall ((main@%_36_0 Int)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb10_0)
                      (not main@%_39_0))
                  (=> main@verifier.error_0 main@%_29_0)
