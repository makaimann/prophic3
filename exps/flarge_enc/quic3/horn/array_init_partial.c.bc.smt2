(set-info :original "./flarge_enc/llvm/array_init_partial.c.bc")
...
(assert (forall ((main@%shadow.mem.0.0_2 (Array Int Int))
  ...
  (=> (and (main 0
           ...
           (= main@%_4_0 (> main@%_1_1 (- 1)))
           (= main@%_5_0 (<= main@%_1_1 main@%_0_0))
           (= main@%..i_0 (and main@%_4_0 main@%_5_0))
           (= main@%_6_1 (and main@%_3_0 main@%..i_0))
           (> main@%_7_1 0)
           (= main@%_8_0 (> main@%_1_1 0))
...
(assert (forall ((main@%_10_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        main@%shadow.mem.0.0_0)
                  true
                  (= main@%_10_0 (+ main@%_7_0 (* main@%.0.i1_0 1)))
                  (or (<= main@%_7_0 0) (> main@%_10_0 0))
                  (> main@%_7_0 0)
                  (= main@%sm_0 (store main@%shadow.mem.0.0_0 main@%_10_0 0))
...
(assert (forall ((main@%_14_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb2_0) (not main@%_18_0))
