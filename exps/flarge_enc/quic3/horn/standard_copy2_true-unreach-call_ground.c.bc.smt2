(set-info :original "./flarge_enc/llvm/standard_copy2_true-unreach-call_ground.c.bc")
...
(assert (forall ((main@%shadow.mem.2.0_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge4_0 main@_bb_0) (not main@%_13_0))
...
(assert (forall ((main@%_15_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%_17_0 (+ main@%_6_0 (* main@%.1.i1_0 1)))
                  ...
                  (=> (and main@_bb6_1 main@_bb6_0) main@%_19_0)
...
(assert (forall ((main@%_21_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (= main@%_23_0 (+ main@%_4_0 (* main@%.0.i_0 1)))
                  ...
                  (=> (and main@_bb7_1 main@_bb7_0) main@%_27_0)
...
(assert (forall ((main@%_21_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb7_0) (not main@%_27_0))
