(set-info :original "./flarge_enc/quic3/llvm/array_monotonic_set.bc")
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (= main@%shadow.mem1.2_1 main@%_1_0)
...
(assert (forall ((main@%_19_0 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%_16_0 (store main@%shadow.mem1.0_0 main@%_15_0 20))
                  ...
                  (= main@%shadow.mem1.1_0 main@%_16_0)
...
(assert (forall ((main@%_27_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%_28_0 (select main@%shadow.mem1.2_0 main@%_27_0))
