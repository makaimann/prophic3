(set-info :original "./flarge_enc/quic3/llvm/standard_vararg_true-unreach-call_ground_true-termination.bc")
...
(assert (forall ((main@%_11_0 Int)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%_16_0 (< main@%_15_0 main@%_8_0))
...
(assert (forall ((main@%_19_0 Int)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_0)
                  true
                  (= main@%_18_0 main@%.02.i_0)
                  (= main@%_19_0 (+ main@%_7_0 (* main@%_18_0 1)))
                  (or (<= main@%_7_0 0) (> main@%_19_0 0))
                  (> main@%_7_0 0)
                  (= main@%_20_0 (select main@%shadow.mem.1_0 main@%_19_0))
                  (= main@%_21_0 (> main@%_20_0 (- 1)))
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@_bb2_0 main@_bb1_0) (not main@%_21_0))
                  (= main@%.lcssa_1 main@%_18_0)
...
(assert (forall ((main@%_25_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb3_0) (not main@%_29_0))
