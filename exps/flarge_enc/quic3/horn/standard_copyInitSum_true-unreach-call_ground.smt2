(set-info :original "./flarge_enc/quic3/llvm/standard_copyInitSum_true-unreach-call_ground.bc")
...
(assert (forall ((main@%_23_0 Int)
  ...
  (=> (and (main 0
           ...
           (= main@%_23_0 main@%_9_1)
           (= main@%_24_1 (+ main@%_23_0 42))
...
(assert (forall ((main@%shadow.mem1.0_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge4_0 main@_bb_0) (not main@%_14_0))
...
(assert (forall ((main@%_16_0 Int)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_char_0)
                  true
                  (= main@%_16_0 (+ main@%_6_0 (* main@%.1.i1_0 1)))
                  (or (<= main@%_6_0 0) (> main@%_16_0 0))
                  (> main@%_6_0 0)
                  (= main@%_17_0 (select main@%_12_0 main@%_16_0))
                  (= main@%_18_0 (+ main@%_17_0 main@%_9_0))
                  (= main@%_19_0 (+ main@%_7_0 (* main@%.1.i1_0 1)))
                  (or (<= main@%_7_0 0) (> main@%_19_0 0))
                  (> main@%_7_0 0)
                  (= main@%_20_0
                     (store main@%shadow.mem1.0_0 main@%_19_0 main@%_18_0))
                  (= main@%_21_0 (+ main@%.1.i1_0 1))
                  (= main@%_22_0 (< main@%_21_0 main@%_3_0))
...
(assert (forall ((main@%_23_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%shadow.mem1.1_1 main@%_20_0)
                  (=> (and main@._crit_edge_0 main@._crit_edge.loopexit_0)
                      (= main@%shadow.mem1.1_2 main@%shadow.mem1.1_1))
                  (= main@%_23_0 main@%_9_0)
                  (= main@%_24_1 (+ main@%_23_0 42))
...
(assert (forall ((main@%_26_0 Bool)
  ...
  (let ((a!1 (and (main 3
                        ...
                        @nd_char_0)
                  true
                  (= main@%_26_0 (< main@%.0.i_0 main@%_3_0))
                  (= main@%_27_0 (and main@%assume.flag.0_0 main@%_26_0))
                  (= main@%_28_0 (+ main@%_7_0 (* main@%.0.i_0 1)))
                  (or (<= main@%_7_0 0) (> main@%_28_0 0))
                  (> main@%_7_0 0)
                  (= main@%_29_0 (select main@%shadow.mem1.1_0 main@%_28_0))
                  (= main@%_30_0 main@%_29_0)
                  (= main@%_31_0 (= main@%_24_0 main@%_30_0))
                  (= main@%_32_0 (+ main@%.0.i_0 1))
                  (=> main@_bb3_1 (and main@_bb3_1 main@_bb3_0))
                  (=> (and main@_bb3_1 main@_bb3_0) main@%_31_0)
...
(assert (forall ((main@%_26_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb3_0) (not main@%_31_0))
