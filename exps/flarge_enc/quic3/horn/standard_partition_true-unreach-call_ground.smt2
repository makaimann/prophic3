(set-info :original "./flarge_enc/quic3/llvm/standard_partition_true-unreach-call_ground.bc")
...
(assert (forall ((@nd_char_0 Int)
  ...
  (=> (and (main 0
           ...
           (=> (and main@_bb_0 main@.lr.ph_0) (= main@%.02.i2_2 main@%.02.i2_1))
...
(assert (forall ((main@%_20_0 Bool)
  ...
  (let ((a!1 (and (main 1
                  ...
                  (= main@%.15.i_0 main@%_17_0)
                  (= main@%shadow.mem.1_1 main@%shadow.mem.0_0)
                  (= main@%.15.i_1 main@%.04.i1_0)
