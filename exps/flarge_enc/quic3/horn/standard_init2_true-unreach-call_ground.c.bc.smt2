(set-info :original "./flarge_enc/llvm/standard_init2_true-unreach-call_ground.c.bc")
...
(assert (forall ((main@%_6_0 Int)
  ...
  (let ((a!1 (and (main 1
                        ...
                        @nd_0)
                  true
                  (= main@%_6_0 (+ main@%_4_0 (* main@%.01.i2_0 1)))
...
(assert (forall ((main@%shadow.mem.0.1_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge4_0 main@_bb_0) (not main@%_8_0))
...
(assert (forall ((main@%_14_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb4_0) (not main@%_18_0))
