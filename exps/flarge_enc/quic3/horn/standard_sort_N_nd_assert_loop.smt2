(set-info :original "./flarge_enc/quic3/llvm/standard_sort_N_nd_assert_loop.bc")
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@_bb1_1 main@_bb1_0) main@%_22_0)
...
(assert (forall ((main@%_12_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb1_0) (not main@%_22_0))
