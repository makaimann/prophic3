(set-info :original "./flarge_enc/llvm/standard_copyInitSum2_true-unreach-call_ground.c.bc")
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (=> (and (main 0
           ...
           (= main@%shadow.mem.1.1_1 main@%sm3_1)
...
(assert (forall ((main@%_13_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@_bb4_1 main@_bb4_0) main@%_19_0)
...
(assert (forall ((main@%_21_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb5_0) (not main@%_28_0))
