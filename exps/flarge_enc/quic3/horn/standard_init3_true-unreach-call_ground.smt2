(set-info :original "./flarge_enc/quic3/llvm/standard_init3_true-unreach-call_ground.bc")
...
(assert (forall ((main@%shadow.mem.0_2 (Array Int Int))
  ...
  (=> (and (main 0
           ...
           (=> (and main@.lr.ph7_0 main@entry_0) main@%_3_1)
...
(assert (forall ((main@%shadow.mem.1_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 1
                  ...
                  (=> (and main@._crit_edge8_0 main@_bb_0) (not main@%_10_0))
                  (=> main@.lr.ph4_0 (and main@.lr.ph4_0 main@._crit_edge8_0))
                  (=> (and main@.lr.ph4_0 main@._crit_edge8_0) main@%_3_0)
                  (=> main@_bb1_0 (and main@_bb1_0 main@.lr.ph4_0))
                  (= main@%shadow.mem.1_1 main@%_8_0)
                  (= main@%.1.i2_1 0)
                  (=> (and main@_bb1_0 main@.lr.ph4_0)
...
(assert (forall ((main@%shadow.mem.2_2 (Array Int Int))
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%_14_0 (+ main@%.1.i2_0 1))
                  (= main@%_15_0 (< main@%_14_0 main@%_2_0))
                  (=> main@._crit_edge5_0 (and main@._crit_edge5_0 main@_bb1_0))
                  (=> (and main@._crit_edge5_0 main@_bb1_0) (not main@%_15_0))
...
(assert (forall ((main@%assume.flag.0_2 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@._crit_edge_0 main@._crit_edge5_0)
                      (not main@%_3_0))
                  (= main@%shadow.mem.3_1 main@%_13_0)
                  (=> (and main@._crit_edge_0 main@._crit_edge5_0)
                      (= main@%shadow.mem.3_2 main@%shadow.mem.3_1))
                  (=> main@_bb3_0 (and main@_bb3_0 main@._crit_edge_0))
                  (= main@%assume.flag.0_1 main@%_4_0)
...
(assert (forall ((main@%_22_0 Bool)
  ...
  (let ((a!1 (and (main 4
                        ...
                        @nd_0)
                  true
                  (= main@%_22_0 (< main@%.0.i_0 main@%_2_0))
                  (= main@%_23_0 (and main@%assume.flag.0_0 main@%_22_0))
                  (= main@%_24_0 (+ main@%_5_0 (* main@%.0.i_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_24_0 0))
                  (> main@%_5_0 0)
                  (= main@%_25_0 (select main@%shadow.mem.3_0 main@%_24_0))
                  (= main@%_26_0 (= main@%_25_0 44))
