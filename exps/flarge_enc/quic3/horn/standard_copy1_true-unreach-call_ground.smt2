(set-info :original "./flarge_enc/quic3/llvm/standard_copy1_true-unreach-call_ground.bc")
...
(assert (forall ((main@%_18_0 Bool)
  ...
  (let ((a!1 (and (main 2
                        ...
                        @nd_0)
                  true
                  (= main@%_18_0 (< main@%.0.i_0 main@%_3_0))
                  ...
                  (= main@%_22_0 (+ main@%_7_0 (* main@%.0.i_0 1)))
...
(assert (forall ((main@%_18_0 Bool)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (=> (and main@verifier.error_0 main@_bb2_0) (not main@%_24_0))
