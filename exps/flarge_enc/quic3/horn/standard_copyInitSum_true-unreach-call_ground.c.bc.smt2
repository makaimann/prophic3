(set-info :original "./flarge_enc/llvm/standard_copyInitSum_true-unreach-call_ground.c.bc")
...
(assert (forall ((main@%_19_0 Int)
  ...
  (=> (and (main 0
           ...
           (= main@%_19_0 main@%_7_1)
           (= main@%_20_1 (+ main@%_19_0 42))
...
(assert (forall ((main@%_13_0 Int)
  ...
  (let ((a!1 (and (main 2
                  ...
                  (= main@%_16_0 (+ main@%_5_0 (* main@%.1.i1_0 1)))
                  (or (<= main@%_5_0 0) (> main@%_16_0 0))
                  (> main@%_5_0 0)
                  (= main@%sm1_0
                     (store main@%shadow.mem.1.0_0 main@%_16_0 main@%_15_0))
                  (= main@%_17_0 (+ main@%.1.i1_0 1))
                  (= main@%_18_0 (< main@%_17_0 main@%_1_0))
                  (=> main@_bb4_1 (and main@_bb4_1 main@_bb4_0))
                  (=> (and main@_bb4_1 main@_bb4_0) main@%_18_0)
...
(assert (forall ((main@%_22_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (= main@%_27_0 (= main@%_20_0 main@%_26_0))
...
(assert (forall ((main@%_22_0 Bool)
  ...
  (let ((a!1 (and (main 3
                  ...
                  (=> (and main@verifier.error_0 main@_bb5_0) (not main@%_27_0))
