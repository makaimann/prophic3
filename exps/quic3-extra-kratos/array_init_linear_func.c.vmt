...
(define-fun .def_125 () Bool (and .def_24 .def_31))
(define-fun .def_126 () Bool (and .def_33 .def_125))
...
(define-fun .def_129 () Bool (and .def_103 .def_126))
(define-fun .def_10 () Int (! |!{c}| :next |!{c}.next|))
(define-fun .def_77 () Bool (= .def_10 |!{c}.next|))
...
(define-fun .def_63 () Int (* 2 .def_12))
(define-fun .def_64 () Int (+ .def_10 .def_63))
(define-fun .def_118 () (Array Int Int) (store .def_14 .def_12 .def_64))
(define-fun .def_119 () Bool (= |!{a1.1}.next| .def_118))
(define-fun .def_85 () Int (* (- 1) |!{i}.next|))
...
(define-fun .def_66 () Int (* (- 1) .def_61))
(define-fun .def_67 () Int (+ .def_63 .def_66))
...
(define-fun .def_112 () Bool (or .def_58 .def_111))
(define-fun .def_117 () Bool (or .def_112 .def_116))
(define-fun .def_132 () Bool (! (or .def_117 .def_131) :trans true))
(define-fun .def_133 () Bool (! (not .def_114) :invar-property 0))
(assert true)
