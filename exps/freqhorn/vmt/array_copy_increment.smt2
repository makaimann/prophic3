...
(define-fun .def_54 () Bool (= .def_12 0))
(define-fun .def_52 () Bool (! (not .def_16) :invar-property 0))
(define-fun .def_55 () Bool (! (and .def_52 .def_54) :init true))
(define-fun .def_46 () Int (select .def_8 i1_0))
(define-fun .def_47 () Int (select .def_10 i1_0))
...
(define-fun .def_50 () Bool (and .loc.11 .def_49))
(define-fun .def_32 () Int (select .def_8 .def_12))
(define-fun .def_34 () Int (+ .def_32 1))
