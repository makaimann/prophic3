...
(define-fun .def_51 () Bool (! (and .def_48 .def_50) :init true))
...
(define-fun .def_33 () Bool (= .def_32 (- 2)))
(define-fun .def_24 () Int (+ .def_10 1))
(define-fun .def_25 () (Array Int Int) (store .def_8 .def_10 0))
(define-fun .def_26 () (Array Int Int) (store .def_25 .def_24 0))
