...
(define-fun .def_56 () Int (select .def_12 i1_0))
(define-fun .def_57 () Bool (<= i1_0 .def_56))
(define-fun .def_58 () Bool (not .def_57))
(define-fun .def_53 () Bool (<= .def_18 i1_0))
(define-fun .def_54 () Bool (not .def_53))
(define-fun .def_51 () Bool (<= 0 i1_0))
...
(define-fun .def_45 () Int (+ .def_18 1))
(define-fun .def_39 () Int (select .def_8 .def_14))
(define-fun .def_38 () Int (select .def_10 .def_14))
(define-fun .def_40 () Bool (= .def_38 .def_39))
(define-fun .def_46 () Int (ite .def_40 .def_45 .def_18))
(define-fun .def_47 () Bool (= .y.14 .def_46))
(define-fun .def_37 () (Array Int Int) (store .def_12 .def_18 .def_14))
(define-fun .def_41 () (Array Int Int) (ite .def_40 .def_37 .def_12))
(define-fun .def_42 () Bool (= .y.11 .def_41))
(define-fun .def_33 () Int (* (- 1) .y.12))
(define-fun .def_34 () Int (+ .def_14 .def_33))
