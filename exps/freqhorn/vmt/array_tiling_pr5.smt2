...
(define-fun .def_85 () Int (! i1_0 :next |.xtv.1|))
...
(define-fun .def_94 () Int (* (- 1) .def_85))
(define-fun .def_95 () Int (* 5 .def_12))
(define-fun .def_97 () Int (+ .def_95 .def_94))
(define-fun .def_98 () Bool (<= .def_97 0))
(define-fun .def_99 () Bool (not .def_98))
(define-fun .def_29 () Bool (<= .def_10 .def_12))
(define-fun .def_92 () Bool (not .def_29))
(define-fun .def_91 () Bool (<= 0 .def_85))
(define-fun .def_93 () Bool (and .def_91 .def_92))
(define-fun .def_100 () Bool (and .def_93 .def_99))
(define-fun .def_86 () Int (select .def_8 .def_85))
(define-fun .def_89 () Bool (<= .def_24 .def_86))
