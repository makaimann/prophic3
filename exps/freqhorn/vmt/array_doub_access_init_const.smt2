...
(define-fun .def_24 () Int (* 2 .def_10))
(define-fun .def_27 () Int (+ .def_24 1))
(define-fun .def_26 () (Array Int Int) (store .def_8 .def_24 0))
(define-fun .def_28 () (Array Int Int) (store .def_26 .def_27 0))
...
(define-fun .def_30 () Bool (and .def_20 .def_29))
