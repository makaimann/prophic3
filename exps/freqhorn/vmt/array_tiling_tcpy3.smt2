...
(define-fun .def_58 () Int (! i1_0 :next |.xtv.1|))
...
(define-fun .def_68 () Int (select .def_10 .def_58))
(define-fun .def_67 () Int (select .def_8 .def_58))
(define-fun .def_69 () Bool (= .def_67 .def_68))
(define-fun .def_70 () Bool (not .def_69))
(define-fun .def_62 () Int (* (- 1) .def_58))
...
(define-fun .def_60 () Bool (<= 0 .def_58))
