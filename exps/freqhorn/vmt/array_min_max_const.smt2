...
(define-fun .def_63 () Bool (= .def_16 100000))
...
(define-fun .def_65 () Bool (! (and .def_55 .def_64) :init true))
...
(define-fun .def_38 () Int (* (- 1) .y.9))
(define-fun .def_39 () Int (+ .def_10 .def_38))
(define-fun .def_40 () Bool (= .def_39 (- 1)))
(define-fun .def_28 () Int (select .def_8 .def_10))
(define-fun .def_33 () Bool (<= .def_12 .def_28))
(define-fun .def_34 () Int (ite .def_33 .def_28 .def_12))
(define-fun .def_35 () Bool (= .y.10 .def_34))
(define-fun .def_29 () Bool (<= .def_14 .def_28))
(define-fun .def_30 () Int (ite .def_29 .def_14 .def_28))
(define-fun .def_31 () Bool (= .y.11 .def_30))
