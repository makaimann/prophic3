...
(assert (forall ((|a_1| (Array Int Int)) (|i_0| Int) (|N_1| Int) (|.loc.5| Bool) (|i1_0| Int) (|.loc.9| Bool) (|.y.6| (Array Int Int)) (|.y.7| Int) (|.y.8| Int) (|.xtv.1| Int)) (=> (and (state |a_1| |i_0| |N_1| |.loc.5| |i1_0|) (let ((.def_26 (<= N_1 i_0))) (and (not .loc.5) (or (and (and (not (= (select a_1 i1_0) 0)) (and (not (<= N_1 i1_0)) (and (not (<= i1_0 0)) .def_26))) .loc.9) (and (= (store (store a_1 i_0 0) (+ i_0 1) 0) .y.6) (and (= (+ i_0 (* (- 1) .y.7)) (- 2)) (and (= N_1 .y.8) (and (not .def_26) (not .loc.9))))))))) (state |.y.6| |.y.7| |.y.8| |.loc.9| |.xtv.1|))))
