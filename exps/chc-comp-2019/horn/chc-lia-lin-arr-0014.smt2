;; Original file: arrqua_167.smt2
(set-logic HORN)
(declare-fun inv ((Array Int Int) (Array Int Int) Int Int) Bool)

(assert (forall ((S Int) (i Int) (a (Array Int Int)) (acopy (Array Int Int)))
...
(assert (forall ((a (Array Int Int)) (acopy (Array Int Int)) (i Int) (S Int) (i1 Int))
