...
(define-fun .def_520 () Bool (= .def_10 .def_12))
(define-fun .def_519 () Bool (= .def_22 .def_24))
(define-fun .def_521 () Bool (and .def_519 .def_520))
(define-fun .def_518 () Bool (= .def_18 .def_20))
(define-fun .def_522 () Bool (and .def_518 .def_521))
(define-fun .def_517 () Bool (= .def_26 .def_28))
(define-fun .def_523 () Bool (and .def_517 .def_522))
(define-fun .def_516 () Bool (= .def_14 .def_16))
(define-fun .def_524 () Bool (and .def_516 .def_523))
(define-fun .def_515 () Bool (not .def_58))
...
(define-fun .def_471 () Bool (and hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_144))
...
(define-fun .def_465 () (Array Int Int) (store .def_10 .def_40 0))
(define-fun .def_466 () (Array Int Int) (store .def_465 .def_50 0))
(define-fun .def_467 () Bool (= .x.407 .def_466))
(define-fun .def_464 () Bool (= .x.424 0))
(define-fun .def_468 () Bool (and .def_464 .def_467))
(define-fun .def_469 () Bool (or .def_58 .def_468))
(define-fun .def_460 () Bool (= .x.421 .x.424))
(define-fun .def_461 () Bool (or hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_460))
...
(define-fun .def_288 () Int (* 4 .def_42))
(define-fun .def_289 () Int (+ .def_32 .def_288))
(define-fun .def_290 () (Array Int Int) (select .def_14 .def_40))
(define-fun .def_438 () Int (select .def_290 .def_289))
(define-fun .def_439 () Bool (= .x.425 .def_438))
(define-fun .def_434 () Int (+ .def_288 .def_54))
(define-fun .def_180 () (Array Int Int) (select .def_14 .def_50))
(define-fun .def_435 () Int (select .def_180 .def_434))
(define-fun .def_436 () Bool (= .x.430 .def_435))
(define-fun .def_429 () Bool (= .x.425 .x.430))
(define-fun .def_430 () Int (ite .def_429 1 0))
(define-fun .def_431 () Bool (= .x.428 .def_430))
(define-fun .def_427 () Bool (= .x.419 .x.428))
...
(define-fun .def_294 () Int (* (- 1) .x.423))
(define-fun .def_295 () Int (+ .def_42 .def_294))
...
(define-fun .def_409 () Bool (and .def_189 .def_296))
...
(define-fun .def_394 () Bool (and .def_114 .def_123))
...
(define-fun .def_287 () Int (select .def_180 .def_181))
(define-fun .def_291 () (Array Int Int) (store .def_290 .def_289 .def_287))
(define-fun .def_292 () (Array Int (Array Int Int)) (store .def_14 .def_40 .def_291))
(define-fun .def_293 () Bool (= .x.409 .def_292))
(define-fun .def_297 () Bool (and .def_293 .def_296))
(define-fun .def_298 () Bool (and .def_193 .def_297))
...
(define-fun .def_270 () Bool (or .def_58 .def_114))
