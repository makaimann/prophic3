...
(define-fun .def_12 () Int (! |.x{7}| :next |.x{14}|))
(define-fun .def_64 () Bool (= .def_12 0))
(define-fun .def_14 () Int (! |.x{8}| :next |.x{16}|))
(define-fun .def_62 () Bool (<= 1 .def_14))
(define-fun .def_65 () Bool (! (and .def_62 .def_64) :init true))
(define-fun .def_59 () Bool (= .def_14 |.x{16}|))
(define-fun .def_8 () (Array Int Int) (! |.x{5}| :next |.x{15}|))
(define-fun .def_57 () Bool (= .def_8 |.x{15}|))
(define-fun .def_53 () Int (* (- 1) |.x{14}|))
...
(define-fun .def_10 () (Array Int Int) (! |.x{6}| :next |.x{13}|))
...
(define-fun .def_49 () Bool (= |.x{13}| .def_48))
...
(define-fun .def_66 () Int (! |.x{21}| :next |.xpv{1}|))
(define-fun .def_75 () Bool (<= 0 .def_66))
(define-fun .def_76 () Bool (and .def_50 .def_75))
(define-fun .def_71 () Int (* (- 1) .def_66))
(define-fun .def_72 () Int (+ .def_39 .def_71))
