...
(define-fun .def_62 () Bool (= c .def_61))
(define-fun .def_53 () Int (* (- 1) .x.5))
(define-fun .def_54 () Int (+ .def_18 .def_53))
(define-fun .def_55 () Bool (= .def_54 (- 1)))
(define-fun .def_48 () Bool (= .def_20 .x.6))
...
(define-fun .def_88 () Bool (<= .def_82 0))
