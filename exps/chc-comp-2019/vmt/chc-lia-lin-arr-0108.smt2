...
(define-fun .def_324 () Bool (= .def_10 .def_12))
(define-fun .def_323 () Bool (= .def_22 .def_24))
...
(define-fun .def_320 () Bool (= .def_14 .def_16))
(define-fun .def_328 () Bool (and .def_320 .def_327))
(define-fun .def_319 () Bool (not .def_58))
...
(define-fun .def_145 () Bool (= .x.224 .x.232))
(define-fun .def_150 () Bool (and .def_145 .def_149))
(define-fun .def_142 () Bool (= .x.230 .x.234))
(define-fun .def_143 () Int (ite .def_142 1 0))
(define-fun .def_144 () Bool (= .x.232 .def_143))
...
(define-fun .def_285 () Bool (and hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_153))
...
(define-fun .def_275 () Bool (or hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_274))
...
(define-fun .def_235 () Int (+ .def_228 .def_54))
(define-fun .def_236 () Int (select .def_147 .def_235))
(define-fun .def_237 () Bool (= .x.223 .def_236))
(define-fun .def_229 () Int (+ .def_30 .def_228))
(define-fun .def_230 () (Array Int Int) (store .def_139 .def_229 .x.223))
(define-fun .def_231 () (Array Int (Array Int Int)) (store .def_14 .def_44 .def_230))
(define-fun .def_232 () Bool (= .x.213 .def_231))
...
(define-fun .def_222 () Bool (or hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_221))
...
(define-fun .def_199 () Bool (or hhv_ULTIMATE.start_ULTIMATE.startEXIT_25_Bool .def_198))
