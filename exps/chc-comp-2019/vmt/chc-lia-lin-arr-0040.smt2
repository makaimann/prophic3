...
(define-fun .def_33 () Int (! j_2 :next |.xtv.1|))
(define-fun .def_106 () Int (! i1_3 :next |.xpv.1|))
(define-fun .def_29 () Bool (not .def_16))
(define-fun .def_18 () Bool (not .def_14))
(define-fun .def_104 () Bool (and .def_18 .def_29))
(define-fun .def_103 () Bool (= .def_10 0))
(define-fun .def_105 () Bool (! (and .def_103 .def_104) :init true))
(define-fun .def_101 () Bool (= .def_12 .x.13))
(define-fun .def_79 () Bool (= .x.12 0))
(define-fun .def_55 () Bool (= .def_8 .x.11))
(define-fun .def_19 () Bool (<= .def_12 .def_10))
(define-fun .def_56 () Bool (and .def_19 .def_55))
(define-fun .def_91 () Bool (and .def_56 .def_79))
(define-fun .def_92 () Bool (and .def_18 .def_91))
...
(define-fun .def_49 () Int (select .def_8 .def_10))
(define-fun .def_69 () Int (* (- 1) .def_33))
(define-fun .def_71 () Int (+ .def_69 .def_49))
(define-fun .def_72 () (Array Int Int) (store .def_8 .def_10 .def_71))
(define-fun .def_73 () Bool (= .x.11 .def_72))
...
(define-fun .def_96 () Bool (or .def_78 .def_95))
(define-fun .def_97 () Bool (and .loc.6 .def_96))
(define-fun .def_62 () Int (* (- 1) .def_12))
(define-fun .def_63 () Int (+ .x.12 .def_62))
...
(define-fun .def_98 () Bool (or .def_65 .def_97))
(define-fun .def_50 () Int (+ .def_33 .def_49))
(define-fun .def_51 () (Array Int Int) (store .def_8 .def_10 .def_50))
(define-fun .def_52 () Bool (= .x.11 .def_51))
...
(define-fun .def_99 () Bool (or .def_54 .def_98))
...
(define-fun .def_100 () Bool (or .def_39 .def_99))
(define-fun .def_102 () Bool (! (and .def_100 .def_101) :trans true))
(define-fun .def_116 () Bool (and .def_14 .def_16))
(define-fun .def_112 () Bool (<= .def_106 0))
(define-fun .def_113 () Bool (not .def_112))
(define-fun .def_109 () Int (select .def_8 .def_106))
(define-fun .def_110 () Bool (<= 0 .def_109))
(define-fun .def_107 () Bool (<= .def_12 .def_106))
...
(define-fun .def_119 () Bool (! (not .def_117) :invar-property 0))
(assert true)
