...
(declare-fun hbv_ULTIMATE.start_L43_16_Int () Int)
...
(define-fun .def_75 () Int (! hbv_ULTIMATE.start_L43_16_Int :next |.xtv.2|))
...
(define-fun .def_110 () (Array Int Int) (store .def_22 .x.76 4))
(define-fun .def_111 () Bool (= .x.70 .def_110))
(define-fun .def_107 () Bool (= .x.75 .x.80))
(define-fun .def_105 () Bool (= .x.75 0))
(define-fun .def_102 () Bool (<= .x.63 .x.76))
(define-fun .def_103 () Bool (not .def_102))
(define-fun .def_100 () Bool (= .x.76 .x.78))
(define-fun .def_97 () (Array Int Int) (store .def_56 .x.76 1))
(define-fun .def_98 () Bool (= .x.64 .def_97))
(define-fun .def_94 () Bool (= .x.76 0))
(define-fun .def_95 () Bool (not .def_94))
(define-fun .def_90 () (Array Int Int) (select .x.66 .x.76))
(define-fun .def_91 () Int (select .def_90 .x.75))
(define-fun .def_92 () Bool (= .def_75 .def_91))
...
(define-fun .def_81 () (Array Int Int) (store .def_80 .x.75 1))
...
(define-fun .def_61 () Bool (= .def_30 .x.74))
...
(define-fun .def_115 () Bool (= .x.74 .x.77))
