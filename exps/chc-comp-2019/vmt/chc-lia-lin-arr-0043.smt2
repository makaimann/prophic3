...
(define-fun .def_14 () Int (! |.x{12}| :next |.x{23}|))
(define-fun .def_81 () Bool (= .def_14 1))
(define-fun .def_12 () Int (! |.x{11}| :next |.x{22}|))
(define-fun .def_79 () Bool (<= .def_12 0))
(define-fun .def_80 () Bool (not .def_79))
(define-fun .def_82 () Bool (and .def_80 .def_81))
(define-fun .def_16 () Int (! |.x{13}| :next |.x{24}|))
(define-fun .def_78 () Bool (= .def_16 3))
(define-fun .def_83 () Bool (and .def_78 .def_82))
(define-fun .def_18 () Int (! |.x{14}| :next |.x{25}|))
(define-fun .def_76 () Bool (= .def_18 7))
(define-fun .def_84 () Bool (and .def_76 .def_83))
(define-fun .def_20 () Int (! |.x{15}| :next |.x{26}|))
(define-fun .def_74 () Bool (= .def_20 5))
(define-fun .def_85 () Bool (and .def_74 .def_84))
(define-fun .def_10 () Int (! |.x{10}| :next |.x{17}|))
(define-fun .def_72 () Bool (= .def_10 1))
(define-fun .def_86 () Bool (! (and .def_72 .def_85) :init true))
(define-fun .def_22 () Int (! |.x{16}| :next |.x{27}|))
(define-fun .def_69 () Bool (= .def_22 |.x{27}|))
(define-fun .def_67 () Bool (= .def_20 |.x{26}|))
(define-fun .def_65 () Bool (= .def_18 |.x{25}|))
(define-fun .def_63 () Bool (= .def_16 |.x{24}|))
(define-fun .def_61 () Bool (= .def_14 |.x{23}|))
(define-fun .def_59 () Bool (= .def_12 |.x{22}|))
(define-fun .def_56 () Bool (<= .def_10 .def_12))
(define-fun .def_53 () Int (* (- 1) |.x{17}|))
...
(define-fun .def_8 () (Array Int Int) (! |.x{9}| :next |.x{21}|))
...
(define-fun .def_87 () Int (! |.x{36}| :next |.xpv{1}|))
(define-fun .def_98 () Int (select .def_8 .def_87))
(define-fun .def_102 () Bool (<= .def_22 .def_98))
...
(define-fun .def_94 () Bool (<= 0 .def_87))
