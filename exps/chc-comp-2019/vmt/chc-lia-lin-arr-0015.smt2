...
(define-fun .def_14 () Int (! N_0 :next |.y.9|))
...
(define-fun .def_79 () Bool (! (and .def_24 .def_78) :init true))
(define-fun .def_70 () Bool (= .def_8 .x.4))
(define-fun .def_69 () Bool (= .def_10 .x.5))
(define-fun .def_71 () Bool (and .def_69 .def_70))
(define-fun .def_72 () Bool (and .loc.10 .def_71))
(define-fun .def_65 () Bool (= .def_14 .x.7))
(define-fun .def_63 () Bool (= .x.6 0))
...
(define-fun .def_43 () Bool (= .x.4 .def_42))
(define-fun .def_38 () (Array Int Int) (store .def_10 .def_12 2))
(define-fun .def_39 () Bool (= .x.5 .def_38))
