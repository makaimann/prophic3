...
(define-fun .def_12 () Int (! |!{min}| :next |!{min}.next|))
(define-fun .def_78 () Bool (= .def_12 |!{min}.next|))
...
(define-fun .def_154 () Bool (<= .def_12 nd_char<0>))
(define-fun .def_135 () Bool (= .def_12 |%{min}#2|))
(define-fun .def_157 () Bool (and .def_135 .def_154))
(define-fun .def_155 () Bool (not .def_154))
(define-fun .def_153 () Bool (= nd_char<0> |%{min}#2|))
...
(define-fun .def_146 () Bool (= |!{min}.next| |%{min}#2|))
...
(define-fun .def_68 () Bool (<= .def_12 .def_67))
...
(define-fun .def_52 () Bool (= |!{min}.next| 0))
