...
(define-fun .def_161 () Bool (and .def_32 .def_39))
(define-fun .def_182 () Bool (and .def_41 .def_161))
(define-fun .def_67 () Bool (not |!pc[1].next|))
(define-fun .def_68 () Bool (and |!pc[0].next| .def_67))
(define-fun .def_163 () Bool (and |!pc[2].next| .def_68))
(define-fun .def_185 () Bool (and .def_163 .def_182))
(define-fun .def_10 () Int (! |!{N}| :next |!{N}.next|))
(define-fun .def_90 () Bool (= .def_10 |!{N}.next|))
(define-fun .def_8 () (Array Int Int) (! |!{b.2}| :next |!{b.2}.next|))
(define-fun .def_88 () Bool (= .def_8 |!{b.2}.next|))
(define-fun .def_101 () Bool (and .def_88 .def_90))
(define-fun .def_58 () Bool (= |!{i}.next| 0))
(define-fun .def_177 () Bool (and .def_58 .def_101))
(define-fun .def_14 () Int (! |!{incr}| :next |!{incr}.next|))
(define-fun .def_94 () Bool (= .def_14 |!{incr}.next|))
(define-fun .def_178 () Bool (and .def_94 .def_177))
(define-fun .def_16 () Int (! |!{x}| :next |!{x}.next|))
(define-fun .def_96 () Bool (= .def_16 |!{x}.next|))
(define-fun .def_179 () Bool (and .def_96 .def_178))
(define-fun .def_18 () (Array Int Int) (! |!{a.1}| :next |!{a.1}.next|))
(define-fun .def_98 () Bool (= .def_18 |!{a.1}.next|))
...
(define-fun .def_170 () (Array Int Int) (store .def_18 .def_12 42))
(define-fun .def_174 () Bool (= |!{a.1}.next| .def_170))
(define-fun .def_149 () Int (* (- 1) |!{i}.next|))
(define-fun .def_150 () Int (+ .def_12 .def_149))
(define-fun .def_151 () Bool (= .def_150 (- 1)))
(define-fun .def_171 () Bool (and .def_101 .def_151))
(define-fun .def_172 () Bool (and .def_94 .def_171))
(define-fun .def_173 () Bool (and .def_96 .def_172))
...
(define-fun .def_166 () Bool (and .def_125 .def_162))
...
(define-fun .def_143 () Int (select .def_18 .def_12))
(define-fun .def_144 () Int (+ .def_14 .def_143))
(define-fun .def_145 () (Array Int Int) (store .def_8 .def_12 .def_144))
...
(define-fun .def_153 () Bool (and .def_94 .def_152))
...
(define-fun .def_135 () Bool (and .def_32 .def_34))
(define-fun .def_136 () Bool (and .def_41 .def_135))
...
(define-fun .def_129 () Bool (and .def_67 .def_123))
(define-fun .def_130 () Bool (and |!pc[2].next| .def_129))
(define-fun .def_117 () Bool (and .def_34 .def_38))
(define-fun .def_118 () Bool (and .def_41 .def_117))
(define-fun .def_131 () Bool (and .def_118 .def_130))
(define-fun .def_73 () Bool (<= .def_10 .def_16))
(define-fun .def_111 () Bool (and .def_73 .def_88))
...
(define-fun .def_75 () Int (select .def_8 .def_16))
(define-fun .def_80 () Int (* (- 1) .def_75))
(define-fun .def_81 () Int (+ .def_14 .def_80))
(define-fun .def_82 () Bool (= .def_81 (- 42)))
...
(define-fun .def_100 () Bool (and .def_74 .def_99))
...
(define-fun .def_64 () Bool (= |!{a.1}.next| |%{a.1}#1|))
(define-fun .def_62 () Bool (= |!{x}.next| |%{x}#1|))
(define-fun .def_60 () Bool (= |!{incr}.next| nd_char<0>))
(define-fun .def_56 () Bool (= |!{N}.next| nd<0>))
(define-fun .def_55 () Bool (= |!{b.2}.next| |%{b.2}#1|))
...
(define-fun .def_52 () Bool (<= nd<0> 0))
(define-fun .def_53 () Bool (not .def_52))
(define-fun .def_66 () Bool (and .def_53 .def_65))
(define-fun .def_72 () Bool (and .def_66 .def_71))
(define-fun .def_134 () Bool (or .def_72 .def_133))
(define-fun .def_139 () Bool (or .def_134 .def_138))
(define-fun .def_169 () Bool (or .def_139 .def_168))
(define-fun .def_188 () Bool (! (or .def_169 .def_187) :trans true))
