...
(define-fun .def_10614 () Int (! proph0 :next |proph0.next|))
...
(define-fun .def_13843 () Int (select |!{array.1}.next| proph0.next))
(define-fun .def_13842 () Int (select .def_27 proph0.next))
(define-fun .def_13844 () Bool (= .def_13842 .def_13843))
(define-fun .def_39 () Bool (= .def_27 |!{array.1}.next|))
(define-fun .def_4465 () Bool (not .def_39))
(define-fun .def_13845 () Bool (or .def_4465 .def_13844))
(define-fun .def_13838 () Int (select .def_27 |!{x}.next|))
(define-fun .def_13837 () Int (select |!{array.1}.next| |!{x}.next|))
(define-fun .def_13839 () Bool (= .def_13837 .def_13838))
(define-fun .def_13840 () Bool (or .def_4465 .def_13839))
(define-fun .def_13833 () Int (select .def_27 |!{i}.next|))
(define-fun .def_13832 () Int (select |!{array.1}.next| |!{i}.next|))
(define-fun .def_13834 () Bool (= .def_13832 .def_13833))
(define-fun .def_13835 () Bool (or .def_4465 .def_13834))
(define-fun .def_10617 () Bool (= .def_10614 proph0.next))
(define-fun .def_4466 () Int (select |!{array.1}.next| 0))
(define-fun .def_29 () Int (select .def_27 0))
(define-fun .def_4467 () Bool (= .def_29 .def_4466))
...
(define-fun .def_645 () Bool (and .def_164 .def_303))
(define-fun .def_165 () Bool (not .def_104))
(define-fun .def_646 () Bool (and .def_165 .def_645))
(define-fun .def_4469 () Bool (and .def_646 .def_4468))
(define-fun .def_13831 () Bool (and .def_4469 .def_10617))
(define-fun .def_13836 () Bool (and .def_13831 .def_13835))
(define-fun .def_13841 () Bool (and .def_13836 .def_13840))
(define-fun .def_13846 () Bool (! (and .def_13841 .def_13845) :trans true))
(define-fun .def_10615 () Bool (= .def_43 .def_10614))
(define-fun .def_10619 () Bool (not .def_10615))
(define-fun .def_10620 () Bool (! (or .def_165 .def_10619) :invar-property 0))
(assert true)
