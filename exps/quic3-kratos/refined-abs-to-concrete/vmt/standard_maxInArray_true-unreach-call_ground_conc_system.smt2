...
(define-fun .def_5271 () Int (! proph0 :next |proph0.next|))
...
(define-fun .def_8097 () Int (select .def_43 .def_5271))
(define-fun .def_8075 () Int (select |!{a.1}.next| .def_5271))
(define-fun .def_8102 () Bool (= .def_8075 .def_8097))
(define-fun .def_45 () Bool (= .def_43 |!{a.1}.next|))
(define-fun .def_8085 () Bool (not .def_45))
(define-fun .def_8103 () Bool (or .def_8085 .def_8102))
(define-fun .def_63 () (Array Int Int) (store .def_43 .def_31 nd_char<0>))
(define-fun .def_8074 () Int (select .def_63 .def_5271))
(define-fun .def_8098 () Bool (= .def_8074 .def_8097))
(define-fun .def_5375 () Bool (= .def_31 .def_5271))
(define-fun .def_8099 () Bool (or .def_5375 .def_8098))
(define-fun .def_8091 () Int (select |!{a.1}.next| .def_31))
(define-fun .def_8081 () Int (select .def_63 .def_31))
(define-fun .def_8092 () Bool (= .def_8081 .def_8091))
(define-fun .def_64 () Bool (= |!{a.1}.next| .def_63))
(define-fun .def_8077 () Bool (not .def_64))
(define-fun .def_8093 () Bool (or .def_8077 .def_8092))
(define-fun .def_8087 () Int (select .def_43 |!{x}.next|))
(define-fun .def_8086 () Int (select |!{a.1}.next| |!{x}.next|))
(define-fun .def_8088 () Bool (= .def_8086 .def_8087))
(define-fun .def_8089 () Bool (or .def_8085 .def_8088))
(define-fun .def_8082 () Bool (= nd_char<0> .def_8081))
...
(define-fun .def_8083 () Bool (and .def_528 .def_8082))
(define-fun .def_8069 () (Array Int Int) (store |!{a.1}.next| |!{i}.next| nd_char<0>))
(define-fun .def_8079 () Int (select .def_8069 |!{i}.next|))
(define-fun .def_8080 () Bool (= nd_char<0> .def_8079))
(define-fun .def_8084 () Bool (and .def_8080 .def_8083))
(define-fun .def_8090 () Bool (and .def_8084 .def_8089))
(define-fun .def_8094 () Bool (and .def_8090 .def_8093))
(define-fun .def_5274 () Bool (= .def_5271 proph0.next))
(define-fun .def_8095 () Bool (and .def_5274 .def_8094))
(define-fun .def_8076 () Bool (= .def_8074 .def_8075))
(define-fun .def_8078 () Bool (or .def_8076 .def_8077))
(define-fun .def_8096 () Bool (and .def_8078 .def_8095))
(define-fun .def_8100 () Bool (and .def_8096 .def_8099))
(define-fun .def_8071 () Int (select |!{a.1}.next| proph0.next))
(define-fun .def_8070 () Int (select .def_8069 proph0.next))
(define-fun .def_8072 () Bool (= .def_8070 .def_8071))
(define-fun .def_6162 () Bool (= |!{i}.next| proph0.next))
(define-fun .def_8073 () Bool (or .def_6162 .def_8072))
(define-fun .def_8101 () Bool (and .def_8073 .def_8100))
(define-fun .def_8104 () Bool (! (and .def_8101 .def_8103) :trans true))
(define-fun .def_5272 () Bool (= .def_73 .def_5271))
(define-fun .def_5276 () Bool (not .def_5272))
(define-fun .def_5277 () Bool (! (or .def_145 .def_5276) :invar-property 0))
(assert true)
