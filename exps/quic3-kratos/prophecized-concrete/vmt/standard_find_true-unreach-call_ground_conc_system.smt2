...
(define-fun .def_9873 () Int (! proph0 :next |proph0.next|))
...
(define-fun .def_9876 () Bool (= .def_9873 proph0.next))
...
(define-fun .def_9878 () Bool (! (and .def_164 .def_9876) :trans true))
(define-fun .def_9874 () Bool (= .def_46 .def_9873))
(define-fun .def_9879 () Bool (not .def_9874))
(define-fun .def_165 () Bool (not .def_101))
(define-fun .def_9880 () Bool (! (or .def_165 .def_9879) :invar-property 0))
(assert true)
