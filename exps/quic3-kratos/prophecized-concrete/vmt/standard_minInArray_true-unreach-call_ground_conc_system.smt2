...
(define-fun .def_5239 () Int (! proph0 :next |proph0.next|))
...
(define-fun .def_5242 () Bool (= .def_5239 proph0.next))
...
(define-fun .def_5244 () Bool (! (and .def_144 .def_5242) :trans true))
(define-fun .def_5240 () Bool (= .def_73 .def_5239))
(define-fun .def_5245 () Bool (not .def_5240))
(define-fun .def_145 () Bool (not .def_83))
(define-fun .def_5246 () Bool (! (or .def_145 .def_5245) :invar-property 0))
(assert true)
