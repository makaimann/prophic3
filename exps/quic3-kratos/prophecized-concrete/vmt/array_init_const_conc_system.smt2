...
(define-fun .def_4794 () Int (! proph0 :next |proph0.next|))
...
(define-fun .def_4797 () Bool (= .def_4794 proph0.next))
...
(define-fun .def_4799 () Bool (! (and .def_116 .def_4797) :trans true))
(define-fun .def_4795 () Bool (= .def_43 .def_4794))
(define-fun .def_4800 () Bool (not .def_4795))
(define-fun .def_117 () Bool (not .def_67))
(define-fun .def_4801 () Bool (! (or .def_117 .def_4800) :invar-property 0))
(assert true)
