...
(let ((.def_38 (not |!pc[3]|)))
(let ((.def_246 (and .def_38 .def_206)))
...
(let ((.def_249 (and .def_234 .def_246)))
(let ((.def_75 (= |!{N}| |!{N}.next|)))
(let ((.def_50 (= |!{i}.next| 0)))
...
(let ((.def_250 (and .def_161 .def_249)))
...
(let ((.def_247 (and .def_62 .def_246)))
(let ((.def_242 (store |!{a.1}| |!{i}| 42)))
