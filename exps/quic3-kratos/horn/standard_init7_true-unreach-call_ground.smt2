...
(let ((.def_38 (not |!pc[3]|)))
(let ((.def_233 (and .def_38 .def_206)))
...
(let ((.def_236 (and .def_221 .def_233)))
(let ((.def_75 (= |!{N}| |!{N}.next|)))
(let ((.def_50 (= |!{i}.next| 0)))
