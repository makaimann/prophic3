...
(assert (forall ((|!{N}| Int) (|!{i}| Int) (|!{max}| Int) (|!{x}| Int) (|!{a.1}| (Array Int Int)) (|!pc[0]| Bool) (|!pc[1]| Bool) (|!pc[2]| Bool))
  (=>
   (let ((.def_37 (not |!pc[2]|)))
(let ((.def_35 (not |!pc[1]|)))
(let ((.def_34 (not |!pc[0]|)))
...
.def_38)))))
   (state |!{N}| |!{i}| |!{max}| |!{x}| |!{a.1}| |!pc[0]| |!pc[1]| |!pc[2]|))))

(assert (forall ((|!{N}| Int) (|!{i}| Int) (|!{max}| Int) (|!{x}| Int) (|!{a.1}| (Array Int Int)) (|!pc[0]| Bool) (|!pc[1]| Bool) (|!pc[2]| Bool)
                 (|!{N}.next| Int) (|!{i}.next| Int) (|!{max}.next| Int) (|!{x}.next| Int) (|!{a.1}.next| (Array Int Int)) (|!pc[0].next| Bool) (|!pc[1].next| Bool) (|!pc[2].next| Bool)
                 (|%{x}#1| Int) (|%{a.1}#1| (Array Int Int)) (nd<0> Int) (nd_char<0> Int) (|%{max}#2| Int))
  (=>
   (and (state |!{N}| |!{i}| |!{max}| |!{x}| |!{a.1}| |!pc[0]| |!pc[1]| |!pc[2]|)
(let ((.def_35 (not |!pc[1]|)))
...
(let ((.def_154 (<= nd_char<0> |!{max}|)))
(let ((.def_135 (= |!{max}| |%{max}#2|)))
(let ((.def_157 (and .def_135 .def_154)))
(let ((.def_155 (not .def_154)))
(let ((.def_153 (= nd_char<0> |%{max}#2|)))
...
.def_172)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
   ) (state |!{N}.next| |!{i}.next| |!{max}.next| |!{x}.next| |!{a.1}.next| |!pc[0].next| |!pc[1].next| |!pc[2].next|))))
