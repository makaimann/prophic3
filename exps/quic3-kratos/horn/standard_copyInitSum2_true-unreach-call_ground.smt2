...
(declare-fun state ((Array Int Int) (Array Int Int) Int Int Int Int Bool Bool Bool) Bool)


(assert (forall ((|!{a.1}| (Array Int Int)) (|!{b.2}| (Array Int Int)) (|!{N}| Int) (|!{i}| Int) (|!{init}| Int) (|!{x}| Int) (|!pc[0]| Bool) (|!pc[1]| Bool) (|!pc[2]| Bool))
  (=>
   (let ((.def_42 (not |!pc[2]|)))
(let ((.def_40 (not |!pc[1]|)))
(let ((.def_39 (not |!pc[0]|)))
...
.def_43)))))
   (state |!{a.1}| |!{b.2}| |!{N}| |!{i}| |!{init}| |!{x}| |!pc[0]| |!pc[1]| |!pc[2]|))))

(assert (forall ((|!{a.1}| (Array Int Int)) (|!{b.2}| (Array Int Int)) (|!{N}| Int) (|!{i}| Int) (|!{init}| Int) (|!{x}| Int) (|!pc[0]| Bool) (|!pc[1]| Bool) (|!pc[2]| Bool)
                 (|!{a.1}.next| (Array Int Int)) (|!{b.2}.next| (Array Int Int)) (|!{N}.next| Int) (|!{i}.next| Int) (|!{init}.next| Int) (|!{x}.next| Int) (|!pc[0].next| Bool) (|!pc[1].next| Bool) (|!pc[2].next| Bool)
                 (|%{x}#1| Int) (|%{a.1}#1| (Array Int Int)) (|%{b.2}#1| (Array Int Int)) (nd_char<0> Int))
  (=>
   (and (state |!{a.1}| |!{b.2}| |!{N}| |!{i}| |!{init}| |!{x}| |!pc[0]| |!pc[1]| |!pc[2]|)
(let ((.def_40 (not |!pc[1]|)))
(let ((.def_160 (and |!pc[0]| .def_40)))
(let ((.def_42 (not |!pc[2]|)))
(let ((.def_181 (and .def_42 .def_160)))
(let ((.def_68 (not |!pc[1].next|)))
(let ((.def_69 (and |!pc[0].next| .def_68)))
(let ((.def_162 (and |!pc[2].next| .def_69)))
(let ((.def_184 (and .def_162 .def_181)))
(let ((.def_90 (= |!{b.2}| |!{b.2}.next|)))
(let ((.def_88 (= |!{a.1}| |!{a.1}.next|)))
(let ((.def_101 (and .def_88 .def_90)))
(let ((.def_92 (= |!{N}| |!{N}.next|)))
(let ((.def_102 (and .def_92 .def_101)))
(let ((.def_61 (= |!{i}.next| 0)))
(let ((.def_177 (and .def_61 .def_102)))
(let ((.def_96 (= |!{init}| |!{init}.next|)))
...
(let ((.def_182 (and .def_71 .def_181)))
(let ((.def_169 (store |!{a.1}| |!{i}| |!{init}|)))
(let ((.def_170 (= |!{a.1}.next| .def_169)))
(let ((.def_171 (and .def_90 .def_170)))
(let ((.def_172 (and .def_92 .def_171)))
(let ((.def_150 (* (- 1) |!{i}.next|)))
(let ((.def_151 (+ |!{i}| .def_150)))
(let ((.def_152 (= .def_151 (- 1))))
(let ((.def_173 (and .def_152 .def_172)))
(let ((.def_174 (and .def_96 .def_173)))
(let ((.def_175 (and .def_98 .def_174)))
(let ((.def_141 (not .def_140)))
(let ((.def_176 (and .def_141 .def_175)))
(let ((.def_183 (and .def_176 .def_182)))
(let ((.def_186 (or .def_183 .def_185)))
(let ((.def_161 (and |!pc[2]| .def_160)))
(let ((.def_123 (not |!pc[0].next|)))
(let ((.def_124 (and |!pc[1].next| .def_123)))
(let ((.def_125 (and .def_70 .def_124)))
(let ((.def_165 (and .def_125 .def_161)))
(let ((.def_157 (= |!{x}.next| 0)))
(let ((.def_94 (= |!{i}| |!{i}.next|)))
(let ((.def_103 (and .def_94 .def_102)))
(let ((.def_104 (and .def_96 .def_103)))
(let ((.def_158 (and .def_104 .def_157)))
(let ((.def_159 (and .def_140 .def_158)))
...
(let ((.def_148 (and .def_88 .def_147)))
(let ((.def_149 (and .def_92 .def_148)))
...
(let ((.def_76 (select |!{b.2}| |!{x}|)))
(let ((.def_79 (* (- 1) .def_76)))
(let ((.def_80 (+ |!{x}| .def_79)))
(let ((.def_81 (+ |!{init}| .def_80)))
(let ((.def_82 (= .def_81 0)))
...
(let ((.def_63 (= |!{init}.next| 42)))
(let ((.def_59 (= |!{N}.next| nd_char<0>)))
...
(let ((.def_53 (<= nd_char<0> 0)))
(let ((.def_54 (not .def_53)))
(let ((.def_67 (and .def_54 .def_66)))
(let ((.def_73 (and .def_67 .def_72)))
(let ((.def_134 (or .def_73 .def_133)))
(let ((.def_139 (or .def_134 .def_138)))
(let ((.def_168 (or .def_139 .def_167)))
(let ((.def_187 (or .def_168 .def_186)))
.def_187)))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
   ) (state |!{a.1}.next| |!{b.2}.next| |!{N}.next| |!{i}.next| |!{init}.next| |!{x}.next| |!pc[0].next| |!pc[1].next| |!pc[2].next|))))
